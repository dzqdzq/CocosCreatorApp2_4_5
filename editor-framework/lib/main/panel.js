...
(e.templateUrl = "editor-framework://static/window.html"),
  (e.open = function (n, r) {
    ...
    c &&
      (c.x && (u.x = parseInt(c.x)),
      c.y && (u.y = parseInt(c.y)),
      c.width && ((w = !1), (u.width = parseInt(c.width))),
      c.height && ((w = !1), (u.height = parseInt(c.height)))),
      (u.windowType = p.type || "dockable"),
      u.resizable ||
        ((w = !0),
        (u.width = parseInt(p.width)),
        (u.height = parseInt(p.height))),
      isNaN(u.width) && (u.width = 400),
      isNaN(u.height) && (u.height = 400),
      isNaN(u.minWidth) && (u.minWidth = 200),
      isNaN(u.minHeight) && (u.minHeight = 200),
      (s = new i(h, u)).nativeWin.setMenuBarVisibility(!1),
      w
  ...
  (e.close = function (n, i) {
    ...
    if (!l)
      return (
        i && i(new Error(`Can not find panel ${n} in main process.`)), void 0
      );
    let r = o.panelInfo(n);
    return r
      ? "simple" === r.type
        ? (l.close(), i && i(null, !0), void 0)
        : (l.send(
            "editor:panel-unload",
            n,
            (e, t) =>
  ...
  (e.popup = function (n) {
    ...
    i &&
      (i.panels.length <= 1 ||
        e.close(n, (i, o) => {
          if (i)
            return t.error(`Failed to close panel ${n}: ${i.stack}`), void 0;
          o && e.open(n);
        }));
  }),
...
r.on("editor:panel-query-info", (e, n) => {
  ...
  let i = o.panelInfo(n);
  if (!i)
    return e.reply(new Error(`Panel info not found for panel ${n}`)), void 0;
  e.reply(null, i);
}),
