...
let o, t, r;
e.isMainProcess
  ? ((o = require("../main/ipc")), (t = require("../main/console")))
  : ((o = require("../renderer/ipc")), (t = require("../renderer/console")));
class n {
  constructor() {
...
class d extends s {
  ...
  collapseTo(i) {
    if (i > this._position || i < 0)
      return t.warn(`Cannot collapse undos to ${i}`), void 0;
  ...
  dirty() {
    if (this._savePosition !== this._position) {
      ...
      for (let e = i + 1; e <= s; e++) if (this._groups[e].dirty()) return !0;
    }
    return !1;
  }
  ...
  _clearRedo() {
    this._position + 1 !== this._groups.length &&
