...
let s, r;
i.isMainProcess
  ? ((s = require("../main/ipc")), (r = require("../main/console")))
  : ((s = require("../renderer/ipc")), (r = require("../renderer/console")));
let n = null,
  l = {};
...
let y = {
  register(e) {
    ...
    l[e] || ((l[e] = new m(e)), s.sendToWins("_selection:register", e));
  },
  reset() {
...
function g(e, t, ...i) {
  "local" !== t &&
    (s.sendToAll.apply(null, [`_${e}`, t, ...i, s.option({ excludeSelf: !0 })]),
...
class _ {
  ...
  select(e, i, s) {
    ...
    if (
      ((e = e || []),
      Array.isArray(e) || (e = [e]),
      (i = void 0 === i || i) && (r = this._unselectOthers(e)),
      e.length)
    ) {
    ...
    e.length ? this._activate(e[e.length - 1]) : this._activate(null),
      r && s && g(v, this.type);
  }
  unselect(e, i) {
    let s = !1,
    ...
    if (((e = e || []), Array.isArray(e) || (e = [e]), e.length)) {
      ...
      (this.selection = t.difference(this.selection, e)),
        i.length &&
          (-1 !== i.indexOf(this.lastActive) && (r = !0),
          g(c, this.type, i),
          (s = !0));
    }
    r &&
  ...
  hover(e) {
    this.lastHover !== e &&
      ...
      (this.lastHover = e),
      null !== e && void 0 !== e && g(f, this.type, e));
  }
  setContext(e) {
  ...
  patch(e, t) {
    ...
    -1 !== i && (this.selection[i] = t),
      this.lastActive === e && (this.lastActive = t),
      this.lastHover === e && (this.lastHover = t),
      this._context === e && (this._context = t),
      g(p, this.type, e, t);
  }
  clear() {
    let e = !1;
    this.selection.length &&
      (g(c, this.type, this.selection), (this.selection = []), (e = !0)),
      this.lastActive && (this._activate(null), (e = !0)),
      e && g(v, this.type);
  }
}
...
class m extends _ {
  ...
  confirm() {
    if (!this.confirmed) {
      (this.confirmed = !0),
        t.xor(this._confirmedSnapShot, this.selection).length &&
          g(v, this.type),
  ...
  cancel() {
    this.confirmed ||
      (super.select(this._confirmedSnapShot, !0),
      (this.confirmed = !0),
      (this._confirmedSnapShot = []));
  }
  clear() {
...
(A = i.isMainProcess ? e.ipcMain : e.ipcRenderer),
  ...
  A.on("_selection:selected", (e, t, i) => {
    ...
    1 === (i = i.filter((e) => -1 === s.selection.indexOf(e))).length
      ? s.selection.push(i[0])
      : i.length > 1 && (s.selection = s.selection.concat(i));
  }),
  ...
  A.on("_selection:patch", (e, t, i, s) => {
    ...
    -1 !== o && (n.selection[o] = s),
      n.lastActive === i && (n.lastActive = s),
      n.lastHover === i && (n.lastHover = s),
      n._context === i && (n._context = s);
  });
