...
function b(e) {
  let r = a[e];
  return (
    r && (delete a[r.sessionId], r.timeoutId && clearTimeout(r.timeoutId)), r
  );
}
(e.option = n.option),
      ...
      l
        ? ((i = T(r, `${s}@renderer`, l.reply, l.timeout)),
          (n = [
            ...
            r,
            ...n,
            e.option({ sessionId: i, waitForReply: !0, timeout: l.timeout }),
          ]))
      ...
      l
        ? ((s = T(n, `${r}@renderer`, l.reply, l.timeout)),
          (i = [
            ...
            n,
            ...i,
            e.option({ sessionId: s, waitForReply: !0, timeout: l.timeout }),
          ]))
