...
const t = require("electron"),
  ...
  s = t.remote.MenuItem,
  l = require("./utils"),
  a = require("../../../share/math"),
  n = require("../utils/resource-mgr"),
  h = require("../utils/dom-utils"),
  o = require("../utils/focus-mgr"),
  d = require("../behaviors/focusable");
module.exports = l.registerElement("ui-color-picker", {
  ...
  hide(t) {
    h.fire(this, "hide", { bubbles: !1, detail: { confirm: t } });
  },
  _initEvents() {
    this.addEventListener("keydown", (t) => {
      13 === t.keyCode || 32 === t.keyCode
        ? (h.acceptEvent(t), this.hide(!0))
        : 27 === t.keyCode && (h.acceptEvent(t), this.hide(!1));
    }),
      this.$hueCtrl.addEventListener("mousedown", (t) => {
        h.acceptEvent(t), o._setFocusElement(this), this.$hueCtrl.focus();
        let i = this._value[3];
        (this._initValue = this._value), (this._dragging = !0);
        let s = this.$hueCtrl.getBoundingClientRect(),
          l = (t.clientY - s.top) / this.$hueCtrl.clientHeight;
      ...
      this.$colorCtrl.addEventListener("mousedown", (t) => {
        h.acceptEvent(t), o._setFocusElement(this), this.$colorCtrl.focus();
        ...
        let l = this.$colorCtrl.getBoundingClientRect(),
          n = (t.clientX - l.left) / this.$colorCtrl.clientWidth,
          d = (t.clientY - l.top) / this.$colorCtrl.clientHeight,
          r = d * d * (3 - 2 * d);
        (r *= 255),
          ...
          h.startDrag(
            ...
            (t) => {
              let n = (t.clientX - l.left) / this.$colorCtrl.clientWidth,
                h = (t.clientY - l.top) / this.$colorCtrl.clientHeight;
              n = a.clamp(n, 0, 1);
  ...
  _saveSettings() {
    ...
    t.set("ui-color-picker", this._settings), t.save();
  },
  _updateColorDiff() {
  ...
  _emitConfirm() {
    h.fire(this, "confirm", { bubbles: !0, detail: { value: this._value } });
  },
  _emitCancel() {
    h.fire(this, "cancel", { bubbles: !0, detail: { value: this._value } });
  },
  _emitChange() {
    h.fire(this, "change", { bubbles: !0, detail: { value: this._value } });
  },
});
