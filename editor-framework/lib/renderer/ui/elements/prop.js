...
const t = require("./utils"),
  e = require("../utils/resource-mgr"),
  i = require("../utils/dom-utils"),
  s = require("../utils/focus-mgr"),
  l = require("../behaviors/focusable"),
  n = require("../behaviors/disable"),
  a = require("../behaviors/readonly"),
  h = require("./hint"),
  o = require("../../../share/platform"),
  r = /\d$/;
let d = null,
  u = !1,
  b = 0,
...
let m = t.registerElement("ui-prop", {
  ...
  set multiValues(t) {
    ...
    return (
      ...
      this.multiValuesChanged && this.multiValuesChanged(e, t),
      this._multiValues
    );
  },
  get value() {
  ...
  set tooltip(t) {
    this._tooltip !== t && (this._tooltip = Editor.i18n.format(t));
  },
  get path() {
    return this._path;
  },
  ...
  ready() {
    ...
    e && (this.labelWidth = e), (this._path = this.getAttribute("path"));
    let s = this.getAttribute("indent");
    null !== s
      ? ((s = parseInt(s)), (this.$label.style.paddingLeft = 13 * s + "px"))
      : (s = 0),
      (this._indent = s),
      (this.multiValues = this.getAttribute("multi-values")),
      null !== this.getAttribute("folded") ? this.fold() : this.foldup(),
      s >= 1 &&
        this.movable &&
      ...
      this._initDisable(!0),
      this._initReadonly(!0),
      this._initEvents(),
      (this._type = this.getAttribute("type")),
      null !== this._type && this.regen(),
      this._disabled &&
        i.walk(
          this,
          { excludeSelf: !0 },
      ...
      o.isWin32 && this.$resizer.classList.add("platform-win");
  },
  connectedCallback() {
    i.fire(this, "ui-prop-connected", { bubbles: !0, detail: this });
  },
  fold() {
    this._folded ||
      ((this._folded = !0),
  ...
  _emitLabelWidthChange(t) {
    i.fire(this, "label-width-change", { bubbles: !0, detail: t });
  },
  _getFirstFocusableElement() {
    let t = s._getFirstFocusableFrom(this, !0);
  ...
  _initEvents() {
    ...
    this.addEventListener("focus-changed", (t) => {
      ...
      this.addEventListener("mousedown", (t) => {
        if ((i.acceptEvent(t), this.disabled))
          return s._setFocusElement(this), void 0;
        this.slidable &&
          (this.readonly
            ? i.startDrag("ew-resize", t)
            : ((this._sliding = !0),
              i.fire(this, "slide-start", { bubbles: !1 }),
              i.startDrag(
                "ew-resize",
                t,
                (t) => {
                ...
                () => {
                  i.fire(this, "slide-confirm", { bubbles: !1 });
                }
              ))),
          s._setFocusElement(null);
        let e = this._getFirstFocusableElement();
        e ? s._setFocusElement(e) : s._setFocusElement(this);
      }),
        ...
        13 === t.keyCode ||
          (27 === t.keyCode
            ? this._sliding &&
              ...
              i.acceptEvent(t),
              i.cancelDrag(),
              i.fire(this, "slide-cancel", { bubbles: !1 }))
            : 37 === t.keyCode
            ? (i.acceptEvent(t), this.fold())
            : 39 === t.keyCode && (i.acceptEvent(t), this.foldup()));
      }),
      ...
      this.$resizer.addEventListener("mousedown", (t) => {
        this._readonly ||
          this.slidable ||
          ((u = !0), (b = t.pageX), (c = this.$label.clientWidth));
      }),
      this.addEventListener("mousemove", (t) => {
        if (!u) return;
        let e = this.$label,
          i = e.clientWidth / e.parentElement.clientWidth,
          s = (c + (t.pageX - b)) / e.parentElement.clientWidth,
          l = 80,
          n = getComputedStyle(this.$label).minWidth;
        "auto" !== n && (l = parseFloat(n.substr(0, n.length - 2))),
          (s > i && s > 0.8) ||
            s * (e.clientWidth / i) <= l ||
            ((e.style.width = 100 * s + "%"),
  ...
  _showTooltip() {
    this.tooltip &&
      ...
      (this._showTooltipID = setTimeout(() => {
        (this._showTooltipID = null), (d.style.display = "block");
        let t = this.$text.getBoundingClientRect(),
          e = d.getBoundingClientRect();
        (d.style.left = t.left - 10), (d.style.top = t.top - e.height - 10);
      }, 200)));
  },
  _hideTooltip() {
    this.tooltip &&
