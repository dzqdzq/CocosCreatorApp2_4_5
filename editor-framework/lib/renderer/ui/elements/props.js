...
const e = require("./prop");
const u = require("../utils/dom-utils");
let s = i.parseString;
let l = i.parseBoolean;
let a = i.parseColor;
let h = i.parseArray;
...
t.number = {
    ...
    _updateMultiValue() {
      ...
      if (this._values.every((i, e) => 0 == e || i == t)) {
        this.$input.removeAttribute("multi-values");
      } else {
        this.$input.setAttribute("multi-values", "");
      }
...
t.object = {
    ...
    ready() {
      ...
      requestAnimationFrame(() => {
        ...
        for (let i in t) {
          let u = t[i];
          let s = new e(i, u, null, null, this.indent + 1);
...
t.vec2 = {
    ...
    _updateMultiX() {
      ...
      if (this.values.every((i, e) => 0 == e || i[0] == t[0])) {
    ...
    _updateMultiY() {
      ...
      if (this.values.every((i, e) => 0 == e || i[1] == t[1])) {
...
t.vec3 = {
    ...
    _updateMultiZ() {
      ...
      if (this.values.every((i, e) => 0 == e || i[2] == t[2])) {
