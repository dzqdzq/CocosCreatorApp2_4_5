...
(t.string = {
  ...
  ready() {
    this.attrs.multiline && (this.autoHeight = !0),
  ...
  (t.number = {
    ...
    _updateMultiValue() {
      if (!this.multiValues || !this.values || this.values.length <= 1)
        return this.$input.removeAttribute("multi-values");
      var t = this.values[0];
      this._values.every((i, e) => 0 == e || i == t)
        ? this.$input.removeAttribute("multi-values")
        : this.$input.setAttribute("multi-values", "");
    },
  }),
    ...
    ready() {
      (this.foldable = !0),
        ...
        requestAnimationFrame(() => {
          ...
          for (let i in t) {
            let u = t[i],
              s = new e(i, u, null, null, this.indent + 1);
  ...
  (t.array = {
    ...
    _updateChildren() {
      ...
      for (let t = 0; t < this.value.length; ++t) {
        let i = this.value[t],
          u = new e(`[${t}]`, i.value, this.type, this.attrs, this.indent + 1);
        (u.movable = !0), (u.removable = !0), this.$child.appendChild(u);
      }
    },
    valueChanged(t, i) {
  ...
  (t.vec2 = {
    ...
    ready() {
      (this.$propX = this.querySelector("#x-comp")),
        ...
        this.value && (this.$inputX.value = this.value[0]),
        this.values && (this.$inputX.values = this.values.map((t) => t[0])),
        ...
        this.value && (this.$inputY.value = this.value[1]),
        this.values && (this.$inputY.values = this.values.map((t) => t[1])),
    ...
    valuesChanged(t, i) {
      (this.$inputX.values = i.map((t) => t[0])),
        ...
        this.multiValues && (this._updateMultiX(), this._updateMultiY());
    },
    _updateMultiX() {
      if (!this.multiValues || !this.values || this.values.length <= 1)
        return this.$inputX.removeAttribute("multi-values");
      var t = this.values[0];
      this.values.every((i, e) => 0 == e || i[0] == t[0])
    ...
    _updateMultiY() {
      ...
      var t = this.values[0];
      this.values.every((i, e) => 0 == e || i[1] == t[1])
  ...
  (t.vec3 = {
    ...
    ready() {
      (this.$propX = this.querySelector("#x-comp")),
        ...
        this.value && (this.$inputZ.value = this.value[2]),
        this.values && (this.$inputZ.values = this.values.map((t) => t[2])),
    ...
    _updateMultiZ() {
      ...
      var t = this.values[0];
      this.values.every((i, e) => 0 == e || i[2] == t[2])
