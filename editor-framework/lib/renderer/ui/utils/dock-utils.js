...
function m(e, t, r, i, o) {
  f ||
    ...
    "dock" === e
      ? (f.classList.remove("tab"), f.classList.add("dock"))
      : "tab" === e && (f.classList.remove("dock"), f.classList.add("tab")),
    (f.style.left = `${t}px`),
    (f.style.top = `${r}px`),
    (f.style.width = `${i}px`),
    (f.style.height = `${o}px`),
    f.parentElement || document.body.appendChild(f);
}
function w() {
  f && f.remove(), (u = null), (p = 0);
}
(e.root = null),
  Object.defineProperty(e, "resizerSpace", { enumerable: !0, get: () => 3 }),
  Object.defineProperty(e, "tabbarSpace", { enumerable: !0, get: () => 22 }),
  Object.defineProperty(e, "panelSpace", { enumerable: !0, get: () => 4 }),
  ...
  (e.dragoverMainDock = function (e, t) {
    ...
    for (let i = 0; i < s.length; ++i) {
      let o = s[i],
        ...
        g = 100,
        m = -1;
      c < g && ((g = c), (m = Math.abs(t - a)), (d = "left")),
        f < g && ((g = f), (m = Math.abs(t - a)), (d = "right")),
        p < g && ((g = p), (m = Math.abs(e - l)), (d = "top")),
        h < g && ((g = h), (m = Math.abs(e - l)), (d = "bottom")),
        null !== d &&
          (null === r || m < r) &&
          ((r = m), (u = { target: o, position: d }));
    }
    if (u) {
      let e = c.items()[0],
        ...
        n = i;
      n >= Math.floor(t.width) && (n = Math.floor(0.5 * t.width));
      let l = o;
      l >= Math.floor(t.height) && (l = Math.floor(0.5 * t.height)),
        "top" === u.position
  ...
  (e.dropMainDock = function (t) {
    ...
    if (!f)
      return (
        l.close(r, (t, i) => {
          if (t)
            return o.error(`Failed to close panel ${r}: ${t.stack}`), void 0;
          i &&
            l.newFrame(r, (t, r) => {
    ...
    if ((p._collapse(), y)) {
      ...
      if (v.parentNode !== h) {
        ...
        if (e) {
          let e = 0;
          h.row
            ? ((e = t.offsetWidth + 3 + i), (t._preferredWidth = e))
            : ((e = t.offsetHeight + 3 + n), (t._preferredHeight = e)),
    ...
    (h = !0),
      r.waterfall(
        [
          ...
          (e) => {
            if ((d.clear(t), !n || !n.type || 0 !== n.type.indexOf("dock")))
              return e(null, []), void 0;
            "dock-v" === n.type
              ? (t.row = !1)
              : "dock-h" === n.type && (t.row = !0);
            let r = [];
            (function e(t, r, i) {
              if (!r) return;
              for (let o = 0; o < r.length; ++o) {
                ...
                if (
                  ("dock-v" === l.type
                    ? ((n = document.createElement("ui-dock")).row = !1)
                    : "dock-h" === l.type
                    ? ((n = document.createElement("ui-dock")).row = !0)
                    : "panel" === l.type &&
                      (n = document.createElement("ui-dock-panel")),
                  n)
                ) {
                  if (
                    (void 0 !== l.width && (n._preferredWidth = l.width),
                    void 0 !== l.height && (n._preferredHeight = l.height),
                    "panel" === l.type)
                  )
          ...
          (t, i) => {
            ...
            r.each(
              t,
              (e, t) => {
                a.some((t) => -1 !== t._panels.indexOf(e.panelID)) &&
                  l.close(e.panelID),
