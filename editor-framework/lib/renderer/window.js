...
function d(e) {
  e.preventDefault(), e.stopPropagation(), n.remove();
  let t = (function (e, t) {
...
function r(e) {
  ...
  if (o)
    return (
      o.openDevTools(),
      o.devToolsWebContents && o.devToolsWebContents.focus(),
      void 0
    );
  t.ipcRenderer.send("editor:window-inspect-at", e.clientX, e.clientY);
}
function s(e) {
  e.preventDefault(), e.stopPropagation(), 27 === e.which && c();
}
function c() {
  (i = !1),
    n.remove(),
    (n = null),
    window.removeEventListener("mousemove", d, !0),
    window.removeEventListener("mousedown", r, !0),
    ...
    (function () {
      if (!i) {
        ...
        window.addEventListener("mousemove", d, !0),
          window.addEventListener("mousedown", r, !0),
