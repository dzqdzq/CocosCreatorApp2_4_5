...
(module.exports = c),
  (c.create = function (o, n, i) {
    ...
    if ((Editor.log("install path: " + s), e.contains(s, o)))
      return (
        i && i(new Error(Editor.T("DASHBOARD.error_project_in_install"))),
        void 0
      );
    if (r.existsSync(o))
      return i && i(new Error("The path " + o + " already exists.")), void 0;
    function c(n) {
      let i;
      try {
  ...
  (c.check = function (o, i) {
    if (!1 === r.existsSync(o))
      return i && i(new Error("Project not exists!")), void 0;
    let t = Editor.dev
      ? Editor.url("app://")
      : e.join(Editor.url("app://"), "..", "..");
    if (e.contains(t, o))
      return (
        i && i(new Error(Editor.T("DASHBOARD.error_project_in_install_open"))),
        void 0
      );
