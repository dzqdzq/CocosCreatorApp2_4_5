...
const e = require("fire-fs"),
  t = (require("fire-path"), require("async")),
  i = require("../editor-framework/lib/share/ipc-listener");
let o = (e) => {
  process.send &&
    process.send({
...
process.on("uncaughtException", o),
  Editor.App.extend({
    ...
    run() {
      "string" != typeof Editor._buildCommand &&
    ...
    spawnWorker(e, t, i, o, r) {
      ...
      let a,
        s = !1;
      "function" == typeof t && ((r = o), (o = i), (i = t), (t = {})),
        (t.scriptUrl = e),
        (function e() {
          a && (clearTimeout(a), (a = null));
          const d = new Editor.Window("worker", { show: !!o, save: !1 });
          (a = setTimeout(() => {
            (a = null),
              s ||
      ...
      if (n) {
        ...
        if (
          ...
          for (let i in e.messages) {
            let r = e.messages[i];
            "function" == typeof r && o.on(t(e.package, i), r.bind(e));
          }
          e._ipc = o;
        }
      }
      ...
      t.waterfall(
        [
          ...
          (e) => {
            ...
            (c = `${o.name}-${a.name}`),
              Editor.assetdb.mount(s, c, { readonly: !0 }, (t) => {
                t
                  ? Editor.warn(
    ...
    unloadPackage(e, i) {
      if (e.gizmos) for (let t in e.gizmos) delete Editor.gizmos[t];
      e["scene-script"] &&
        (Editor.Ipc.sendToPanel(
          "scene",
        ...
        e["build-template"] && delete Editor.Builder.buildTemplates[e.name];
      ...
      if (e.inspector) for (let t in e.inspector) delete Editor.inspectors[t];
      var r = e["runtime-resource"];
      if (!r) return i && i(), void 0;
      var n = `${e.name}-${r.name}`;
      t.waterfall(
        [
          (e) => {
