...
})(
  {
      ...
      function (t, e, r) {
        ...
        function i(t) {
          var e,
            ...
            a,
            s = t.length;
          (i = n(t)), (a = new l((3 * s) / 4 - i)), (r = i > 0 ? s - 4 : s);
          var u = 0;
          for (e = 0; e < r; e += 4)
            (o =
              (f[t.charCodeAt(e)] << 18) |
          ...
          return (
            2 === i
              ? ((o =
                  (f[t.charCodeAt(e)] << 2) | (f[t.charCodeAt(e + 1)] >> 4)),
                (a[u++] = 255 & o))
              : 1 === i &&
                ((o =
                  (f[t.charCodeAt(e)] << 10) |
        ...
        function s(t, e, r) {
          for (var n, o = [], i = e; i < r; i += 3)
            (n = (t[i] << 16) + (t[i + 1] << 8) + t[i + 2]), o.push(a(n));
          return o.join("");
        }
        function u(t) {
          for (
            var e, r = t.length, n = r % 3, o = "", i = [], a = 0, u = r - n;
            a < u;
            a += 16383
          )
    ...
    2: [
      function (t, e, r) {
        (function (e) {
          ...
          function c(t, e) {
            if (
              (s(e), (t = o(t, e < 0 ? 0 : 0 | d(e))), !i.TYPED_ARRAY_SUPPORT)
            )
          ...
          function m(t, e, r, n, o) {
            ...
            if (("string" == typeof e && (e = i.from(e, n)), i.isBuffer(e)))
          ...
          function X(t, e, r, n, o) {
            return (
              o || N(t, e, r, 4, 3.4028234663852886e38, -3.4028234663852886e38),
          ...
          (r.Buffer = i),
            ...
            (i.compare = function (t, e) {
              ...
              if (t === e) return 0;
              for (
                var r = t.length, n = e.length, o = 0, a = Math.min(r, n);
                o < a;
                ++o
              )
                if (t[o] !== e[o]) {
          ...
          (i.prototype.slice = function (t, e) {
            ...
            if (i.TYPED_ARRAY_SUPPORT)
              (n = this.subarray(t, e)), (n.__proto__ = i.prototype);
            else {
              var o = e - t;
              n = new i(o, void 0);
            ...
            (i.prototype.readFloatLE = function (t, e) {
              return e || O(t, 4, this.length), H.read(this, t, !0, 23, 4);
            }),
            (i.prototype.readFloatBE = function (t, e) {
              return e || O(t, 4, this.length), H.read(this, t, !1, 23, 4);
            }),
            (i.prototype.readDoubleLE = function (t, e) {
              return e || O(t, 8, this.length), H.read(this, t, !0, 52, 8);
            }),
            (i.prototype.readDoubleBE = function (t, e) {
              return e || O(t, 8, this.length), H.read(this, t, !1, 52, 8);
            }),
          ...
          (function () {
            ...
            function p(t) {
              ...
              var v,
                ...
                A = i ? "Object" : "ScriptBridgingProxyObject",
                T = i ? "Object" : "Environment",
                E = i && n.java ? "JavaPackage" : u(n.java),
                C = i ? "Object" : "RuntimeObject",
                I = /\bJava/.test(E) && n.java,
                D = I && u(n.environment) == T,
                R = I ? "a" : "α",
                B = I ? "b" : "β",
                M = n.document || {},
                O = n.operamini || n.opera,
                L = x.test((L = i && O ? O["[[Class]]"] : u(O)))
                  ? L
                  : (O = null),
                k = t,
                U = [],
                N = null,
                X = t == b,
                F = X && O && "function" == typeof O.version && O.version(),
                Y = (function (e) {
                  return l(e, function (e, r) {
                    return (
                      e ||
              ...
              if (
                ...
                "IE" == W && /\blike iPhone OS\b/.test(t)
                  ...
                  ? (j &&
                    ...
                    : "Silk" == W
                    ? (/\bMobi/i.test(t) ||
                        ((V = "Android"), U.unshift("desktop mode")),
                      /Accelerated *= *true/i.test(t) &&
                        U.unshift("accelerated"))
                    : "PaleMoon" == W && (v = /\bFirefox\/([\d.]+)\b/.exec(t))
                    ? U.push("identifying as Firefox " + v[1])
                    : "Firefox" == W && (v = /\b(Mobile|Tablet|TV)\b/i.exec(t))
                    ? (V || (V = "Firefox OS"), G || (G = v[1]))
                    : !W ||
                      (v =
                ...
                (v =
                  ...
                  ("WebKit" == Y &&
                    ...
                    "NetFront")) && (Y = [v]),
                "IE" == W && (v = (/; *(?:XBLWP|ZuneWP)(\d+)/i.exec(t) || 0)[1])
                  ? ((W += " Mobile"),
                  ...
                  ? ((W = "IE Mobile"),
                    (V = "Windows Phone 8.x"),
                    U.unshift("desktop mode"),
                    F || (F = (/\brv:([\d.]+)/.exec(t) || 0)[1]))
                  : "IE" != W &&
                    "Trident" == Y &&
                    (v = /\brv:([\d.]+)/.exec(t)) &&
                    (W && U.push("identifying as " + W + (F ? " " + F : "")),
                    (W = "IE"),
                    (F = v[1])),
                X)
              ) {
                if (c(n, "global"))
                  if (
                    ...
                    try {
                      ...
                      v[0].global.system == n.system && (W = "Narwhal");
                    }
                  } else
              ...
              if (
                ...
                W = "Firefox Mobile";
              else if ("Maxthon" == W && F) F = F.replace(/\.[\d.]+/, ".x");
                ...
                if ("IE" == W && X)
                  try {
                    null === n.external && U.unshift("platform preview");
                  } catch (t) {
                    U.unshift("embedded");
                  }
                else
                  (/\bBlackBerry\b/.test(G) || /\bBB10\b/.test(t)) &&
                  (v =
              ...
              (v = (/\bAppleWebKit\/([\d.]+\+?)/i.exec(t) || 0)[1]) &&
                ...
                "Safari" == W && (!F || parseInt(F) > 45) && (F = v)),
                "Opera" == W && (v = /\bzbov|zvav$/.exec(V))
                  ? ((W += " "),
                    U.unshift("desktop mode"),
                    "zvav" == v ? ((W += "Mini"), (F = null)) : (W += "Mobile"),
                ...
                Y &&
                  ...
                  U.push(v),
                U.length && (U = ["(" + U.join("; ") + ")"]),
                j && G && G.indexOf(j) < 0 && U.push("on " + j),
                G && U.push((/^on /.test(U[U.length - 1]) ? "" : "on ") + G),
                V &&
                  ((v = / ([\d.+]+)$/.exec(V)),
                ...
                (v = /\b(?:AMD|IA|Win|WOW|x86_|x)64\b/i.exec(k)) &&
                !/\bi686\b/i.test(k)
                  ? (V &&
                      ((V.architecture = 64),
              ...
              return (
                ...
                V &&
                  ...
                  (V != String(V).split(" ")[0] ||
                    (V != W.split(" ")[0] && !G)) &&
                  U.push(G ? "(" + V + ")" : "on " + V),
                U.length && ($.description = U.join(" ")),
                $
              );
            }
            var d = { function: !0, object: !0 },
              g = (d[typeof window] && window) || this,
              y = g,
              b = d[typeof r] && r,
              v = d[typeof e] && e && !e.nodeType && e,
              m = b && v && "object" == typeof t && t;
    ...
    10: [
      function (t, e, r) {
        ...
        (p.nextTick = function (t) {
          ...
          g.push(new c(t, e)), 1 !== g.length || y || i(u);
        }),
      ...
      function (t, e, r) {
        ...
        (n.prototype = {
          ...
          loginSuccess: function (t) {
            if (!t || !t.userID) return void console.log("userID 不能为空!");
          ...
          createRole: function (t) {
            var e = {};
            t.roleID && (e.roleID = t.roleID),
              t.userName && (e.userName = t.userName),
              t.race && (e.race = t.race),
              t.class && (e.class = t.class),
    ...
    13: [
      function (t, e, r) {
        (function (n, o) {
          !(function (t, i, a) {
            "use strict";
            var s = { function: !0, object: !0 },
              u = (s[typeof window] && window) || this,
              c = s[typeof r] && r,
              f = s[typeof e] && e && !e.nodeType && e,
              l = c && f && "object" == typeof o && o;
            !l || (l.global !== l && l.window !== l && l.self !== l) || (u = l),
              "function" == typeof define &&
              "object" == typeof define.amd &&
              define.amd
                ? ((n.env.NODE_ENV = "development"), define(a), (u[t] = a()))
                : c && f
                ? ((e.exports = a()), (u[t] = a()))
                : (u[t] = a());
            ...
            o = {
              ...
              random32Str: function () {
                var t,
                  e,
                  r,
                  n = Date.now().toString(32).toUpperCase();
                return (
                  (t = Date.now()),
                  ...
                  (r = e.replace(/[xy]/g, function (e) {
                    ...
                    return (
                      ...
                      (t = Math.floor(t / 16)),
                      "x" === e ? r.toString(16) : ((7 & r) | 8).toString(16)
                    );
                  })),
                  (n || "") + r.replace(/-/g, "").toUpperCase()
                );
              },
        ...
        (function (r) {
          ...
          var n = t("./encrypt"),
            ...
            d = {
              ...
              isShowLog: !1,
              init: function (t) {
                if (!t.appID) return void console.log("appID 不能为空!");
                if (((this.data.appID = t.appID), !t.appSecret))
                  return void console.log("appSecret 不能为空!");
                (this.data.appSecret = t.appSecret),
                  t.channel && (this.data.channel = t.channel),
              ...
              _runInterval: function () {
                ...
                setInterval(function () {
                  ...
                  for (
                    var e = t._getLocalStorage("_MSG_" + t.data.appID),
              ...
              log: function () {
                if ("development" === r.env.NODE_ENV || !0 === this.isShowLog)
              ...
              _submit: function (t) {
                ...
                (e.onreadystatechange = function () {
                  ...
                  e.open("POST", this.data.apiURL, !0),
                  e.setRequestHeader(
                    "Content-Type",
              ...
              _msgPersist: function (t) {
                for (var e = 0; e < t.length; e++) this.data.msgPool.push(t[e]);
                this._addLocalStorage(
              ...
              _getCCID: function () {
                ...
                return (
                  e || ((e = i(n.random32Str())), this._addLocalStorage(t, e)),
                  e
                );
              },
              extends: function (t) {
              ...
              _addLocalStorage: function (t, e) {
                window.localStorage &&
                  ("sessionId" == t && window.sessionStorage
              ...
              _getBrowserVersion: function () {
                if (!this.browserVersion) {
                  var t = navigator.userAgent.toLowerCase(),
                    e =
                      /micromessenger|qqbrowser|sogou|qzone|liebao|ucbrowser|360 aphone|360browser|edge|baiduboxapp|bidubrowser|baidubrowser|maxthon|mxbrowser|trident|miuibrowser/i,
                    r = /chrome|safari|firefox|opr|oupeng|opera/i,
                    n = e.exec(t);
                  n || (n = r.exec(t));
                  var o = n ? n[0] : "unknown";
                  "micromessenger" === o
                    ? (o = "wechat")
                    : "safari" === o && t.match(/android.*applewebkit/)
                    ? (o = "androidbrowser")
                    : "trident" === o
                    ? (o = "ie")
                    : "360 aphone" === o
                    ...
                    : "opr" === o
                    ? (o = "opera")
                    : "bidubrowser" === o && (o = "baidubrowser");
                  var i =
                      /(micromessenger|qq|mx|maxthon|edge|bidu|baidu|sogou)(mobile)?(browserType)?\/?([\d.]+)/i,
                    a =
                      /(msie |rv:|firefox|chrome|ucbrowser|oupeng|opera|opr|safari|miui)(mobile)?(browserType)?\/?([\d.]+)/i,
                    s = t.match(i);
                  s || (s = t.match(a));
                  var u = s ? s[4] : "";
                  (this.browserVersion = o),
                    u && (this.browserVersion += "-" + u);
                }
    ...
    18: [
      function (t, e, r) {
        ...
        (n.prototype = {
          begin: function (t) {
            if (!t || !t.level) return void console.log("level 不能为空!");
            var e = this._generatePostData({
              category: "level",
              action: "start",
              level: t.level,
    ...
    21: [
      function (t, e, r) {
        ...
        (n.prototype = {
          begin: function (t) {
            if (!t || !t.taskID) return void console.log("taskID 不能为空!");
            var e = this._generatePostData({
              category: "task",
              action: "start",
              taskID: t.taskID,
