    ...
    try {
      ...
      if (t) {
        ...
        a.children.splice(a.children.indexOf("cloud-function"), 1),
          s && s.splice(s.indexOf("cloud-function"), 1);
...
function s(i) {
  try {
    ...
    return (
      !e ||
      r.satisfies(e, "< " + Editor.versions.CocosCreator, {
        includePrerelease: !0,
      })
    );
  } catch (i) {
...
process.on("unhandledRejection", (i) => {
  ...
  (exports.startup = async function (r, u) {
    require("./init"),
      ...
      (Editor.Network.isOnline && !Editor.argv.nologin) ||
        Editor.User.enable(!1);
    let E = !1;
    ...
    Editor._buildCommand ||
      Editor._compileCommand ||
