...
(module.exports = new (class {
  ...
  e.on("editor:project-profile-updated", async () => {
    ...
    if (e) {
      let i = o();
      t.isEqual(i.sort(), e.excludes.sort()) ||
  ...
  e.on("migrate-project", (e, t) => {
    ...
    t ||
      (t = (function () {
        ...
        return t && t.ver
          ? r.satisfies(t.ver, "< 2.3.0", { includePrerelease: !0 })
            ? (console.log(
      ...
      t && "2.0.10" !== t
        ? (r.satisfies(t, ">= 2.1.0 < 2.1.2", { includePrerelease: !0 }) &&
            (s("use_reversed_rotateTo.js"), s("use_reversed_rotateBy.js")),
          r.satisfies(t, ">= 2.2.1 <= 2.2.2", { includePrerelease: !0 }) &&
            s("use_reversed_rotateTo.js"),
          r.satisfies(t, ">= 2.3.0 < 2.3.3", { includePrerelease: !0 }) &&
            s("use_reversed_rotateBy.js"),
          r.satisfies(t, ">= 2.1.0 < 2.2.2", { includePrerelease: !0 }) &&
