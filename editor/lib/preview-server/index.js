...
let l = {
    ...
    o
      ? (o.close(),
        (function e(t, i, r) {
          ...
          if (e) return Editor.warn(e), t && t(e), void 0;
          (this._previewPort = i),
    ...
    s.engine("html", b.renderFile),
      ...
      s.get("/", function (e, t) {
        ...
        let a = Editor.require(
          ...
          c = !0,
          u = !1,
          l = Editor.Profile.load("project://project.json").get(
            "excluded-modules"
          );
        l &&
  ...
  query: async function (e, n, s) {
    if (this._validateStashedScene)
      switch ((void 0 === s && ((s = n), (n = "web-desktop")), e)) {
        ...
        default:
          var o = r.dirname(e),
            a = await i.queryBundlesWithScenes(),
            c = await i.queryBundleFolders();
          c.push({ name: cc.AssetManager.BuiltinBundleName.MAIN, url: "" });
          var d = c.find((e) => e.name === o);
          if (!d) return s(new Error("Bundle does not exist!"));
          t.buildConfig(
            {
              name: o,
  ...
  stop: function () {
    o &&
      o.close(function () {
        Editor.info("shutdown preview server"), (o = null);
      });
  },
  browserReload: function () {
    d ||
      (d = setTimeout(function () {
        n.emit("browser:reload"), clearTimeout(d), (d = !1);
      }, 50));
  },
  ...
  setPreviewAndroidInstantPath: function (e) {
    var t = require("express");
    Editor.log("express path is ", e), (c = t.static(e));
  },
...
Object.defineProperty(l, "previewPort", {
  ...
  set(e) {
    (this._previewPort = e), this._listenByPort(e);
  },
}),
  (module.exports = l);
