const e = require("fire-fs"),
  n = require("fire-path"),
  o = require("source-map"),
  r = o.SourceMapConsumer,
  t = o.SourceMapGenerator,
  i = require("event-stream");
function u(o, i, u) {
  if (o.sourceMap) {
    let s = o.sourceMap,
      a = (function (o, t, i) {
    ...
    o.sourceMap = (function (e, n) {
      var o = new r(n),
        i = new t(),
        u = { line: 0, column: 0, bias: r.LEAST_UPPER_BOUND },
        s = {
          original: null,
      ...
      o.eachMapping(function (n) {
        if (null == n.originalLine) return;
        let o = n.source,
          r = e[o];
        if (!r) return;
        (u.line = n.originalLine), (u.column = n.originalColumn);
      ...
      (a.sourcesContent = []), (a.sourceRoot = n.sourceRoot);
      for (let n = 0; n < a.sources.length; ++n) {
        let o = a.sources[n],
          r = e[o];
        r && (a.sourcesContent[n] = r.sourcesContent[0]);
      }
      return a;
    })(a, s);
...
(module.exports = function (e, n) {
  return i.through(function (o) {
    u(o, e, n), this.emit("data", o);
  });
}),
  (module.exports.offsetLines = function (e, n) {
    var o = new r(e),
      i = new t({ file: e.file, sourceRoot: e.sourceRoot });
    o.eachMapping(function (o) {
      o.source || (o.source = e.sources[0]),
        "number" == typeof o.originalLine &&
          0 < o.originalLine &&
    ...
    return (
      void 0 !== e.sourcesContent && (u.sourcesContent = e.sourcesContent),
      (u.sources = e.sources),
      u
    );
  });
