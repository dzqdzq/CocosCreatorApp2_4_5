const e = require("fire-path"),
  ...
  i = require("fire-url"),
  o = require("lodash"),
  n = Editor.remote.ProjectCompiler.DEST_PATH,
  l = e.join(Editor.remote.Project.path, "node_modules"),
  a = Editor.remote.ProjectCompiler.INDEX_FILE_PATH;
let s = Object.create(null),
  d = [];
let u =
    Editor.Profile.load("global://features.json").get(
...
function f(t) {
  ...
  delete require.cache[t], delete s[r];
}
(cc.require = function (t, r) {
  ...
  if (o && u) {
    ...
    if (t !== p - 1) {
      let r = [];
      for (let i = t; i < m.length; i++) r.push("  " + e.relative(n, m[i]));
  ...
  (c._resolveFilename = function (t, r, i) {
    if (p > 0) {
      ...
      if (
        ...
        return (m[p - 1] = o.path), o.path;
    }
    return (
      r.paths.includes(l) || r.paths.push(l), c._resolveFilenameVendor(t, r, i)
    );
  });
let h = [];
module.exports = {
    ...
    t(i, (t, i) => {
      (i = o(i)
        ...
        (function (t, r) {
          ...
          let i = s[r];
          return i || (i = s[r] = { name: r, path: t, children: [] }), i;
        })(t);
      }),
        (function (e) {
          (m.length = 0), p++;
