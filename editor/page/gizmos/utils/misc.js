...
(module.exports = n),
  (n.addMoveHandles = function (e, n, t) {
    ...
    var r = n.cursor || "default",
      ...
      i = function (n) {
        if ((n.stopPropagation(), cc.director.getScene())) {
          var r = n.clientX - l,
            u = n.clientY - o;
    ...
    e.on("mousedown", function (n) {
      if (u) {
        var c = Editor.Selection.curSelection("node"),
          a = Editor.Selection.hovering("node");
  ...
  (n.getCenterWorldPos = function (n) {
    for (var t = null, l = null, o = null, r = null, u = 0; u < n.length; ++u) {
      for (
        var i, d = n[u], c = e.getWorldOrientedBounds(d), a = 0;
        a < c.length;
        ++a
      )
        (i = c[a]),
  ...
  (n.getCenterWorldPos3D = function (n) {
    for (
      ...
      for (
        var c, a = n[d], s = e.getWorldOrientedBounds(a), v = 0;
        v < s.length;
        ++v
      )
        (c = s[v]),
