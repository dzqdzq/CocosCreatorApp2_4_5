...
module.exports = {
  ...
  onMouseDown(e) {
    if (!e.button && 1 === e.which) {
      let i = e.offsetX,
        n = cc.game.canvas.height - e.offsetY;
      (this.recordLastX = i), (this.recordLastY = n);
  ...
  onMouseMove(e) {
    let t = e.offsetX,
      i = cc.game.canvas.height - e.offsetY,
      n = o(this.gizmoRootNode, t, i),
      s = new cc.Event("mouseMove", !0);
    if (
      ((s.x = t),
      (s.y = i),
      ...
      e != this.hoverinNode &&
        (null != this.hoverinNode &&
          ((s = new cc.Event("hoverOut", !0)),
          this.hoverinNode.emit(s.type, s)),
        (this.hoverinNode = e),
        (s = new cc.Event("hoverIn", !0)),
        this.hoverinNode.emit(s.type, s));
    } else
      null != this.hoverinNode &&
        ((s = new cc.Event("hoverOut", !0)), this.hoverinNode.emit(s.type, s)),
        (this.hoverinNode = null);
  },
  onMouseUp(e) {
    let t = e.offsetX,
      i = cc.game.canvas.height - e.offsetY,
      n = new cc.Event("mouseUp", !0);
    if (null != this.curSelectNode)
      return (
        this.curSelectNode.emit(n.type, n), (this.curSelectNode = null), !0
      );
    {
      let e = o(this.gizmoRootNode, t, i);
      for (let o = 0; o < e.length; o++) e[o].node.emit(n.type, n);
    }
  },
  onMouseLeave() {
