...
module.exports = class extends t{createAnchorGroup(){
  ...
  let o = t.line().stroke({width:3,color:"#cccc00",opacity:.5});
  ...
  t.plot = (n => {
    if (n.distance) {
      ...
      o.style("stroke-dasharray",e.dashLength());
  ...
  t.m[12] = t.m[13]=0;
  let c=cc.v3(this.target.distance,0,0);cc.Vec3.transformMat4(c,c,t);let o=this.getScreenDelta(c);
  o.z = 0;
  let r = o.mag();
