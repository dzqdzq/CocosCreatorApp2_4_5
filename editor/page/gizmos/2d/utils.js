...
(module.exports = n),
    ...
    var r = n.cursor || "default",
      ...
      i = function (n) {
        if (
          ...
          var r = n.clientX - o,
            u = n.clientY - l;
          t.update && t.update.call(e, r, u, n);
        }
      }.bind(e),
      d = function (n) {
    ...
    e.on("mousedown", function (n) {
      if (u) {
        var c = Editor.Selection.curSelection("node"),
          s = Editor.Selection.hovering("node");
      ...
      1 === n.which &&
        ...
        t.start && t.start.call(e, n.offsetX, n.offsetY, n)),
        3 !== n.which && n.stopPropagation();
    });
  }),
  ...
  (n.snapPixelWihVec2 = function (e) {
    return (e.x = n.snapPixel(e.x)), (e.y = n.snapPixel(e.y)), e;
  }),
  ...
  (n.getCenterWorldPos = function (n) {
    for (var t = null, o = null, l = null, r = null, u = 0; u < n.length; ++u) {
      for (
        var i, d = n[u], c = e.getWorldOrientedBounds(d), s = 0;
        s < c.length;
        ++s
      )
        (i = c[s]),
  ...
  (n.getWorldBounds3D = function (n) {
    for (
      ...
      for (
        var c, s = n[d], a = e.getWorldOrientedBounds(s), g = 0;
        g < a.length;
        ++g
      )
        (c = a[g]),
  ...
  (n.getRecursiveNodes = function (e, t) {
    for (let o = 0; o < e.length; o++)
      e[o].active && (t.push(e[o]), n.getRecursiveNodes(e[o].children, t));
  }),
  (n.getRecursiveWorldBounds3D = function (e) {
    let t = [];
    return n.getRecursiveNodes(e, t), n.getWorldBounds3D(t);
  });
