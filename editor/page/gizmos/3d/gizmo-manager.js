...
const { create3DNode: e, getRaycastResults: o } = require("../utils/engine"),
  t = require("./gizmo-defines"),
  i = require("../../../3d/manager/node"),
  s = require("../../selection"),
  n = require("../utils/transform-tool-data"),
  l = require("../../operation"),
  r = require("./elements/controller/world-axis-controller");
let h = cc.v3();
n.on("tool-name-changed", (e) => {
  ...
  (module.exports = new (class {
    ...
    setTransformToolName(e) {
      ["position", "rotation", "scale"].includes(e) &&
    ...
    onSceneLoaded() {
      this.clearAllGizmos(), (this.transformToolName = "position");
      let e = s.query();
      this.select(e);
    }
    get transformTool() {
    ...
    set transformToolName(e) {
      ...
      if (null != o && o !== this._transformTool) {
        let e = [];
        null != this._transformTool &&
          (this._transformTool.hide(), (e = this._transformTool.target)),
    ...
    set coordinate(e) {
      (n.coordinate = e),
        this._transformTool && this.edit(this._transformTool.target);
    }
    get pivot() {
      return n.pivot;
    }
    ...
    createGizmo(e, o, t) {
      ...
      let i = this._gizmosPool[e],
        s = null;
      if (null == i)
        (i = []), (s = new o(t)), i.push(s), (this._gizmosPool[e] = i);
      else {
    ...
    showNodeGizmo(e) {
      ...
      if (null == e.gizmo) {
        ...
        (o = t[s]) && ((i = this.createGizmo(s, o, e)).show(), (e.gizmo = i));
      }
      e._components.forEach((s) => {
        if (e.active && s.enabled && null == s.gizmo) {
          (o = null), (i = null);
          let e = cc.js.getClassName(s);
          null != (o = t.components[e]) &&
            ((i = this.createGizmo(e, o, s)).show(), (s.gizmo = i));
        }
      });
    }
    hideNodeGizmo(e) {
    ...
    onComponentEnable(e) {
      ...
      -1 !== this._selection.indexOf(o.node.uuid) && this.showNodeGizmo(o.node);
    }
    onComponentDisable(e) {
      let o = cc.engine.getInstanceById(e);
      o && o.gizmo && (this.destoryGizmo(o.gizmo), (o.gizmo = null));
    }
    updateGizmosState(e, o) {
      if (!e) return;
      let t = e._components;
      Object.keys(o).forEach((i) => {
        e.gizmo && (e.gizmo[i] = o[i]),
          t.forEach((e) => {
            e.gizmo && (e.gizmo[i] = o[i]);
          });
      });
    ...
    select(e, o) {
      ...
      let t = i.query(e);
      if (!t) return;
      this.showNodeGizmo(t), (this._selection = o);
      let s = [];
      o.forEach((e) => {
        let o = i.query(e);
        o &&
          (this.updateGizmosState(o, { selecting: !0, editing: !1 }),
          s.push(o));
      }),
        this.edit(s);
    }
    unselect(e) {
      e.forEach((e) => {
        ...
        -1 !== o && this._selection.splice(o, 1);
        let t = i.query(e);
        this.updateGizmosState(t, { selecting: !1, editing: !1 }),
    ...
    edit(e) {
      if (0 === e.length)
        return this._transformTool && (this._transformTool.target = []), void 0;
      1 === e.length &&
        this.updateGizmosState(e[0], { selecting: !1, editing: !0 }),
        null != this.transformTool &&
          ((this.transformTool.target = e), this.transformTool.show());
    }
    onMouseDown(e) {
      if (e.leftButton) {
        let t = e.x,
          i = cc.game.canvas.height - e.y,
          s = o(this.gizmoRootNode, t, i),
          n = s.ray;
        if (s.length > 0) {
          let e = s[0],
            o = new cc.Event("mouseDown", !0);
          return (
    ...
    onMouseMove(e) {
      let t = e.x,
        i = cc.game.canvas.height - e.y,
        s = o(this.gizmoRootNode, t, i),
        n = new cc.Event("mouseMove", !0);
      if (
        ((n.x = t),
        (n.y = i),
        (n.moveDeltaX = e.moveDeltaX),
        (n.moveDeltaY = -e.moveDeltaY),
        null != this.curSelectNode)
      )
        this.curSelectNode.emit(n.type, n);
      else if (s.length > 0) {
        let e = s[0].node;
        e !== this.hoverinNode &&
          (null != this.hoverinNode &&
            ((n = new cc.Event("hoverOut", !0)),
            this.hoverinNode.emit(n.type, n)),
          (this.hoverinNode = e),
          ((n = new cc.Event("hoverIn", !0)).x = t),
          (n.y = i),
          this.hoverinNode.emit(n.type, n));
      } else
        null != this.hoverinNode &&
    ...
    onMouseUp(e) {
      let t = e.x,
        i = cc.game.canvas.height - e.y,
        s = new cc.Event("mouseUp", !0);
      if (null != this.curSelectNode)
        return (
          this.curSelectNode.emit(s.type, s), (this.curSelectNode = null), !1
        );
      {
        let e = o(this.gizmoRootNode, t, i);
        for (let o = 0; o < e.length; o++) e[o].node.emit(s.type, s);
      }
    }
    onMouseLeave() {
      let e = new cc.Event("mouseLeave", !0);
      null != this.curSelectNode &&
        (this.curSelectNode.emit(e.type, e), (this.curSelectNode = null));
    }
    onKeyDown(e) {
    ...
    onNodeChanged(e) {
      null != e && e.emit("change"),
        this.hideNodeGizmo(e),
        -1 !== this._selection.indexOf(e.uuid) && this.showNodeGizmo(e);
    }
    onNodeRemoved(e) {
      null != e && this.hideNodeGizmo(e);
    }
