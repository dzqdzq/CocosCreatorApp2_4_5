require("electron").ipcRenderer, require("util");
...
module.exports = async function (o) {
  const n = Editor.require("app://editor/page/scene-utils/utils/prefab"),
    r = Editor.require("app://editor/page/scene-utils/utils/node"),
    s = Editor.require(
    ...
    a = Editor.require("unpack://engine-dev/cocos2d/core/mesh/CCMeshRenderer"),
    d = Editor.require("unpack://engine-dev/cocos2d/core/3d/CCModel");
  let {
    gltf: c,
    meshIDs: u,
    skeletonIDs: f,
  ...
  function C(i, o, n) {
    ...
    for (let t = 0; t < s.length; t++) {
      let i = s[t];
      if (e.existsSync(i) && (r = Editor.remote.assetdb.fspathToUuid(i))) break;
    }
    return r;
  }
  let b = [],
    E = [],
    k = (c = JSON.parse(c)).materials || [];
  for (let e = 0; e < k.length; e++) {
    let t = k[e],
      o = C(t.name + ".mtl", ["materials", "Materials"]);
    if (o) {
    ...
    let r,
      s = n._techniqueData[0],
      l = t.pbrMetallicRoughness;
    if (l) {
      if (l.baseColorTexture) {
        ...
        if (e) {
          ...
          if (
            (t.startsWith("data:image/ccmissing;base64,") &&
              (t = (t = (t = window.atob(
            ...
            (q._uuid = r),
              ...
              (s.defines.USE_DIFFUSE_TEXTURE = !0);
          }
        }
      }
      if (r) s.props.diffuseColor = cc.color(255, 255, 255, 255);
      else {
        let e = l.baseColorFactor;
        if (e) {
          let t = void 0 === e[0] ? 255 : 255 * e[0],
            i = void 0 === e[1] ? 255 : 255 * e[1],
            o = void 0 === e[2] ? 255 : 255 * e[2],
            n = void 0 === e[3] ? 255 : 255 * e[3];
  ...
  for (let e = 0; e < x.length; e++) {
    let t = x[e],
      i = new cc.Node();
    (i.is3DNode = !0), (i.name = t.name);
    let o = t.position;
    o && i.setPosition(o[0], o[1], o[2]);
    let n = t.quat;
    n && i.setRotation(n[0], n[1], n[2], n[3]);
    let r = t.scale;
    if ((r && i.setScale(r[0], r[1], r[2]), void 0 !== t.mesh)) {
      let e,
        o = new cc.Mesh();
      if (((o._uuid = u[t.mesh]), void 0 !== t.skin)) {
        e = i.addComponent(s);
        let o = new cc.Skeleton();
        (o._uuid = f[t.skin]), (e._skeleton = o);
      } else e = i.addComponent(a);
      (e.mesh = o), (e._materials = []);
  ...
  let N,
    D = c.scenes[c.scene];
  1 === D.nodes.length && 0 === D.nodes[0] && "RootNode" === x[0].name
    ? (N = v[0])
    : ((N = new cc.Node("RootNode")).is3DNode = !0);
  let M = !1;
  for (let e = 0; e < v.length; e++) {
    let t = v[e],
      i = x[e].children;
    if (i) for (let e = 0; e < i.length; e++) v[i[e]].parent = t;
  ...
  let R = (function () {
    ...
    S = r.getNodePath(N).length + 1,
    T = n.createPrefabFrom(N, (e) => {
      if (e === N) return p;
  ...
  return (w[h] = P), { nodeMap: w, materials: b.map((e) => e.serialize()) };
};
