...
var i = Editor.require("app://editor/share/engine-extends/json-packer"),
  r = Editor.require("app://editor/share/engine-extends/texture-asset-packer"),
  l = require("./hash-uuid");
const n = 8,
  u = 500;
var o = !0;
...
module.exports = class {
  ...
  _queryPackableDepends(e, s) {
    ...
    if (!Array.isArray(i) || 0 === i.length) return s(null, null);
    i = i.filter((e) => {
  ...
  removeFromGroups(e, s) {
    for (let i = 0; i < e.length; i++) {
      let r = e[i].uuids;
      t.pullAll(r, s), 0 === r.length && (cc.js.array.fastRemoveAt(e, i), --i);
    }
  }
  getAllUuidsInBuild() {
        ...
        for (let t = 0; t < o.length; t++) {
          ...
          if (r.length > 0)
            for (let e = 0; e < r.length; e++) {
              let t = r[e];
              -1 === t.indexOf(n) && (t.push(n), ++u);
            }
          else {
            let t = [s, n];
            e.push({ name: "", uuids: t }), r.push(t), ++u;
          }
        }
        u > 0 && r.push(n);
      }
      ...
      this.queryAssetInfosInBuild(cc.SpriteFrame, (s, i) => {
        ...
        if (
          ...
          for (let s = 0; s < e.length; s++) {
            let i = e[s].uuids;
            if (i.length > 1) for (let e = 0; e < i.length; e++) t.add(i[e]);
          }
        ...
        for (let t = 0; t < l.length; t++) {
          let s = l[t];
          -1 !== this.packableGroupRootUuids.indexOf(s) &&
            (e.push({ name: "", uuids: [s], isPlaceholder: !0 }),
            console.log(`add dummy group to allow download ${s} individually`));
        }
        console.timeEnd("inline single SpriteFrames: 4"), t(null, e);
      });
  }
  ...
  _mergeSmallFiles(t, s) {
    var i = [(e) => e(null, t)];
    this.inlineSpriteFrames && i.push(this._inlineSpriteFrames.bind(this)),
      this.mergeAllJson || i.push(this._packAllTextures.bind(this)),
      e.waterfall(i, s);
  }
  _computeGroup(t) {
    console.time("init packs: computeGroup"),
      ...
      e.waterfall(
        [
          ...
          (e, t) => {
            console.time("computeGroup: _mergeSmallFiles"), t(null, e);
          },
          this._mergeSmallFiles.bind(this),
          (e, t) => {
            console.timeEnd("computeGroup: _mergeSmallFiles"), t(null, e);
          },
          (e, t) => {
            t(
              null,
          ...
          (e, t) => {
            console.timeEnd("init packs: computeGroup"), t(null, e);
          },
        ],
        t
      );
    ...
    (this.rootUuids = t),
      ...
      this._computeGroup((t, s) => {
        ...
        e.eachLimit(
          ...
          (e, t) => {
            var s = e.uuids,
              l = "texture" === e.type ? new r() : new i();
            this._packAssets(l, s, (s) => {
              if (s) return t(s);
              (l.name = e.name), this.packers.push(l), t();
            });
          },
          l
        );
  ...
  buildPacks(t) {
    var s = this.packers.map((e) => e.pack(this.minify)),
      i = s.map((e) => e.indices),
      r = l.calculate(i, l.BuiltinHashType.PackedAssets);
