  ...
  if (t.name.startsWith("pvrtc_")) {
    ...
    return (
      "pvrtc_2bits" === t.name
        ...
        : "pvrtc_4bits_rgb" === t.name
        ? (r = e.RGB_PVRTC_4BPPV1)
        : "pvrtc_2bits_rgb" === t.name
        ? (r = e.RGB_PVRTC_2BPPV1)
        : "pvrtc_4bits_rgb_a" === t.name
        ? (r = e.RGB_A_PVRTC_4BPPV1)
        : "pvrtc_2bits_rgb_a" === t.name && (r = e.RGB_A_PVRTC_2BPPV1),
      `.pvr@${r}`
    );
  }
...
function p(e, r, n, o) {
  let i = t(e),
    a = ".png";
  if ("webp" === n.name) (i = i.webp({ quality: n.quality })), (a = ".webp");
  else if ("jpg" === n.name) (i = i.jpeg({ quality: n.quality })), (a = ".jpg");
  else if ("png" === n.name) {
...
function f(t, r, n, i) {
  ...
  if (
    ("pvrtc_4bits" === n.name
      ? (p = "PVRTC1_4")
      : "pvrtc_4bits_rgb" === n.name
      ? (p = "PVRTC1_4_RGB")
      : "pvrtc_2bits" === n.name
      ? (p = "PVRTC1_2")
      : "pvrtc_2bits_rgb" === n.name
      ? (p = "PVRTC1_2_RGB")
      : "pvrtc_4bits_rgb_a" === n.name
      ? ((p = "PVRTC1_4_RGB"), (u = !0))
...
module.exports = function (t, e) {
  ...
  i.each(
    ...
    (t, e) => {
      let n = p;
      t.name.startsWith("pvrtc_")
        ? (n = f)
        : t.name.startsWith("etc") && (n = d);
      let o = u(t);
      o = o.replace(/@.*/, "");
      let i = l(s, o);
      if (g && a.exportTo(r, t, o, i)) return e(), void 0;
      n(c, s, t, (n) => {
        g && !n && a.add(r, t, o, i), e(n);
      });
    },
    (t) => {
      let r = T(),
        n = r.map((t) => l(s, t.replace(/@.*/, "")));
      e(t, r, n);
    }
  );
};
