...
class r {
      ...
      t.build(e, (t, a) => {
        if (t)
          if (t.message === i.AssetMissing) {
            ...
            u && r._reportMissingAsset(e, u);
          } else Editor.error(t.message || t);
        else {
          var d = a.dependUuids,
            o = a.redirect,
            h = a.nativePaths,
          ...
          h && (((l = l || {}).nativePath = h[0]), (l.nativePaths = h)),
            o && ((l = l || {}).redirect = o),
            l && (this._results[e] = l);
        }
        (this._ownerCaches[e] = void 0), n();
      });
    }, n);
  }
  static _reportMissingAsset(e, s) {
    var i = s.assetUuid,
      r = `Cannot find the asset referenced in "${Editor.assetdb.remote.uuidToUrl(
        i
      )}", it may have been deleted. Detailed information:\n`,
      n = s.ownersForDependUuids;
    if (n) {
  ...
  parse(e, s) {
    if (
      ...
      let t = e[0];
      if (this._results[t]) return;
      s && (this._ownerCaches[t] = s),
        (this._results[t] = !0),
        this.queue.push(t);
    } else {
      var t = [];
      for (let i = 0; i < e.length; i++) {
        let r = e[i];
        this._results[r] ||
          (s && (this._ownerCaches[r] = s), t.push(r), (this._results[r] = !0));
      }
      this.queue.push(t);
    }
  }
