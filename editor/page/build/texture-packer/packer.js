const e = require("fire-fs"),
  ...
  i = require("fire-path"),
  r = require("del"),
  o = require(Editor.url("app://editor/share/sharp")),
  n = require("./algorithm"),
  a = require("./bleeding").applyBleed,
  h = i.join(Editor.remote.Project.path, "temp", "trimImages");
class d {
  constructor(e, t, i) {
    (this.files = e),
      (this.width = t),
...
function s(e, t, i) {
  ...
  t.atlases.forEach(function (e) {
    (function (e, t, i) {
      t && (e.width = e.height = Math.max(e.width, e.height));
      i && ((e.width = c(e.width)), (e.height = c(e.height)));
...
module.exports = function (n, d, c) {
  if (!n) return c(new Error("SpriteFrames is null"));
  ...
  (d.atlases = []),
    ...
    t.waterfall(
      [
            ...
            (function (r, n, a) {
              ...
              t.forEach(
                ...
                function (e, t) {
                  ...
                  let r = e.trim,
                    n = o(e.originalPath).extract({
                      left: r.x,
                      top: r.y,
                      width: r.rotatedWidth,
                      height: r.rotatedHeight,
                    });
                  e.spriteFrame.isRotated() && (n = n.rotate(270)),
        ...
        function (e, t) {
          console.time("TexturePacker: determine canvas size"), s(e, d, t);
        },
        function (e, i) {
          ...
          t.eachSeries(
            ...
            function (t, i) {
              global.gc && global.gc(),
                ...
                (function (e, t, i) {
                  ...
                  const n = t.width,
                    h = t.height,
                    d = { raw: { width: n, height: h, channels: 4 } };
            ...
            function (t) {
              console.timeEnd("TexturePacker: generate images"), i(t, e);
            }
          ),
            (e.name = d),
            (e.width = n),
