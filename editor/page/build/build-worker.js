        ...
        [
          function (e) {
            cc.assetManager.init({ importBase: a, nativeBase: a }),
              (cc.assetManager.cacheAsset = !1),
              (cc.assetManager.force = !0),
              (cc.assetManager.downloader.maxRetryCount = 0),
              (cc.assetManager.downloader.limited = !1),
              (cc.assetManager.downloader.appendTimeStamp = !0);
    ...
    e.on(
      ...
      function (e, { dest: c, root: u, scenes: p }, m, f, w) {
        var E,
          g,
          h = 4,
          b = Editor.remote.Builder.actualPlatform2Platform(m),
          q = o[b],
          v = w.hasOwnProperty("pack") ? w.pack : q.pack,
          k = t.join(c, "import"),
          y = require("./file-writer"),
          x = require("./asset-crawler"),
          C = require("./build-asset"),
          U = require("./group-manager"),
          P = require("./group-strategies"),
          T = require("./texture-packer"),
          j = require("./building-assetdb"),
          S = new y(k, f),
          _ = new j(Editor.assetdb),
          A = new T();
        if (w.compressionType === l) {
          if (q.isNative) {
            if (w.optimizeHotUpdate) w.inlineSpriteFrames = !1;
            else {
              w.inlineSpriteFrames &&
                Editor.info(
          ...
          w.compressionType === s
            ? (v = !1)
            : w.compressionType === d
            ? ((w.mergeAllJson = !0), (w.inlineSpriteFrames = !1))
            : (w.inlineSpriteFrames = !1);
        v &&
          ((g =
            w.compressionType === d
              ? new P.MergeAllJson()
        ...
        var D = [
          ...
          function (e, t) {
            var r = e
                ...
                .map((e) => e.uuid),
              i = p;
            (M = n.uniq(i.concat(r))), z.start(M, t);
          },
          (e, t) => {
        ...
        1,
          ...
          v &&
            D.push(
              function (e) {
                console.time("init packs"), E.initPacks(M, B, e);
              },
              function (e) {
              ...
              function (e, t) {
                console.timeEnd("build packs"), (F = e.packedAssets), t();
              }
            ),
          D.push(function (e) {
            S.flush(e);
          ...
          i.waterfall(D, function (t) {
            if (t)
              (t = t && t.stack) instanceof Error || (t = new Error(t)),
                e.reply(t);
            else {
