...
const i = !1,
  ...
  l = Editor.require("app://editor/page/build/texture-compress");
class o {
  constructor(e, i, t, s, a) {
    ...
    (this.actualPlatform = s),
      ...
      (this.exportSimpleFormat =
        !l.stripDefaultValues || l.exportSimpleProject),
  ...
  build(e, i) {
    if (this.sharedUuids[e]) return i(null, { redirect: this.sharedUuids[e] });
    this.assetdb.queryInfoByUuid(e, (t, s) => {
      if (!s) return (this.existsCache[e] = !1), i(new Error(o.AssetMissing));
  ...
  _exportNativeAsset(e, i) {
    let r = e.nativeUrl,
      a = t.relative(this.library, r),
      o = t.join(this.writer.dest, "..", "native", a);
  ...
  _getAssetRef(e) {
    ...
    return (
      ...
      i ? Editor.serialize.asAsset(e) : null
    );
  }
  _buildAsset(r, l) {
    var o = t.join(this.library, r.slice(0, 2), r + ".json"),
      d = s.readFileSync(o);
    i && console.log("building " + o), this.deserializeDetails.reset();
    ...
    (d = null),
      (u._uuid = r),
      this.shouldExportScript && a.reportMissingClass(u),
      a.reset(),
      this.deserializeDetails.assignAssetsBy(this._bindedGetAssetRef);
    var n,
      h = this.deserializeDetails.uuidList.slice();
    h.length > 0 && (n = this.deserializeDetails.uuidObjList.slice()),
      u._native &&
      (this.isJSB ||
...
(o.AssetMissing = "asset missing"), (module.exports = o);
