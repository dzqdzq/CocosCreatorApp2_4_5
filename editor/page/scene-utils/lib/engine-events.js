...
function n(e) {
  ...
  let n = cc.js.getClassName(e),
    c = _Scene.gizmos[n];
  c &&
    (e.gizmo && (e.gizmo.remove(), (e.gizmo = null)),
    (e.gizmo = new c(_Scene.gizmosView, e)),
    _Scene.gizmosView && _Scene.gizmosView.checkNodeGizmoState(e),
    e.gizmo.update()),
    cc.engine.repaintInEditMode();
}
function c(e) {
  e.gizmo && (e.gizmo.remove(), e.gizmo.hide(), (e.gizmo = null)),
    e.trajectoryGizmo &&
      (e.trajectoryGizmo.remove(), (e.trajectoryGizmo = null)),
    cc.engine.repaintInEditMode();
}
function o() {
  let e = Editor.Selection.curActivate("node"),
    n = e && cc.engine.getInstanceById(e);
  if (cc.isValid(n)) {
    let e = n._components;
    for (let n = 0; n < e.length; n++) {
      ...
      if (
        ...
        return (
          cc.engine.setAnimatingInEditMode(!0, "component_playOnFocus"), void 0
        );
    }
  }
...
function i(e) {
  _Scene.gizmosView.onComponentEnable(e),
    cc.engine.getInstanceById(e).constructor._playOnFocus && o(),
    cc.engine.repaintInEditMode();
}
function t(e) {
  _Scene.gizmosView.onComponentDisable(e);
  let n = cc.engine.getInstanceById(e);
  n ? n.constructor._playOnFocus && o() : o(), cc.engine.repaintInEditMode();
}
function r(n) {
  n.gizmo && ((n.gizmo._dirty = n.gizmo._dirty || e), n.gizmo.update()),
    n.trajectoryGizmo && n.trajectoryGizmo.update();
  let c = n._components;
  for (let n = 0, o = c.length; n < o; n++) {
    let o = c[n];
    o.gizmo && ((o.gizmo._dirty = o.gizmo._dirty || e), o.gizmo.update());
  }
...
function d() {
  ...
  n &&
    ...
    (_Scene.gizmosView.update(), n._children.forEach(r), (e = !1));
}
function g() {
