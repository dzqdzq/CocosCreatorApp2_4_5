var t = cc.Class.Attr.DELIMETER,
  e = "A$$ETprops" + t + "A$$ETprops";
function r(t) {
  (this.owner = t), (this.watchingInfos = Object.create(null));
}
...
function a(t, e) {
  ...
  (n.set = function (t, r) {
    if (
      (a.call(this, t, r), this._watcherHandle && this._watcherHandle !== s)
    ) {
      let t = this[e];
...
(r.initComponent = function (t) {
      ...
      ((i = (function (e) {
        for (
          ...
          if (n[l + "hasSetter"] && n[l + "hasGetter"]) {
            var u = e[c];
            (u instanceof cc.Asset || null == u) &&
              (a(s, c), r ? r.push(c) : (r = [c]));
          }
        }
        return r;
      })(n)),
  ...
  (r.start = function (t) {
    t._watcherHandle || r.initHandle(t),
      t._watcherHandle !== s && t._watcherHandle.start();
  }),
  (r.stop = function (t) {
    t._watcherHandle && t._watcherHandle !== s && t._watcherHandle.stop();
  }),
  ...
  (r.prototype.stop = function () {
    for (var t in this.watchingInfos) {
      ...
      e && cc.assetManager.editorExtend.assetListener.off(e.uuid, e.callback);
    }
  ...
  (r.prototype._registerToArray = function (t, e, r) {
    var s = function (t, e, r, s) {
      let a = n(s);
      for (let t = 0; t < r.length; t++) n(r[t]) === a && (r[t] = s);
      i(t, e, r);
  ...
  (r.prototype.changeWatchAsset = function (t, e) {
    ...
    if (Array.isArray(r)) {
      ...
      if (Array.isArray(e)) (r.length = 0), this._registerToArray(t, e, r);
      else {
        let r = n(e);
        r && this._register(t, r);
      }
    } else if (Array.isArray(e))
      r && cc.assetManager.editorExtend.assetListener.off(r.uuid, r.callback),
