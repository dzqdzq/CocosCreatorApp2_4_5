...
const e = require("fire-path"),
  r = (require("fire-url"), require("async")),
  i = (require("fire-fs"), require("node-uuid")),
  o = (require("./source-maps"), require("../global-variables-protecter"));
let a,
  s,
  t,
  n = require,
  l = !1,
  c = require("../../project-scripts"),
  d = c.loadScript;
c.loadScript = function (r, i) {
  var o = g._globalsVerifier_loadPluginScript,
    a = e.relative(Editor.Project.path, r);
  "." === a[0] && (a = r),
    (o.info = "loading " + a),
    o.record(),
    d.call(c, r, () => {
...
let g = {
  reset() {
    cc.Object._deferredDestroy(),
      ...
      this._globalsVerifier_editing.isRecorded() &&
        this._globalsVerifier_editing.restore(),
      this._globalsProtecter.isRecorded() && this._globalsProtecter.restore(),
      cc._RF.reset(),
  ...
  reload(e, i) {
    ...
    var a = {
      ...
      s = Editor.serialize(a, {
        stringify: !1,
        discardInvalid: !1,
        reserveContentsForSyncablePrefab: !0,
      }),
      t = cc.deserialize.reportMissingClass;
    r.waterfall(
      [
        (e) => {
        ...
        (e, r) => {
          (cc.deserialize.reportMissingClass = t),
            ...
            (e.scene._prefabSyncedInLiveReload = !0),
            ...
            (e.scene._prefabSyncedInLiveReload = !1),
      ...
      (e, r) => {
        (cc.deserialize.reportMissingClass = t), (this.reloading = !1), i(e, r);
      }
    );
  },
  loadScripts(e) {
      ...
      c.load((r) => {
        ...
        o.forEach((e) => {
          ...
          cc._componentMenuItems.forEach((e, r) => {
            ...
            a[i] || ((a[i] = []), o.push(i)), a[i].push(e);
          }),
          o.forEach((e) => {
            a[e].sort((e, r) =>
              e.menuPath.localeCompare(r.menuPath, "en", { numeric: !0 })
            );
          });
        let s = [];
        for (let e in a)
          if ("|%%separator%%|" === e) s.push({ type: "separator" });
          else {
            a[e].forEach((e) => {
              s.push({
        ...
        Editor.Menu.register("add-component", s, !0),
  ...
  registerReloadableData(e) {
    var r = i.v4();
    return (this._liveReloadableDatas[r] = e), r;
  },
  popReloadableData(e) {
    var r = this._liveReloadableDatas[e];
    return delete this._liveReloadableDatas[e], r;
  },
