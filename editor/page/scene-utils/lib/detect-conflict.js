...
module.exports = {
    ...
    return (
      ...
      ((i =
        t.type === cc.Layout.Type.GRID
          ...
          : cc.Layout.Type[t.type].toLowerCase()),
      CC_TEST ||
        cc.warn(
  ...
  checkConflict_Layout(e) {
    for (var t = e.node.children, i = 0; i < t.length; ++i) {
      ...
      if (c && this.checkConflict_WidgetLayout(c, e)) return !0;
    }
    return !1;
  },
  checkConflict_Widget(e) {
    ...
    if (cc.Node.isNode(t)) {
      ...
      if (i && i.resizeMode === cc.Layout.ResizeMode.CONTAINER)
        return this.checkConflict_WidgetLayout(e, i), !0;
    }
    return !1;
  },
  afterAddChild(e) {
    ...
    !(
      ...
      (function (e) {
        for (; e && !(e instanceof cc.Scene); e = e._parent)
          if (e._objFlags & cc.Object.Flags.HideInHierarchy) return !0;
        return !1;
      })(i)
    ) &&
