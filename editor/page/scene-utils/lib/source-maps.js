...
var r = require("util"),
  e = require("async"),
  t = require("source-map").SourceMapConsumer,
  s = require("fire-fs"),
  n = require("fire-path");
const i = "InTryCatch",
  o = "CCComponent.js",
  a = "//# sourceMappingURL=data:application/json;charset=utf-8;base64,",
  l = " (eval at ",
  u = " ".repeat(4) + "at ",
  c = " (",
  f = ")",
...
function v(r) {
  return (r = r.replace(/\\/g, "/")).startsWith("file:///") && (r = p(r)), r;
}
class g {
  constructor(r) {
  ...
  load(r, t) {
    console.time("load sourcemaps for " + this.name),
      e.map(r, this.loadSingle.bind(this), (r, e) => {
        var s = [];
        for (var n of e) n && (s = s.concat(n));
        console.timeEnd("load sourcemaps for " + this.name), t(r, s);
      });
  }
}
class b {
  ...
  load(r, t) {
    e.reduce(
      ...
      (r, e) => {
        this._cacheSourcesContent(), this._normalizeGeneratedUrl(), t();
      }
    );
  }
  flow(r, e, t) {
  ...
  transform(r, e, t) {
    var s = r.split("\n"),
      n = 1;
    e && t ? (s.shift(), (s[0] = e)) : (n = this._adjustStack(s, e, t));
    for (var i = n; i < s.length; i++) {
      ...
      if (a.startsWith(u) && a.charCodeAt(a.length - 1) === h) {
        ...
        if (-1 !== m) {
          ...
          if (-1 === (m = a.lastIndexOf(c))) continue;
        ...
        if (-1 !== b) {
          ...
          if (!isNaN(S) && -1 !== (b = d.lastIndexOf(":", b - 1))) {
            ...
            if (!isNaN(O)) {
              ...
              if (
                (w.startsWith("file:///") && (w = p(w)),
                this.filters[0].sourceMaps[w])
              ) {
                var x = i === n,
                  M = this._transformLine(a, w, O, S, x, m);
                M && (s[i] = M);
              }
            }
          }
  ...
  _adjustStack(r, e, t) {
    ...
    return (
      e
        ? (s = 1)
        : -1 === (s = r.findIndex((r) => r.startsWith(u))) && (s = r.length),
      t ? (e ? (r.shift(), (r[0] = e)) : r.splice(s, 1)) : e && (r[0] = e),
      s
    );
  }
  ...
  _transformLine(r, e, t, s, n, i) {
    ...
    if (o) {
      var a;
      if (((e = o.url), (s = o.columnNum), (t = o.lineNum), n)) {
        var l = o.sources[e];
        if (l) {
          var u = l[o.injectedLineNum];
          u && (a = `${r.substring(0, i)}: "${u}" (`);
        }
      }
      return (
  ...
  _cacheSourcesContent() {
    ...
    for (var r = 0; r < this.filters.length; r++) {
      ...
      for (var s in e) {
        ...
        (n.sources = o), (i.sourcesContent = void 0), (n.json = null);
      }
    }
            ...
            (r, e, t) => {
              if (r.startsWith("assets")) {
                var s = "db://" + r.replace(/\\/g, "/"),
                  i = Editor.assetdb.remote.urlToUuid(s);
                if (i) {
    ...
    : [
        ...
        new (class extends g {
          ...
          loadSourceMapsJSON(r, e) {
            ...
            Editor.Utils.UuidUtils.isUuid(t)
  ...
  (module.exports = {
    init: function () {
      ...
      cc.error = Editor.error = function (t) {
        if (t instanceof Error) t = e.transform(t.stack, "", !1);
        else {
          t =
            arguments.length > 1
