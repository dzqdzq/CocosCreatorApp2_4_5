...
var e = [
  ...
  t = cc.Class.Attr.DELIMETER + "hasGetter",
  r = cc.Class.Attr.DELIMETER + "hasSetter",
  n = cc.Class.Attr.DELIMETER + "serializable";
function o(e) {
...
function i(o) {
  if (!o || "object" != typeof o)
    return Editor.error("Unknown object to record"), void 0;
  if (Array.isArray(o) || ArrayBuffer.isView(o)) return o.map(s);
  var i = o.constructor;
  if (i === Object) return c(o, Object.getOwnPropertyNames(o), s);
  if (cc.Class._isCCClass(i)) {
    var a = i.__props__,
      f = cc.Class.Attr.getClassAttrs(i),
      u = c(o, a, s, function (c) {
        var s = f[c + t];
        return (
          !(!s && !1 === f[c + n]) &&
          s === f[c + r] &&
          (!o.hasOwnProperty(c) || "function" !== o[c]) &&
          (!cc.Node.isNode(o) || !e.includes(c))
        );
      });
    return (
      o.__asyncStates &&
...
function f(e, t, r) {
  var n,
    c = t.length;
  if ((Array.isArray(e) && (e.length = t.length), r))
    for (n = 0; n < c; n++) e[n] = r(e[n], t[n]);
  else for (n = 0; n < c; n++) e[n] = o(t[n]);
}
function u(e, t, r) {
  var n;
  for (n in e) n in t || delete e[n];
  if (r) for (n in t) e[n] = r(e[n], t[n]);
  else for (n in t) e[n] = o(t[n]);
}
function l(e, t) {
  var r, n, o;
    ...
    for (o in t)
      if ((r = cc.js.getPropertyDescriptor(e, o)) && r.set) {
        ...
        if (n !== c) {
          ...
          } else if (c instanceof cc.ValueType && c.equals(n)) continue;
          e[o] = n;
        }
      }
  for (o in t) {
    if ((r = Object.getOwnPropertyDescriptor(e, o)) && "value" in r)
      r.writable && (e[o] = a(e[o], t[o]));
  }
  (function (e, t) {
    ...
    if (r)
      for (var n in r) {
        var o = r[n];
        "start" === o.state && Editor.setAsset(e, n, o.uuid);
      }
  })(e, t);
}
function d(e, t) {
...
function p(e, t) {
  ...
  if (!t) return Editor.error("Invalid record to restore");
  if (Array.isArray(e) || ArrayBuffer.isView(e)) f(e, t, a);
  else {
    var r = e.constructor;
    r === Object
      ? u(e, t, a)
      : cc.Class._isCCClass(r)
      ? l(e, t)
...
function y(e) {
  var t = e.constructor;
  cc.Class._isCCClass(t) && "function" == typeof e.onRestore && e.onRestore();
}
function b(e) {
  (e._objFlags &= cc.Object.Flags.PersistentMask),
    (e._objFlags &= ~cc.Object.Flags.Destroyed),
    e instanceof cc.Component && (cc.engine.attachedObjsForEditor[e.uuid] = e);
}
module.exports = {
  recordObject: i,
  restoreObject: d,
