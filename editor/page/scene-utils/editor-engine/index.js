"use strict";
require("../utils/node"), require("../utils/animation");
const i = require("./lib/ticker"),
  t = require("./lib/time"),
  e = require("./lib/playable"),
  n = cc.Class({
    name: "EditorEngine",
    extends: e,
    ctor: function () {
    ...
    init: function (i, t) {
      if (this._isInitializing)
        return cc.error("Editor Engine already initialized"), void 0;
      ...
      this.createGame(i, function (n) {
        (e._isInitialized = !0),
          (e._isInitializing = !1),
          t(n),
          CC_EDITOR && !i.dontTick && e.startTick();
      });
    },
    ...
    playInEditor: function () {
      CC_EDITOR &&
        ...
        cc.imeDispatcher._domInputControl &&
    ...
    tickInEditMode: function (i, t) {
      CC_EDITOR && cc.director.mainLoop(i, t);
    },
    ...
    onResume: function () {
      CC_EDITOR && cc.Object._clearDeferredDestroyTimer(),
        cc.game.resume(),
        CC_DEV && !this._useDefaultMainLoop && this._tickStop();
    },
    onPause: function () {
    ...
    onPlay: function () {
      if (
        (CC_EDITOR && !this._isPaused && cc.Object._clearDeferredDestroyTimer(),
        this.playInEditor(),
        (this._shouldRepaintInEM = !1),
        this._useDefaultMainLoop)
      ) {
        var e = i.now();
        t._restart(e), this._tickStart();
      } else CC_EDITOR && this._tickStop();
    },
    onStop: function () {
      cc.game.pause(),
        (this._loadingScene = ""),
        CC_EDITOR && (this.repaintInEditMode(), this._tickStart());
    },
    startTick: function () {
      this._tickStart(),
    ...
    _tick: function () {
      ...
      var e = i.now();
      this._isUpdating || this._stepOnce
        ? (t._update(e, !1, this._stepOnce ? 1 / 60 : 0),
          (this._stepOnce = !1),
          this.tick(t.deltaTime, !0))
        : CC_EDITOR &&
          (t._update(e, !1, this.maxDeltaTimeInEM),
          (this._shouldRepaintInEM || this._animatingInEditMode > 0) &&
    ...
    _tickStop: function () {
      -1 !== this._requestId &&
        (i.cancelAnimationFrame(this._requestId), (this._requestId = -1));
    },
    reset: function () {
      (cc.game._prepared = !1),
        (cc.game._rendererInitialized = !1),
