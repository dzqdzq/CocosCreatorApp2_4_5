cc._widgetManager.updateOffsetsToStayPut = function (t, e) {
  ...
  if (o) {
    var r = cc.Vec2.ZERO,
      h = cc.Vec2.ONE;
    t._target &&
      ((o = t._target), this._computeInverseTransForTarget(a, o, r, h));
    ...
    if ((void 0 === e && (e = t._alignFlags), e & l.LEFT)) {
      ...
      t.isAbsoluteLeft || (y /= s.width), (y /= h.x), (t.left = i(t.left, y));
    }
    if (e & l.RIGHT) {
      var d = (1 - g.x) * s.width;
      d += r.x;
      var f = (d *= h.x) - (n.x + (1 - c.x) * a.width * a.scaleX);
      t.isAbsoluteRight || (f /= s.width),
        (f /= h.x),
        (t.right = i(t.right, f));
    }
    if (e & l.TOP) {
      ...
      t.isAbsoluteTop || (u /= s.height), (u /= h.y), (t.top = i(t.top, u));
    }
    if (e & l.BOT) {
      var _ = -g.y * s.height;
      (_ += r.y), (_ *= h.y);
      var w = n.y - c.y * a.height * a.scaleY - _;
      t.isAbsoluteBottom || (w /= s.height),
        (w /= h.y),
