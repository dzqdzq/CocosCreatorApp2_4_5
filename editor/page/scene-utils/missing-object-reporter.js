var e = require("lodash"),
  t = require("fire-url"),
  s = require("../../share/engine-extends/object-walker"),
  i = Editor.require("app://editor/page/scene-utils/utils/node"),
  o = require("./missing-reporter");
function n(e) {
  o.call(this, e);
}
cc.js.extend(n, o),
  (n.prototype.doReport = function (t, s, n, r, c) {
    ...
    (a =
      ...
      : (a = e.findLast(n, (e) => e instanceof cc.Node)) &&
        (u = ` by node "${a.name}"`);
    if ("string" == typeof s) d = `Asset "${s}" used${u}${c} is missing.`;
    else {
      var p = cc.js.getClassName(s);
      p.startsWith("cc.") && (p = p.slice(3)),
        (d =
          s instanceof cc.Asset
            ? `The ${p} used${u}${c} is missing.`
            : `The ${p} referenced${u}${c} is invalid.`);
    }
    (d += o.INFO_DETAILED),
      a instanceof cc.Component && (a = a.node),
      a instanceof cc.Node && (d += `Node path: "${i.getNodePath(a)}"\n`),
      r && (d += `Asset url: "${r}"\n`),
      s instanceof cc.Asset && s._uuid && (d += `Missing uuid: "${s._uuid}"\n`),
      d.slice(0, -1),
      Editor.warn(d);
  }),
  (n.prototype.report = function () {
    var e;
    this.root instanceof cc.Asset &&
      (e = Editor.assetdb.remote.uuidToUrl(this.root._uuid));
    var i = o.getObjectType(this.root),
      n = e ? ` in ${i} "${t.basename(e)}"` : "";
    s.walk(this.root, (t, s, i, o, r) => {
      this.missingObjects.has(i) && this.doReport(t, i, o, e, n);
    });
  }),
