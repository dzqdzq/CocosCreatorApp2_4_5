var e = require("lodash"),
  s = require("fire-url"),
  r = require("../../share/engine-extends/object-walker"),
  i = Editor.require("app://editor/page/scene-utils/utils/node"),
  t = cc.js._getClassById,
  n = require("./missing-reporter");
  ...
  (d = d || (r._$erialized && r._$erialized.__type__)),
    (function (e, r, t, o) {
      ...
      if (t instanceof cc.SceneAsset || t instanceof cc.Prefab) {
        var d, l, p;
        e instanceof cc.Component
          ? (p = (l = e).node)
          : cc.Node.isNode(e) && (p = e);
        var u = c ? ` in ${a} "${c}"` : "",
          f = r,
          h = !1;
        if (l) {
          var g = cc.js.getClassName(l);
          l instanceof cc._MissingScript &&
...
cc.js.extend(a, n),
  (a.prototype.report = function () {
    r.walk(this.root, (e, s, r, i) => {
      this.missingObjects.has(r) && o(r, e, i, this.root);
    });
  }),
...
var c = {
  ...
  classFinder: function (e, s, r, i) {
    ...
    return (
      n ||
      (e && ((c.hasMissingClass = !0), c.reporter.stashByOwner(r, i, e)), null)
    );
  },
  hasMissingClass: !1,
...
(c.classFinder.onDereferenced = function (e, s, r, i) {
  ...
  t && c.reporter.stashByOwner(r, i, t);
}),
