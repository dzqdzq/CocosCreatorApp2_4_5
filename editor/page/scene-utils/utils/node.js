...
function r(e) {
  var t,
    n = e._components.length;
  for (t = 0; t < n; ++t) {
    var o = e._components[t];
    o._enabled && cc.director._compScheduler.disableComp(o);
  }
...
function s(e) {
  const t = new cc.Vec3();
  return cc.Vec3.subtract(t, e.maxPosition, e.minPosition), t;
}
function a(e) {
  const t = s(e),
    n = new cc.Vec3();
  return cc.Vec3.scaleAndAdd(n, e.minPosition, t, 0.5), n;
}
function l(e, t) {
  const n = i(t),
    o = s(n);
...
function u(e, t) {
  ...
  if (1 === c + r + (0 === o.z ? 1 : 0)) {
    const e = 0.001;
    c ? (o.x = e) : r ? (o.y = e) : (o.z = e);
  }
  (e.size = o), (e.center = a(n));
}
(n.getObbFromRect = function (e, t, n, o, c, r) {
  let i = t.x,
    ...
    a = t.width,
    l = t.height,
    u = e.m[0] * i + e.m[4] * s + e.m[12],
    d = e.m[1] * i + e.m[5] * s + e.m[13],
    f = e.m[0] * a,
    g = e.m[1] * a,
    m = e.m[4] * l,
    h = e.m[5] * l;
  ...
  (n.getWorldOrientedBounds = function (e, t, c, r, i, s) {
    ...
    if ((e.getWorldMatrix(o), a)) return n.getObbFromMeshRenderer(a, o);
    {
      t = t || e.getContentSize();
      let a = e.getAnchorPoint(),
        l = t.width,
        u = t.height,
        d = new cc.Rect(-a.x * l, -a.y * u, l, u),
        f = n.getObbFromRect(o, d, c, r, i, s),
        g = n.getWorldPosition3D(e);
      return (
        f.forEach((e) => {
          e.z = g.z;
        }),
  ...
  (n.setScenePosition = function (e, t) {
    ...
    if (!o)
      return (
        cc.error("Can not access scenePosition if no running scene"), void 0
      );
  ...
  (n.setSceneRotation = function (e, t) {
    ...
    if (!o)
      return (
        cc.error("Can not access sceneRotation if no running scene"), void 0
      );
  ...
  (n.setWorldRotation = function (e, t) {
    if (isNaN(t)) cc.error("The new worldRotation must not be NaN");
    else {
      let o = e.parent;
      o
        ? o instanceof cc.Scene
          ? (e.angle = t - o.angle)
  ...
  (n._hasFlagInComponents = function (e, t) {
    ...
    for (let e = 0, o = n.length; e < o; ++e) {
      if (n[e]._objFlags & t) return !0;
    }
    return !1;
  }),
  (n._destroyForUndo = function (e, t) {
    cc.Node.isNode(e) &&
      (e._activeInHierarchy && r(e),
      (function (e) {
  ...
  (n.getNodePath = function (e) {
    ...
    for (; e && !(e instanceof cc.Scene); )
      (t = t ? e.name + "/" + t : e.name), (e = e._parent);
    return t;
  }),
  (n.createNodeFromAsset = function (t, n) {
    ...
    cc.assetManager.editorExtend.queryAssetInfo(t, (c, r, i) => {
      ...
      if (cc.js.isChildClassOf(i, cc._Script)) {
        let e,
          c = Editor.Utils.UuidUtils.compressUuid(t),
          i = cc.js._getClassById(c);
        if (cc.js.isChildClassOf(i, cc.Component))
          (e = new cc.Node(cc.js.getClassName(i))).addComponent(i), n(null, e);
        else {
          let e = (!CC_TEST && require("fire-url")).basename(r);
          "compiling" === Editor.remote.Compiler.state || o.reloading
            ? n(
                new Error(
          ...
          if (o.createNode) {
            if (o instanceof cc.Prefab) {
              if (e && e.get("auto-sync-prefab")) {
                require("./prefab")._setPrefabSync(o.data, !0);
              }
            }
            o.createNode(n);
          } else
  ...
  (n.createNodeFromClass = function (e, t) {
    ...
    if (e) {
      ...
      if (t) {
        ...
        c && cc.director._nodeActivator.resetComp(c, !0);
      } else o = new Error(`Unknown node to create: ${e}`);
    }
    t && t(o, n);
  }),
  ...
  (n.getWorldPosition3D = function (e) {
    let t = cc.mat4(),
      n = cc.v3(0, 0, 0);
    return e.getWorldMatrix(t), cc.Vec3.transformMat4(n, n, t), n;
  }),
  (n.setWorldPosition3D = function (e, t, o = 3) {
    ...
    if (t instanceof cc.Vec3) {
      ...
      (c = n.makeVec3InPrecision(c, o)), e.setPosition(c.x, c.y, c.z);
    } else cc.error("The new worldPosition must be cc.Vec3");
  }),
  (n.getWorldRotation3D = function (e) {
    let o = e.parent,
      c = cc.quat(0, 0, 0, 1),
      r = cc.quat(0, 0, 0, 1);
    return e.getRotation(r), o ? (t.mul(c, n.getWorldRotation3D(o), r), c) : r;
  }),
  (n.setWorldRotation3D = function (e, o, c = 3) {
    if (o instanceof cc.Quat) {
      let r = e.parent,
        i = cc.quat(0, 0, 0, 1),
        s = cc.quat(0, 0, 0, 1);
      r ? (r.getRotation(i), t.conjugate(i, i), t.mul(s, i, o)) : (s = o);
      let a = cc.v3();
      t.toEuler(a, s),
        (a = n.makeVec3InPrecision(a, c)),
        n.setEulerAngles(e, a);
    } else cc.error("The new worldRotation must be Quat");
  }),
...
(n.addComponentHandle = function (e, t) {
  t.constructor && d[t.constructor.name] && d[t.constructor.name](t, e);
}),
  (module.exports = n);
