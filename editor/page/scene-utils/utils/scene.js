...
let a = null,
  ...
  u = function (e, t, o, c, r) {
    let i;
    t && (i = cc.engine.getInstanceById(t)),
      i || (i = cc.director.getScene()),
    ...
    let d = e.map((e) => {
      return new Promise(function (t, r) {
        n.createNodeFromAsset(e, (e, n) => {
          ...
          let d;
          if (n) {
            if (((d = n.uuid), i && (n.parent = i), c)) {
              n.parent = null;
              let e = cc.engine.getInstanceById(c).getSiblingIndex();
              (n.parent = i), n.setSiblingIndex(e);
            }
            _Scene.Undo.recordCreateNode(d);
          }
          d && Editor.Selection.select("node", d, !1, !1),
            cc.engine.repaintInEditMode(),
            o &&
              o.unlinkPrefab &&
              ((n && n.parent && n.parent._prefab) ||
    ...
    Promise.all(d)
      .then((e) => {
        _Scene.Undo.commit(), Editor.Selection.confirm(), r && r(null, e);
      })
      .catch((e) => {
        _Scene.Undo.commit(), Editor.Selection.cancel(), r && r(e);
      });
  },
  m = function (e, n, t) {
    ...
    return !(o && !e.getComponent(o)) || m(e, o, !0);
  },
  g = function (e, n) {
    let t = Editor.Utils.UuidUtils.isUuid(n),
      o = cc.js._getClassById(n);
    if (!o)
      return t
        ? (Editor.error(`Can not find cc.Component in the script ${n}.`), !1)
        : (Editor.error(`Failed to get component ${n}`), !1);
    let c = cc.engine.getInstanceById(e);
    return c ? m(c, o) : (Editor.error(`Can not find node ${e}`), !1);
  },
  p = function (e, n) {
    let o = cc.engine.getInstanceById(n);
    if (!o) return Editor.error(`Can not find component ${n}`), !1;
    if (t.STATE.RECORD)
      return (
        o instanceof cc.Animation
          ? Editor.Dialog.messageBox({
              type: "warning",
    ...
    let c = cc.engine.getInstanceById(e);
    if (!c) return Editor.error(`Can not find node ${e}`), void 0;
...
module.exports = {
  createDefaultScene: function () {
    let e = new cc.Scene(),
      n = new cc.Node("Canvas");
    (n.parent = e), n.addComponent(cc.Canvas);
  ...
  isAnyChildClassOf: function (e, ...n) {
    for (var t = 0; t < n.length; ++t)
      if (cc.js.isChildClassOf(e, n[t])) return !0;
    return !1;
  },
  ...
  pasteNodes: function (e) {
    if (!a || t.STATE.RECORD) return;
    let n;
    e && (n = cc.engine.getInstanceById(e)), n || (n = cc.director.getScene());
    let o = [];
    for (let e in a.nodes) {
      let t = cc.instantiate(a.nodes[e]);
      (t.parent = n), o.push(t.uuid), _Scene.Undo.recordCreateNode(t.uuid);
    }
    _Scene.Undo.commit(), Editor.Selection.select("node", o);
  },
  duplicateNodes: function (e) {
    if (t.STATE.RECORD) return;
      ...
      if (t && !r.isChildOf(t)) {
        ...
        if (t.parent !== r) {
          ...
          (t.parent = r),
            ...
            (t.parent = null);
          let c = d ? i(d) : -1;
          (t.parent = r), t.setSiblingIndex(c);
        } else {
          let e = i(t),
            n = d ? i(d) : -1;
          e < n && (n -= 1), t.setSiblingIndex(n);
        }
        !a &&
          (n = n || o.getSyncedRootInScene(r)) &&
          ((await o.confirmPrefabSynced(n)) || _Scene.Undo.undo());
      }
    }),
      _Scene.Undo.commit();
  },
  ...
  copyComponent: function (e) {
    ...
    n && (s = cc.instantiate(n, !0));
  },
  pasteComponent: function (e, n) {
    let t = cc.engine.getInstanceById(e);
    if (t && s) {
      let o = cc.instantiate(s, !0);
      t._addComponentAt(o, n),
        cc.director._nodeActivator.resetComp(o, !1),
  ...
  createNodeByClassID: function (e, t, o, c) {
    let r;
    o && ((r = cc.engine.getInstanceById(o)), c && (r = r.parent)),
      r || (r = cc.director.getScene());
    n.createNodeFromClass(t, (n, t) => {
      if (n) return Editor.error(n);
      (t.name = e),
        (t.parent = r),
        cc.engine.repaintInEditMode(),
        Editor.Selection.select("node", t.uuid, !0, !0),
  ...
  createNodeByPrefab: function (e, t, c, r) {
    ...
    n.createNodeFromAsset(t, (n, t) => {
      if (n) return Editor.error(n), void 0;
      o.unlinkPrefab(t, !0),
        (t.name = e),
        c && ((i = cc.engine.getInstanceById(c)), r && (i = i.parent)),
        i || (i = cc.director.getScene());
      var d = t.getComponent(cc.Canvas);
      d && _Scene._applyCanvasPreferences(d),
        (t.parent = i),
        cc.engine.repaintInEditMode(),
        Editor.Selection.select("node", t.uuid, !0, !0),
        _Scene.Undo.recordCreateNode(t.uuid),
  ...
  deleteNodes: function (e) {
    ...
    l(o).forEach((e) => {
      ...
      _Scene.Undo.commit(),
      Editor.Selection.unselect("node", e, !0);
  },
  checkAddComponentID: g,
  addComponent: function (e, o) {
    if (!g(e, o)) return;
    let c = cc.engine.getInstanceById(e),
      r = cc.js._getClassById(o),
      i = c.addComponent(r);
    i &&
      (cc.director._nodeActivator.resetComp(i, !0),
  ...
  createProperty: function (e, n, t) {
    ...
    if (c)
      try {
        let r,
          i = cc.Class.attr(c.constructor, n);
        if (i && Array.isArray(o(i.default))) r = [];
        else {
  ...
  resetProperty: function (e, n, t) {
    ...
    if (o) {
      ...
      _Scene.Undo.commit(), cc.engine.repaintInEditMode();
    }
  },
  setProperty: function (e) {
    let n = cc.engine.getInstanceById(e.id);
    if (!n) return !1;
    if (t.isRecordCurrentClip(n, e)) return !1;
    try {
      let o = n;
      if (
        (o instanceof cc.Component && (o = n.node),
        ...
        let e = setInterval(() => {
          E(n) || (clearInterval(e), t.recordNodeChanged([o], n));
        }, 100);
      } else t.recordNodeChanged([o], n);
      return !0;
    } catch (t) {
      return (
        t instanceof Editor.setPropertyByPath.ProhibitedException ||
          Editor.warn(
    ...
    if (e && n && n.length > 0) {
      ...
      if (
        ...
        for (let e = 1; e < n.length; e++) {
          let t = n[e],
            d = t.getWorldPosition(cc.v3()),
            a = t.getWorldRotation(cc.quat());
          _Scene.Undo.recordNode(t.uuid),
