var t = Editor.require(
  ...
  e = ["currentImport", "webkitIndexedDB", "webkitStorageInfo"],
  o = ["object", "function", "boolean"],
  i = window;
function n(t) {
  (this.info = ""),
    (this.onIntroduced = this.onModified = this.onDeleted = null),
    (this.dontRestoreIntroduce =
      this.dontRestoreModify =
      this.dontRestoreDelete =
        !1);
  var o = e;
  if (t) {
    t.ignoreNames && (o = o.concat(t.ignoreNames));
    var i = t.callbacks;
    i &&
      ("function" == typeof i
...
(n.prototype = {
  record: function () {
    for (var t in ((this._snapshot = {}), i))
      i.hasOwnProperty(t) && !this.ignoreNames[t] && (this._snapshot[t] = i[t]);
    return this;
  },
  isRecorded: function () {
    ...
    for (t in (console.assert(this.isRecorded(), "Should recorded"), i))
      if (i.hasOwnProperty(t) && !this.ignoreNames[t]) {
            ...
            if (o.includes(typeof n)) {
              if (this.onModified) {
                var s = Editor.Utils.toString(n) || '""',
                  d = Editor.Utils.toString(i[t]) || '""';
                this.onModified(
                  `Modified global variable while ${this.info}: ${t}\nBefore: ${s}\nAfter: ${d}`
                );
              }
              this.dontRestoreModify || (i[t] = n);
            }
            continue;
          }
        }
        if (
          ...
          r || (this._snapshot[t] = i[t] = void 0);
        }
      }
    for (t in this._snapshot)
      t in i ||
        this.ignoreNames[t] ||
        (this.onDeleted &&
          this.onDeleted(`Deleted global variable while ${this.info}: ${t}`),
        this.dontRestoreDelete || (i[t] = this._snapshot[t]));
  },
}),
  (module.exports = n);
