(() => {
  ...
  function t(t, i) {
    ...
    (e.ready = function () {
      for (let t = 0; t < i.length; t++) {
        let e = i[t],
          u = this.querySelector(`#${e}-comp`),
          s = u.children[0];
        this.value && (s.value = this.value[e]),
          this.values && (s.values = this.values.map((t) => t[e])),
      ...
      (e.valuesChanged = function (t, e) {
        for (let t = 0; t < i.length; t++) {
          ...
          (this[`$input${u}`].values = e.map((t) => t[u])),
            this.multiValues && this._updateMulti(u);
        }
      }),
      ...
      (e._updateMulti = function (t) {
        ...
        e.every((t, i) => 0 == i || t == e[i - 1])
          ? (i.removeAttribute("multi-values"), (i.value = e[0]))
          : (i.setAttribute("multi-values", ""), (i.values = e));
      }),
  ...
  Editor.UI.registerProperty("String", Editor.UI.getProperty("string")),
    ...
    Editor.UI.registerProperty("Integer", {
      ...
      _updateMultiValue() {
        ...
        this._values.every((t, i) => 0 == i || t == this._values[i - 1])
    ...
    Editor.UI.registerProperty("Enum", {
      ...
      ready(t) {
        (this.$input = this.querySelector("ui-prop>ui-select")),
          this.installStandardEvents(this.$input),
          this.attrs && this.attrs.enumList
    ...
    Editor.UI.registerProperty("cc.Asset", {
      ...
      valuesChanged(t, i) {
        (this.$input.values = i.map((t) => t.uuid)),
          this.multiValues && this._updateMultiValue();
      },
      multiValuesChanged(t, i) {
        this._updateMultiValue();
      },
      _updateMultiValue() {
        if (!this.multiValues || !this.values || this.values.length <= 1)
          return this.$input.removeAttribute("multi-values");
        var t = this.values[0];
        this.values.every((i, e) => 0 == e || i.uuid == t.uuid)
          ? this.$input.removeAttribute("multi-values")
          : this.$input.setAttribute("multi-values", "");
      },
    }),
    ...
    Editor.UI.registerProperty("cc.Size", {
      ...
      ready() {
        (this.$propW = this.querySelector("#w-comp")),
          ...
          this.value && (this.$inputW.value = this.value.width),
          this.values &&
          ...
          this.value && (this.$inputH.value = this.value.height),
          this.values &&
        ...
        t && ((this.$inputW.step = t), (this.$inputH.step = t));
      },
      inputValue() {
        return {
      ...
      valuesChanged(t, i) {
        (this.$inputW.values = i.map((t) => t.width)),
          ...
          this.multiValues && (this._updateMultiW(), this._updateMultiH());
      },
      multiValuesChanged(t, i) {
    ...
    Editor.UI.registerProperty("cc.Color", {
      ...
      ready() {
        (this.$input = this.children[0]),
          this.value && this.valueChanged(null, this.value),
          this.installStandardEvents(this.$input),
    ...
    Editor.UI.registerProperty("cc.Rect", {
      ...
      ready() {
        this.setAttribute("auto-height", ""),
          ...
          this.value && (this.$inputX.value = this.value.x),
          this.values && (this.$inputX.values = this.values.map((t) => t.x)),
          this.installStandardEvents(this.$inputX),
          (this.$inputY = this.querySelector("#y-input")),
          this.value && (this.$inputY.value = this.value.y),
          this.values && (this.$inputY.values = this.values.map((t) => t.y)),
      ...
      _updateMultiX() {
        ...
        var t = this.values[0];
        this.values.every((i, e) => 0 == e || i.x == t.x)
      ...
      _updateMultiY() {
        ...
        var t = this.values[0];
        this.values.every((i, e) => 0 == e || i.y == t.y)
      ...
      _updateMultiW() {
        if (!this.multiValues || !this.values || this.values.length <= 1)
          return this.$inputW.removeAttribute("multi-values");
        var t = this.values[0];
        this.values.every((i, e) => 0 == e || i.width == t.width)
          ? this.$inputW.removeAttribute("multi-values")
          : this.$inputW.setAttribute("multi-values", "");
      },
      _updateMultiH() {
        if (!this.multiValues || !this.values || this.values.length <= 1)
          return this.$inputH.removeAttribute("multi-values");
        var t = this.values[0];
        this.values.every((i, e) => 0 == e || i.height == t.height)
          ? this.$inputH.removeAttribute("multi-values")
          : this.$inputH.setAttribute("multi-values", "");
      },
    }),
    Editor.UI.registerProperty("cc.Vec4", {
      ...
      ready() {
        this.setAttribute("auto-height", ""),
          ...
          this.value && (this.$inputZ.value = this.value.z),
          this.values && (this.$inputZ.values = this.values.map((t) => t.z)),
          this.installStandardEvents(this.$inputZ),
          (this.$inputW = this.querySelector("#w-input")),
          this.value && (this.$inputW.value = this.value.w),
          this.values && (this.$inputW.values = this.values.map((t) => t.w)),
          this.installStandardEvents(this.$inputW),
          (this.multiValues = this.getAttribute("multi-values"));
      },
      inputValue() {
        var t = this.$inputX.multiValues,
          i = this.$inputY.multiValues,
          e = this.$inputZ.multiValues,
          u = this.$inputW.multiValues;
        return {
          x: t ? null : this.$inputX.value,
          y: i ? null : this.$inputY.value,
      ...
      _updateMultiZ() {
        ...
        var t = this.values[0];
        this.values.every((i, e) => 0 == e || i.z == t.z)
      ...
      _updateMultiW() {
        if (!this.multiValues || !this.values || this.values.length <= 1)
          return this.$inputW.removeAttribute("multi-values");
        var t = this.values[0];
        this.values.every((i, e) => 0 == e || i.w == t.w)
          ? this.$inputW.removeAttribute("multi-values")
          : this.$inputW.setAttribute("multi-values", "");
      },
    });
