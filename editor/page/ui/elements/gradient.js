...
const t = require("chroma-js"),
  i = Editor.UI._ResMgr,
  s = Editor.UI._DomUtils,
  a = Editor.UI._FocusMgr,
  r = Editor.UI.Focusable,
  n = Editor.UI.Disable,
  o = Editor.UI.Readonly;
module.exports = Editor.UI.registerElement("ui-gradient", {
  ...
  set value(e) {
    if (!e) return this.removeAttribute("value"), void 0;
    "object" != typeof e && (e = { alpha: [], color: [] });
    try {
      this.setAttribute("value", JSON.stringify(e));
    } catch (e) {
      console.warn(e), this.removeAttribute("value");
    }
  },
  behaviors: [r, n, o],
  template:
  ...
  ready() {
    (this._showing = !1),
      ...
      this._initEvents(),
      e ||
        (((e = document.createElement("ui-gradient-picker")).style.position =
          "fixed"),
        (e.style.zIndex = 999),
        (e.style.display = "none"));
  },
  detachedCallback() {
    this._showGradientPicker(!1);
  },
  _initEvents() {
    this.addEventListener("mousedown", (t) => {
      this.disabled ||
        ...
        this.readonly ||
          (this._showing
            ? this._showGradientPicker(!1)
            : ((e.value = this.value), this._showGradientPicker(!0))));
    }),
    ...
    if (t !== i)
      switch (e) {
        case "invalid":
          ...
          break;
        case "value":
          (this.invalid = !1), this._updateColor();
      }
  },
  _updateColor() {
    const e = this.invalid
      ...
      t = e.alpha || [{ value: 1, progress: 0 }],
      i = e.color || [{ value: "#ffffff", progress: 0 }],
      s = (this._map = {
    ...
    t.forEach((e, i) => {
      ((s[e.progress] = s[e.progress] || {}).a = (255 * e.value) | 0),
        i === t.length - 1 && (s[1].a = (255 * e.value) | 0),
        0 === i && (s[0].a = (255 * e.value) | 0);
    }),
      i.forEach((e, t) => {
        const a = this._convertToRGB(e.value),
          r = (s[e.progress] = s[e.progress] || {});
        (r.r = a[0]),
          (r.g = a[1]),
          (r.b = a[2]),
          t === i.length - 1 &&
            ((s[1].r = a[0]), (s[1].g = a[1]), (s[1].b = a[2])),
          0 === t && ((s[0].r = a[0]), (s[0].g = a[1]), (s[0].b = a[2]));
      });
    ...
    a.forEach((e, t) => {
      const i = s[e];
      void 0 === i.r && (i.r = Math.round(r(t, "r"))),
        void 0 === i.g && (i.g = Math.round(r(t, "g"))),
        void 0 === i.b && (i.b = Math.round(r(t, "b"))),
        void 0 === i.a && (i.a = Math.round(r(t, "a"))),
        (i.progress = e);
    }),
      a.forEach((e, t) => {
        const i = s[e];
  ...
  _emitConfirm() {
    s.fire(this, "confirm", { bubbles: !0, detail: { value: this.value } });
  },
  _emitCancel() {
    s.fire(this, "cancel", { bubbles: !0, detail: { value: this.value } });
  },
  _emitChange() {
    s.fire(this, "change", { bubbles: !0, detail: { value: this.value } });
  },
