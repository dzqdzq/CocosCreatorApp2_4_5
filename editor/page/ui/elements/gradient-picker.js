...
const t = require("chroma-js"),
  e = Editor.UI._ResMgr,
  o = Editor.UI._DomUtils,
  r = Editor.UI.Focusable;
module.exports = Editor.UI.registerElement("ui-gradient-picker", {
  get value() {
    return this._value;
  },
  set value(t) {
    if (!t) return this.removeAttribute("value"), void 0;
    "object" != typeof t && (t = { alpha: [], color: [] });
    try {
      this.setAttribute("value", JSON.stringify(t));
    } catch (t) {
      console.warn(t), this.removeAttribute("value");
    }
  },
  get fixed() {
  ...
  hide(t) {
    o.fire(this, "hide", { bubbles: !1, detail: { confirm: t } });
  },
  _initEvents() {
    this.addEventListener("focus", this._onFocus),
      this.addEventListener("blur", this._onBlur),
      this.$preview.addEventListener("mouseup", this._onPreviewMouseDown, !0),
      ...
      case "value":
        if (((this.invalid = !1), o))
          try {
            ...
            console.warn(t), (this.value = null);
          }
        else this._value = {};
        requestAnimationFrame(() => {
          this._updateAlpha(),
  ...
  _onLocationChange(t) {
    "alpha" === this.$root.activeOrbital
      ? (this.$root._value.alpha.some((e) => {
          if (e.progress !== this.$root.activeProgress) return !1;
    ...
    e.stopPropagation(),
      "color" === this.$root.activeOrbital
        ? (this.$root._value.color.some((o) => {
            if (o.progress !== this.$root.activeProgress) return !1;
        ...
        : "alpha" === this.$root.activeOrbital &&
          (this.$root._value.alpha.some((t) => {
            if (t.progress !== this.$root.activeProgress) return !1;
  ...
  _onAlphaKeyMouseDown(t) {
    const e = t.pageX,
      o = t.pageY,
      r = this.getAttribute("index"),
      i = this.$root._value.alpha[r],
      s = "SPAN" === t.target.tagName ? t.target.parentElement : t.target,
      a = parseInt(s.style.left),
      l = i.progress;
  ...
  _updateHybrid() {
    const t = this.invalid
        ? { color: [], alpha: [] }
        : this.value || { color: [], alpha: [] },
      e = t.alpha || [{ value: 1, progress: 0 }],
      o = t.color || [{ value: "#ffffff", progress: 0 }],
      r = (this._map = {
    ...
    e.forEach((t, o) => {
      ((r[t.progress] = r[t.progress] || {}).a = (255 * t.value) | 0),
        o === e.length - 1 && (r[1].a = (255 * t.value) | 0),
        0 === o && (r[0].a = (255 * t.value) | 0);
    }),
      o.forEach((t, e) => {
        const i = this._convertToRGB(t.value),
          s = (r[t.progress] = r[t.progress] || {});
        (s.r = i[0]),
          (s.g = i[1]),
          (s.b = i[2]),
          e === o.length - 1 &&
            ((r[1].r = i[0]), (r[1].g = i[1]), (r[1].b = i[2])),
          0 === e && ((r[0].r = i[0]), (r[0].g = i[1]), (r[0].b = i[2]));
      });
    ...
    i.forEach((t, e) => {
      const o = r[t];
      void 0 === o.r && (o.r = Math.round(s(e, "r"))),
        void 0 === o.g && (o.g = Math.round(s(e, "g"))),
        void 0 === o.b && (o.b = Math.round(s(e, "b"))),
        void 0 === o.a && (o.a = Math.round(s(e, "a"))),
        (o.progress = t);
    }),
      i.forEach((t, e) => {
        const o = r[t];
  ...
  _updateActive(e, o) {
    if (
      ...
      (this.$location.value = 0), (this.$color.value = [255, 255, 255, 255]);
  },
  _convertToRGB(e) {
    let o;
  ...
  _emitConfirm() {
    o.fire(this, "confirm", { bubbles: !0, detail: { value: this.value } });
  },
  _emitChange() {
    o.fire(this, "change", { bubbles: !0, detail: { value: this.value } });
  },
});
