...
function s(t) {
  ...
  if (s) {
    var e = s.type,
      i = Editor.assets[e];
    return i
      ? cc.js._getClassId(i, !1)
      : (Editor.error("Can not get asset type of " + t),
        cc.js._getClassId(cc.Asset, !1));
  }
  return cc.js._getClassId(cc.Texture2D, !1);
}
module.exports = class {
  ...
  getDependencies(t) {
    return this.containsAsset(t, !0)
      ? Editor.Utils.getDependsRecursively(this._buildAssets, t, "dependUuids")
      : [];
  }
  getAssetType(t) {
    return this.containsAsset(t, !0), s(t);
  }
  getNativeAssetPath(t) {
    return this.getNativeAssetPaths(t)[0] || "";
  }
  getNativeAssetPaths(e) {
    if (!this.containsAsset(e, !0)) return [];
    let i = this._buildAssets[e];
    if ("object" != typeof i) return [];
    let n = [];
    i.nativePaths ? (n = i.nativePaths) : i.nativePath && (n = [i.nativePath]);
    let r = s(e),
      a = this._nativeMd5Map && this._nativeMd5Map[e];
    return a
      ? n.map((s) => {
          if ("cc.TTFFont" === r)
