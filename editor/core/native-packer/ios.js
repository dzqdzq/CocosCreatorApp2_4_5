...
const e = require("fire-path"),
  t = require("fire-fs"),
  r = require("xcode"),
  { spawn: o, spawnSync: i } = require("child_process"),
  s = require("./base");
module.exports = class extends s {
  constructor(o) {
    ...
    if (
      ...
      !t.existsSync(this.projectPath))
    )
      return (
        Editor.error("Can't find xcodeproj file at path: ", this.projectPath),
        void 0
      );
    (this.project = r.project(this.projectPath)), this.project.parseSync();
  }
  addFramework(e, t) {
    let r = !0;
    return (
      this._searchTarget(t)
  ...
  addFileToCompileSource(e, t, r) {
    let o = !0,
      i = this._searchTarget(t),
      s = this._searchPBXGroup(r);
    return (
      i && s
        ? (this.project.addSourceFile(e, { target: i }, s), this._save())
        : (o = !1),
      o
    );
  }
  addFileToProject(e, t) {
    let r = !0,
      o = this._searchPBXGroup(t);
    return o ? this.project.addFile(e, o) : (r = !1), this._save(), r;
  }
  checkPodEnvironment() {
    return (
      !i("pod").error ||
  ...
  addPodDependenceForTarget(r, o, i) {
    ...
    let s = e.join(
      ...
      n = t.readFileSync(s, "utf-8");
    if (
      (-1 === n.indexOf(o) && (n += `target '${o}' do\nend`),
      this.isDependenceExist(r, o, i))
    )
  ...
  executePodFile() {
    return new Promise((t, r) => {
      ...
      i.stdout.on("data", (e) => {
        ...
        i.on("close", (e) => {
          if (0 !== e)
            return r("exec pod install fail with exit code", e), void 0;
          t();
        });
    });
  }
