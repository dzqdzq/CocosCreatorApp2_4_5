...
const e = require("electron"),
  r = e.ipcMain,
  i = Editor.Profile.load("global://settings.json");
r.on("app:explore-project", () => {
  ...
  r.on("app:play-on-device", (r, t) => {
    ...
    if ("browser" === o) {
      ...
      if ("default" === r) e.shell.openExternal(l);
      else {
