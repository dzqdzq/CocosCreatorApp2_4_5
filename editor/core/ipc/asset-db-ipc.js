...
t.on("asset-db:explore", (t, s) => {
  ...
  t.on("asset-db:import-assets", (e, t, s, r) => {
    r && Editor.Ipc.sendToPanel("assets", "assets:start-refresh"),
      Editor.assetdb.watchOFF(),
      Editor.assetdb.import(t, s, (t, s) => {
        e.reply && (t ? e.reply() : e.reply(null, s)),
          r && Editor.Ipc.sendToPanel("assets", "assets:end-refresh");
      }),
  ...
  t.on("asset-db:asset-uuid-changed", function (e, t) {
    Editor.ProjectCompiler.needCompile(t.type, t.uuid) &&
  ...
  t.on("asset-db:assets-moved", function (e, t) {
    ...
    t.forEach(function (e) {
      Editor.ProjectCompiler.needCompile(e.type, e.uuid) &&
        (r.push(e.srcPath), d.push(e.destPath), (s = !0)),
        "scene" === e.type &&
  ...
  t.on("asset-db:assets-deleted", function (e, t) {
    ...
    t.forEach(function (e) {
      if (
        (Editor.ProjectCompiler.needCompile(e.type, e.uuid) &&
          (r.push({ path: e.path, uuid: e.uuid }), (s = !0)),
        "scene" === e.type)
      ) {
        var t = Editor.sceneList.indexOf(e.uuid);
        -1 !== t && Editor.sceneList.splice(t, 1),
          e.uuid === Editor.currentSceneUuid &&
  ...
  t.on("asset-db:meta-backup", (t, d) => {
    ...
    let a = s.normalize(s.join(Editor.Project.path, Editor.metaBackupPath)),
      o = Editor.T("MESSAGE.assets.meta_backup_detail", { backupPath: a });
    d.forEach((e, t) => {
      o += "\n" + (t + 1) + ". " + e;
    });
    ...
    1 === i
      ...
      : 2 === i && (r.set("show-meta-backup-dialog", !1), r.save());
  });
