...
const e = require("fire-path"),
  t = require("fire-fs"),
  s = require("plist"),
  i = require("./native-asset"),
  a = require("./sprite-frame"),
  r = require(Editor.url("app://editor/share/sharp"));
class p extends i {
  constructor(e) {
    super(e),
      (this.type = null),
  ...
  deserialize(e) {
    ...
    for (let s in e.subMetas) {
      let i = e.subMetas[s],
        r = new a(this._assetdb);
      r.deserialize(i), (t[s] = r);
    }
  ...
  import(i, a) {
    if (null === this.type)
      try {
        let a = e.basename(i),
          ...
          h = p.metadata.realTextureFileName || p.metadata.textureFileName;
    ...
    super.import(i, (t) => {
      if (t) return a(t);
      if ((p.migrateTextureCompression(this), "raw" === this.type))
        this.updateSubMetas({});
      ...
      r(i)
        .metadata()
        .then((e) => {
          (this.width = e.width), (this.height = e.height), a();
        })
        .catch((e) => {
          a(e);
        });
