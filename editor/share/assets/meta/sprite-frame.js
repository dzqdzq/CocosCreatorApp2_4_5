    ...
    h.cache(!1),
      t.waterfall(
        [
          ...
          (t, r, h) => {
            if (!t || !r)
              return h(new Error("Can not load image for " + o)), void 0;
            let s = r.width,
              a = r.height;
            if (
              ((this.rawWidth = s),
            ...
            this._assetdb.saveAssetToLibrary(this.uuid, d), h(null, d);
          },
        ],
        (t) => {
          h.cache(!0), r && r(t);
