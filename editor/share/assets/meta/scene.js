...
async function n(e, t) {
  try {
    ...
    let i = cc.js._getClassId(t, !1);
    e = await (async function (e, t, i, r) {
      try {
        let a = await r();
        a = Editor.serialize(a, { stringify: !1 });
        let o = [];
        ...
        for (let t = 0; t < o.length; ++t, a = JSON.parse(JSON.stringify(a))) {
          let r = o[t],
            s = e[r];
          if (!s || !Array.isArray(s._components)) continue;
          let n = !1;
...
class c extends i {
  ...
  async import(i, r) {
    e.readJson(i, async (e, a) => {
      ...
      if (a) {
        (a = await c.verify(i, a)), (a = await c.migrate(i, a, this.uuid));
  ...
  static async verify(t, i) {
    ...
    if (Array.isArray(i))
      for (var a = 0; a < i.length; ++a) {
        var o = i[a];
        "cc.Node" !== o.__type__ ||
          void 0 === o._components ||
          Array.isArray(o._components) ||
          ((o._components = []),
          (r = !0),
          Editor.warn(
    ...
    return r && e.writeFileSync(t, JSON.stringify(i, null, 2)), i;
  }
  static async migrate(t, i, l) {
    ...
    let u = !1;
    return (
      r.satisfies(_, "< 1.0.1", { includePrerelease: !0 }) &&
        ((i = await (async function (e) {
          if (Array.isArray(e))
            for (var t = 0; t < e.length; t++) {
              var i = e[t];
              "cc.ParticleSystem" === i.__type__
                ? (e[t] = await s(i, a))
                : "sp.Skeleton" === i.__type__ && (e[t] = await s(i, o));
            }
          return e;
        })(i)),
        (u = !0)),
      r.satisfies(_, "< 1.0.2", { includePrerelease: !0 }) &&
        ((i = await (async function (e) {
          if (Array.isArray(e))
            for (var t = 0; t < e.length; t++) {
              var i = e[t];
              "cc.LightComponent" === i.__type__ && (i.__type__ = "cc.Light");
            }
          return e;
        })(i)),
        (u = !0)),
      r.satisfies(_, "< 1.1.0", { includePrerelease: !0 }) &&
        ((i = await (async function (e, t) {
          if (Array.isArray(e))
            for (var i = 0; i < e.length; i++) {
              var r = e[i];
              "cc.ParticleSystem" === r.__type__
                ? 0 === r.positionType &&
                  ((r.positionType = 1),
                  Editor.warn(
        ...
        (u = !0)),
      r.satisfies(_, "< 1.2.1", { includePrerelease: !0 }) &&
        ((i = await (async function (e, t) {
          if (Array.isArray(e))
            for (var i = 0; i < e.length; i++) {
              var r = e[i];
              if ("cc.Node" === r.__type__)
                if (void 0 !== r._rotationX || void 0 !== r._rotationY) {
                  if (0 !== r._rotationX || 0 !== r._rotationY) {
                    let e = cc.v3();
                    r._rotationX === r._rotationY
                      ? (e.z = -r._rotationX)
                      : ((e.x = r._rotationX), (e.y = r._rotationY)),
                      (r._eulerAngles = Editor.serialize(e, { stringify: !1 }));
                  }
                  r._rotationX = r._rotationY = void 0;
                } else if (void 0 !== r._quat) {
                  if (r._is3DNode)
                    ...
                    r._eulerAngles = Editor.serialize(t, { stringify: !1 });
                  }
                  r._quat = void 0;
                }
            }
        ...
        (u = !0)),
      r.satisfies(_, "< 1.2.3", { includePrerelease: !0 })
        ? ((i = await (async function (e, t) {
            if (Array.isArray(e))
              for (var i = 0; i < e.length; i++) {
                var r = e[i],
                ...
                if ("cc.Node" === a || "cc.Scene" === a) {
                  ...
                  if (void 0 !== r._trs) {
                    let t = r._trs.array;
                    12 === t.length && ((r._skewX = t[10]), (r._skewY = t[11])),
                      e.set(t.slice(0, 10));
                  } else
                    (e[0] = 0),
                      (e[1] = 0),
                  ...
                  void 0 !== r._position &&
                    ...
                    (e[2] = r._position.z || 0),
                    (r._position = void 0)),
                    void 0 !== r._scaleX || void 0 !== r._scaleY
                      ? (void 0 !== r._scaleX &&
                          ((e[7] = r._scaleX), (r._scaleX = void 0)),
                        void 0 !== r._scaleY &&
                          ((e[8] = r._scaleY), (r._scaleY = void 0)),
                        (e[9] = 1))
                      : void 0 !== r._scale &&
                        ((e[7] = r._scale.x),
                        (e[8] = r._scale.y),
                        (e[9] = r._scale.z),
                        (r._scale = void 0)),
                    (r._trs = Editor.serialize(e, { stringify: !1 }));
                }
              }
            return e;
          })(i)),
          (u = !0))
        : r.satisfies(_, "< 1.2.4", { includePrerelease: !0 }) &&
          ((i = await (async function (e, t) {
            if (Array.isArray(e))
              for (var i = 0; i < e.length; i++) {
                var r = e[i],
          ...
          (u = !0)),
      r.satisfies(_, "< 1.2.5", { includePrerelease: !0 }) &&
        (i = await (async function (e, t) {
          if (Array.isArray(e))
            for (var i = 0; i < e.length; i++) {
              var r = e[i];
              if ("cc.Camera" === r.__type__) {
                ...
                if (!a) continue;
                a._is3DNode && (r._alignWithScreen = !1);
              }
            }
          return e;
        })(i)),
      r.satisfies(_, "< 1.2.6", { includePrerelease: !0 }) &&
        ((i = await n(i)), (u = !0)),
      r.satisfies(_, "< 1.2.7", { includePrerelease: !0 }) &&
        ((i = await (async function (e, t) {
          try {
            if (Array.isArray(e))
              for (var i = 0; i < e.length; i++) {
                var r = e[i];
                "cc.ParticleSystem3D" === r.__type__ &&
                  (r.shapeModule && (r._shapeModule = r.shapeModule),
                  r.colorOverLifetimeModule &&
                    (r._colorOverLifetimeModule = r.colorOverLifetimeModule),
                  r.sizeOvertimeModule &&
                    (r._sizeOvertimeModule = r.sizeOvertimeModule),
                  r.velocityOvertimeModule &&
                    (r._velocityOvertimeModule = r.velocityOvertimeModule),
                  r.forceOvertimeModule &&
                    (r._forceOvertimeModule = r.forceOvertimeModule),
                  r.limitVelocityOvertimeModule &&
                    (r._limitVelocityOvertimeModule =
                      r.limitVelocityOvertimeModule),
                  r.rotationOvertimeModule &&
                    (r._rotationOvertimeModule = r.rotationOvertimeModule),
                  r.textureAnimationModule &&
                    (r._textureAnimationModule = r.textureAnimationModule),
                  r.trailModule && (r._trailModule = r.trailModule),
        ...
        (u = !0)),
      r.satisfies(_, "< 1.2.8", { includePrerelease: !0 }) &&
        ((i = await (async function (e, t) {
          try {
            if (Array.isArray(e))
              for (var i = 0; i < e.length; i++) {
                var r = e[i],
                  a = r.__type__;
                if ("cc.Node" === a || "cc.Scene" === a) {
                  if (!r._color) continue;
                  r._color.a < 255 &&
                    255 === r._opacity &&
                    ((r._opacity = r._color.a), (r._color.a = 255));
                }
              }
          } catch (e) {
            Editor.error(e);
        ...
        (u = !0)),
      r.satisfies(_, "< 1.2.9", { includePrerelease: !0 }) &&
        ((i = await (async function (e) {
          if (Array.isArray(e))
            for (var t = 0; t < e.length; t++) {
              var i = e[t];
              ("cc.WXSubContextView" !== i.__type__ &&
                "cc.SwanSubContextView" !== i.__type__) ||
                (i.__type__ = "cc.SubContextView");
            }
          return e;
        })(i)),
        (u = !0)),
      u && e.writeFileSync(t, JSON.stringify(i, null, 2)),
      i
    );
  }
}
