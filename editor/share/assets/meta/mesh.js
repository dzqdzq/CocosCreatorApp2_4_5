...
module.exports = class extends Editor.metas.asset {
  ...
  generateVBBuffer(e, t, i, n, u) {
    ...
    for (let i in u) {
      ...
      let c = n[a.bufferView],
        d = new h();
      (d.name = f), (d.type = a.componentType), (d.num = r[a.type]), m.push(d);
    ...
    for (let e = 0; e < p; e++)
      for (let t = 0; t < l.length; t++) {
        let s = l[t],
          ...
          n = s.perByte,
          o = s.byteOffset + e * n;
        for (let e = 0; e < n; e++) i.push(r[o + e]);
      }
  ...
  generateIBBuffer(e, t, s, r, u, f, a) {
    ...
    if (b >= 5124 && b <= 5126) {
      ...
      for (let s = 0; s < t.length; s++) t[s] = e[s] > 65535 ? 0 : e[s];
      let i = new Uint8Array(t.buffer, 0, t.byteLength);
      for (let e = 0; e < t.byteLength; e++) s.push(i[e]);
      b = 5123;
    } else {
      let e = l.count * o[b],
        t = l.byteOffset || 0;
      for (let i = m.byteOffset + t, r = 0; r < e; r++) s.push(p[i + r]);
    }
