...
var e = require("fire-fs"),
  ...
  i = require("fire-path"),
  r = require("async"),
  s = require("@babel/core"),
  a = require("convert-source-map"),
  o = require("./precompile-script"),
  l = 92160;
function u(t) {
  if (-1 !== i.basename(t).lastIndexOf(".min.")) return !0;
  var r = e.statSync(t);
  return r && r.size >= l;
}
function n(t) {
...
class p extends Editor.metas.asset {
  constructor(e) {
    super(e),
      (this.isPlugin = null),
      (this.loadPluginInWeb = !0),
      (this.loadPluginInNative = !0),
      (this.loadPluginInEditor = !1);
  }
  static defaultType() {
    return "javascript";
  }
  ...
  compile(t, i) {
    ...
    try {
      ...
      r = s.transform(o, {
        ...
        compact: !1,
        filename: t,
        presets: [[require("@babel/preset-env"), { loose: !0 }]],
        plugins: [
  ...
  checkGlobalVariables(i, r) {
    var s = /^var\s+\S+/,
      a = t.createInterface({ input: e.createReadStream(i) });
    a.on("line", (e) => {
      s.test(e) &&
        Editor.info(
  ...
  import(e, t) {
    if (
      (null === this.isPlugin &&
        ((this.isPlugin = !1), u(e) && (this.isPlugin = n(e))),
      this.isPlugin)
    ) {
