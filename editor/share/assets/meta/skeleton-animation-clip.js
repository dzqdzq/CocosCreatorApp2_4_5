...
const t = require("fire-fs"),
  { promisify: e } = require("util"),
  { type2size: a, compType2Array: i } = require("./utils/gltf");
function r(t, e, r) {
  let s = t.accessors[e],
    n = t.bufferViews[s.bufferView],
    u = r[n.buffer].buffer,
    o = a[s.type];
...
module.exports = class extends Editor.metas.asset {
  ...
  import(t, e) {
    if (this._assetdb.isSubAssetByPath(t)) return e();
    e();
  }
  async importGltf(t, e) {
    ...
    for (let t in o) {
      ...
      for (let t in e) {
        let a = e[t];
        this.mergeFrames(a, t), (l = Math.max(l, a.length)), (f += a.length);
      }
    }
  ...
  _makeSureJointHasCurves(t, e) {
    for (let a = 0; a < e.length; a++) {
      ...
      t[r] || (t[r] = {});
      let s = t[r];
      s.quat || (s.quat = [{ frame: 0, value: i.quat || [0, 0, 0, 1] }]),
        s.scale || (s.scale = [{ frame: 0, value: i.scale || [1, 1, 1] }]),
        s.position ||
  ...
  generateBuffer(t) {
    ...
    return (
      ...
      { description: a, buffer: (e = new Buffer(new Uint8Array(e.buffer))) }
    );
  }
  mergeFrames(t, e) {
    function a(t, e, a) {
      return (a = a || 1e-4), Math.abs(e - t) < a;
    }
    ...
    function o(t, e, i, o, l, f) {
      ...
      return (
        r.lerp(n, c, u),
        a(u.x, s.x) && a(u.y, s.y) && a(u.z, s.z) && a(u.w, s.w)
      );
    }
    for (let a = 1; a < t.length - 1; a++) {
      let r,
        ...
        f = n.frame,
        c = u.frame;
      "scale" === e || "position" === e ? (r = i) : "quat" === e && (r = o),
        r(s.value, n.value, u.value, l, f, c) && t.splice(a--, 1);
    }
  }
  async save() {
