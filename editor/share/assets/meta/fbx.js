const e = require("fire-path"),
  r = require("fire-fs"),
  t = Editor.require("unpack://node_modules/fbx2gltf"),
  i = require("md5"),
  s = require("del"),
  ...
  u = require("./buffer"),
  f = require("node-uuid"),
  a = e.join(require("os").tmpdir(), "fbx2gltf_temp");
r.ensureDirSync(a);
module.exports = class extends n {
  constructor(e) {
    super(e), (this._convertDestPath = "");
  }
  static defaultType() {
    return "fbx";
  }
  async importModel(o) {
    ...
    return (
      ...
      /[\u0080-\uffff]/g.test(o) &&
        ((u = e.join(a, f.v4() + ".fbx")), r.copySync(o, u), (o = u)),
      new Promise((e, i) => {
        t(o, n)
          .then(
            (t) => {
              ...
              try {
                ...
                return Editor.error(e), i(e);
              }
              (this._convertDestPath = t), (this._gltf = s), e();
            },
            (e) => {
          ...
          .finally(() => {
            u && s.sync(u.replace(/\\/g, "/"), { force: !0 });
          });
      })
    );
  }
  async _createBufferMeta(t, i, s) {
    (this._bufferUuids = []), (this._buffers = []);
