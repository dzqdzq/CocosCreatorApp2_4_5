...
var f = (
  ...
  u = require("./serialize-nicify"),
  c = ["_objFlags", "_parent", "_prefab"].concat(
    "_name",
    "_active",
    "_trs",
    "_eulerAngles",
...
function d(e, r) {
  (r = r || {}),
    ...
    (this._dontStripDefault =
      !this._exporting || !("dontStripDefault" in r) || r.dontStripDefault),
    ...
    (this._parsingData = []),
    (this._objsToResetId = []),
    (this._reserveContentsForAllSyncablePrefab =
...
var p = cc.Class.Attr,
  g = p.DELIMETER + "editorOnly",
  y = p.DELIMETER + "serializable",
  v = p.DELIMETER + "default",
  h = p.DELIMETER + "formerlySerializedAs";
function b(e, i, r, s, a) {
  for (
    ...
    if (!1 !== _[u + y]) {
      ...
      if (e._exporting) {
        if (_[u + g]) continue;
        if (!e._dontStripDefault && f(_[u + v], c)) continue;
      }
      r[u] = A(e, c);
      var d = _[u + h];
      d && (r[d] = r[u]);
  ...
  if ((t && i instanceof t) || (n && i instanceof n)) {
    if (e._exporting) {
      if (!(i instanceof t && i._parent instanceof cc.Scene)) return;
      if (!e._dontStripDefault && !i._id) return;
    }
    r._id = i._id;
  }
}
    ...
    if (o) {
      if (o.length > 0)
        if ("_$erialized" !== o[o.length - 1])
          i._onBeforeSerialize && (_ = i._onBeforeSerialize(o)),
            b(e, i, r, a, _);
        else
          i._$erialized &&
            ((r.__type__ = i._$erialized.__type__),
            j(e, i._$erialized, r),
            e._missingClassReporter && e._missingClassReporter(i, r.__type__));
    } else
      for (var l in i)
        (i.hasOwnProperty && !i.hasOwnProperty(l)) ||
          (95 === l.charCodeAt(0) && 95 === l.charCodeAt(1)) ||
          (r[l] = A(e, i[l]));
  }
}
function z(e, i) {
          ...
          ? ((function (e, i, r) {
              if (e._missingObjectReporter) {
                ...
                void 0 === t &&
                  ...
                  t || e._missingObjectReporter(i);
              }
            })(t, n, u),
            t._exporting && (u = e(u, !0)),
            { __uuid__: u })
          : null;
      }
      var c = n._objFlags;
      if (t._exporting && c & l) return;
      if (t._discardInvalid) {
        if (c & _) return;
        if (!n.isValid)
          return t._missingObjectReporter && t._missingObjectReporter(n), null;
      } else {
        if (c & _ && c & o) return;
        if (!n.isRealValid) return null;
      }
      if (s && s.isNode(n)) if (z(t, n) && n !== n._prefab.root) return null;
    }
    return m(t, n);
  }
...
function m(e, r) {
  var t,
    s = r instanceof i,
    n = r.constructor,
    _ = cc.js._getClassId(r, !1);
  if (s || cc.Class._isCCClass(n)) {
    (t = e.serializedList.length), (r.__id__ = t), e._objsToResetId.push(r);
    var o = {};
    return (
      ...
      r._serialize
        ...
        : (j(e, r, o), s && r._objFlags > 0 && (o._objFlags &= a)),
      { __id__: t }
    );
  }
  ...
  if (!n || n === Object || Array.isArray(r) || _) {
    ...
    var l = (function (e, i) {
      ...
      if (-1 !== r) return e._parsingData[r];
    })(e, r);
    return l
      ? ((t = e.serializedList.length),
        (r.__id__ = t),
        e._objsToResetId.push(r),
        !1 === Array.isArray(r) && _ && (l.__type__ = _),
...
function R(e, i) {
  var r,
    t = !("stringify" in (i = i || {})) || i.stringify,
    s = i.minify,
    n = s || i.nicify,
    a = new d(e, i).serializedList;
  return (
    n && u(a),
    (r = 1 !== a.length || Array.isArray(a[0]) ? a : a[0]),
    !1 === t ? r : JSON.stringify(r, null, s ? 0 : 2)
  );
}
(R.asAsset = function (e) {
  if (!e)
    return (
      cc.error("[Editor.serialize.asAsset] The uuid must be non-nil!"), null
    );
  var i = new r();
  return (i._uuid = e), i;
}),
  ...
  (R.findRootObject = function (e, i) {
    if (Array.isArray(e))
      for (var r = 0; r < e.length; r++) {
        var t = e[r];
        if (t.__type__ === i) return t;
      }
    else if (e.__type__ === i) return e;
    return null;
  }),
