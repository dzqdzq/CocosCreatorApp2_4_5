...
(o.prototype.walk = null),
  (o.prototype.parseObject = function (e) {
    if (Array.isArray(e)) this.forEach(e);
      ...
      var r = e.constructor;
      if ((e instanceof t || (r !== Object && !s(e, !1))) && e !== this.root)
        return;
      var o = r && r.__props__;
      o ? this.parseCCClass(e, r, o) : this.forIn(e);
    }
  }),
  (o.prototype.parseCCClass = function (t, s, o) {
    for (var n = e.getClassAttrs(s), i = 0; i < o.length; i++) {
      var a = o[i];
      !1 !== n[a + r] && this.walk(t, a, t[a]);
    }
  }),
  (o.prototype.forIn = function (t) {
    for (var e in t)
      !t.hasOwnProperty(e) ||
        (95 === e.charCodeAt(0) && 95 === e.charCodeAt(1)) ||
        this.walk(t, e, t[e]);
  }),
  (o.prototype.forEach = function (t) {
    for (var e = 0, r = t.length; e < r; ++e) this.walk(t, "" + e, t[e]);
  }),
  cc.js.extend(n, o),
...
var i = new o(null);
function a(t, e) {
  (i.root = null), (i.walk = e), i.parseObject(t);
}
(i.walk = null),
  (module.exports = {
    walk: function (t, e) {
