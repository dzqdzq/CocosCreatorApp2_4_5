...
const e = require("lodash"),
  ...
  b = CC_TEST
    ...
    : Editor.require("unpack://engine-dev/cocos2d/core/platform/CCClass")
        .getDefault,
  y = ["_objFlags", "_parent", "_prefab"].concat(
    "_name",
    "_active",
    "_eulerAngles",
    "_localZOrder"
  ...
  m = (() => {
    class r {
      constructor(e, t) {
        (this.parsedObjs = new Set()),
          ...
          (this.reserveContentsForAllSyncablePrefab =
            !!t.reserveContentsForSyncablePrefab),
          (this.builder = e),
          (this.assetExists =
            this.missingObjectReporter && Object.create(null));
      }
      parse(e) {
        e instanceof cc.Prefab && (this.prefabRoot = e.data),
      ...
      verifyValue(e, t, i) {
        ...
        if ("object" === s) {
          if (!i) return null;
          if (this.parsedObjs.has(i)) return i;
          if (i instanceof a) {
            if (i instanceof n) {
              var l = i._uuid;
      ...
      parseField(e, r, i, s) {
        ...
        if ("object" === a) {
          ...
          if (i instanceof n && e) {
            var l = i._uuid;
            return (
              this.exporting && (l = t.compressUuid(l, !0)),
