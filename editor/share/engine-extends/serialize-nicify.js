var e = function (e) {
  ...
  t = function (e, t, i) {
    if ("object" == typeof e) {
      if (((e._iN$t = !0), i.temporaryDataList.push(e), e.content)) {
        var s = e.__type__ && cc.js._getClassById(e.__type__);
        if (s && s.prototype._serialize) return;
      }
      var n;
      if (Array.isArray(e))
        for (var o = 0; o < e.length; o++) (n = e[o]) && r(n, o, e, t, i);
      else for (var f in e) (n = e[f]) && r(n, f, e, t, i);
    }
  },
  r = function (e, r, i, s, n) {
    var o = e.__id__,
      f = void 0 !== o;
    f &&
      ((e = s[o]),
      -1 !== n.referncedIDList.indexOf(o)
        ? n.referencedCounts[o]++
        : (n.referencedCounts[o] = 1),
      n.referncedIDList.push(o),
      n.keyList.push(r),
      n.objList.push(i)),
      !e._iN$t ? t(e, s, n) : f && n.referencedCounts[o]++;
  };
CC_TEST && (cc._Test.nicifySerialized = e), (module.exports = e);
