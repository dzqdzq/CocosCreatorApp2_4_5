const e = require("path"),
  i = require("fs"),
  n = require("gulp"),
  t = (require("gulp-sourcemaps"), require("babelify")),
  r = require("browserify"),
  s = require("vinyl-source-stream"),
  o = (require("gulp-uglify"), require("vinyl-buffer")),
  a = (require("async"), require("aliasify")),
  u = /[Ww]eb[Vv]iew/;
function l(n, t) {
