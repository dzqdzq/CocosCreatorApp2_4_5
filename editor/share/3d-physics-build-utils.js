const e = require("browserify"),
  i = require("babelify"),
  s = require("vinyl-source-stream"),
  r = require("vinyl-buffer"),
  n = require("path"),
  t = require("gulp"),
  u = require("./build-platforms"),
  l = {
...
(o.getPhysicsModule = function (e, i) {
  ...
  (o.getPhysicsEntries = function (e) {
    let i = Editor.require("unpack://engine/modules.json"),
      s = Editor.url("unpack://engine"),
      r = i.find((e) => "3D Physics Framework" === e.name);
    if (!r) throw new Error("can't find physics framework module");
    let t = r.entries,
      u = i.find((i) => i.name === e);
    if (!u) throw new Error(`can't find physics moduel '${e}'`);
  ...
  (o.build = function ({ dest: l, excludedModules: o, debug: a, platform: d }) {
    return new Promise((h, g) => {
      ...
      let b = this.getPhysicsEntries(y),
        m = this.getPhysicsBuildFlags(y),
        f = u[d].isNative,
        q = "runtime" === d,
        j = { jsb: f && !q, runtime: q, minigame: "mini-game" === d, debug: a };
      m && Object.assign(j, m);
      let E = new e({ extensions: [".js", ".ts"], entries: b });
      const P = Editor.require("unpack://engine/gulp/util/utils"),
        w = Editor.require("unpack://engine/gulp/util/handleErrors.js");
      let k = E.transform(i, {
        extensions: [".js", ".ts"],
        presets: c,
        plugins: p,
  ...
  (o.updateMinigameRequire = function ({ debug: e, excludedModules: i }, s, r) {
    ...
    } else s = s.replace("require('physics-js-path');", "");
    return s;
  }),
  (module.exports = o);
