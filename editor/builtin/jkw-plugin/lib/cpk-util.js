let e = require("./jszip.min.js"),
  t = require("path"),
  i = require("fs-extra"),
  a = require("./worker-util.js"),
  r = require("./adapter-util.js"),
  o = require("./tinypack-util.js"),
  n = require("./separate-engine-util.js"),
  s = {};
