...
module.exports = {
  gatherInfo(o) {
    (i = o.cpk), (d = o.gameConfig), (p = o.customConfig.separateEngineMode);
    let r = o.buildPath;
    (n = e.join(r, "cocos")),
  ...
  organizeResources() {
    ...
    Editor.info(Editor.T("cpk-publish.separate_engine_begin_hint")),
      o.existsSync(n) || o.ensureDirSync(n),
      o.moveSync(c, s);
