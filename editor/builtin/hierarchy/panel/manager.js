      ...
      if (
        ...
        t[d.id] &&
          (function (i, d, o) {
            let l = t[i.id],
              r = t[d];
            if (d !== l.parent) return (c = e.remove(i.id)), void 0;
            if (r && r.children[o] !== i.id) {
              c = e.remove(i.id);
              let t = n.indexOf(i.id);
              return -1 !== t && n.splice(t, 1), void 0;
            }
            if (null === d && n[o] !== i.id) {
              c = e.remove(i.id);
              let t = n.indexOf(i.id);
            ...
            f.name !== i.name && (f.name = i.name),
              f.isActive !== i.isActive && (f.isActive = i.isActive),
              f.prefabState !== i.prefabState &&
                (f.prefabState = i.prefabState),
              f.locked !== i.locked && (f.locked = i.locked);
          })(d, u, o),
        !t[d.id])
      ) {
        (function (e, i) {
          for (let t = 0; t < e.length; ++t) {
            let n = e[t];
            n && n.id === i.id && ((i.fold = n.oldNode.fold), e.splice(t, 1));
          }
        })(c, d),
          e.add(d, u || null, o);
        let t = e.queryNode(u);
        t && i.fold(u, t.fold),
          null === u && n.splice(o, 0, d.id),
          r.push(d.id);
      }
      let s = 0;
      d.children &&
...
(exports.startup = function () {
  e.initNodeState(), (d = !0), r();
}),
  (exports.stop = function () {
    (d = !0), e.initNodeState(), clearTimeout(l), o([]);
  }),
