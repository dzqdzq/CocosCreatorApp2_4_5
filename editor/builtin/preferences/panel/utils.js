...
const e = require("fire-fs"),
  { dirname: t, join: i } = require("path"),
  o = Editor.require("app://share/engine-utils");
let s = null;
...
(exports.queryGeneral = function () {
  ...
  (exports.queryPreview = function () {
    let e = exports.profiles.global,
      t = e.get("clear-simulator-cache"),
      i = [],
      o = s.simulator_screen_size;
    return (
      s &&
        o &&
        (o.forEach((e, t) => {
        ...
        })),
      {
        ...
        simulatorWaitForConnect: (s && s.init_cfg.waitForConnect) || !1,
        resolutionList: i,
      }
    );
  });
