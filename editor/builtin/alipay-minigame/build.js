const e = Editor.require("app://editor/share/adapters-build-utils"),
  ...
  i = "project://alipay-minigame.json",
  r = Editor.require("app://editor/share/3d-physics-build-utils"),
  n = require("path");
const o = {
...
module.exports = {
  ...
  buildStart: function (e) {
    ...
    e.startSceneAssetBundle = t.get("startSceneAssetBundle") || !1;
  },
  ...
  messages: {
    "script-build-finished": async function (t, r) {
      ...
      try {
        (function () {
          if (!Editor.Profile.load(i)) throw new Error("config file not found");
        })(),
    ...
    "build-finished": function (e, t) {
      ...
      Editor.Ipc.sendToMain("builder:notify-build-result", t, n), e.reply();
    },
  },
