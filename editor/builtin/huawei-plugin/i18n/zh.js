module.exports = {
  ...
  custom_npm_path_not_config:
    "无配置自定义node路径,node路径将用系统环境变量路径",
  custom_npm_path_config_error: "自定义node路径错误，请重新选择",
  window_default_npm_path_error:
    "系统环境变量node路径错误，请配置系统环境变量或自定义node路径",
  mac_default_npm_path_error:
    "读取默认node路径在/usr/local/bin/找不到，请配置自定义node路径",
  choose_json_file: "选择json文件",
  choose_image: "选择图片",
  select_certificate_path: "查看证书指纹，请先选择certificatePath路径",
  install_nodejs_before_view_certificate:
    "查看证书指纹需要nodejs,请安装nodejs或配置自定义npm路径",
  select_certificate_path_after_view_certificate:
    "查看证书指纹错误，请选择正确的certificatePath路径",
  certificate_fingerprint: "证书指纹:",
  certificate_fingerprint_window_error:
    "打印证书指纹错误：检查系统环境是否配置node环境或配置自定义node路径",
  certificate_fingerprint_mac_error:
    "打印证书指纹错误：检查/usr/bin/是否有node,或配置自定义node路径",
