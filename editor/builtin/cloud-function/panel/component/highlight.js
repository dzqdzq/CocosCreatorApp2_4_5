...
(exports.template = t.readFileSync(
  ...
  (exports.watch = {
    y(t) {
      this.show = -999 !== t;
      let e = s.point(t);
      if (!e || !e.node) return (this.node = null), !1;
      "folder" === e.node.assetType || "mount" === e.node.assetType
        ? (this.state = 2)
        : (this.state = 3),
        (this.node = e.node);
    },
    node(t) {
      ...
      (this.style.top = n.offset * i.lineHeight),
        ...
        (this.style.width =
          this.$el.parentNode.scrollWidth - this.style.left - 5),
