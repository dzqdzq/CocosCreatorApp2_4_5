...
(exports.template = e.readFileSync(
  ...
  (exports.watch = {
    "node.rename": {
      handler: function (e, t) {
        e && !t && (this.oriName = this.node.name),
          !e && t && this.nodeRename();
      },
    },
    "node.level": {
  ...
  (exports.methods = {
    ...
    onUpdateStyle(e) {
      return (
        (this.style.transform = `translateY(${e * n.lineHeight}px)`), this.style
      );
    },
    genIcon() {
    ...
    _getDrawFrameIcon(e) {
      let t,
        n,
        i = `thumbnail://${e.rawTextureUuid}?32`,
        o = e.trimX,
        r = e.trimY,
        s = 0;
      e.rotated
        ? ((t = e.height), (n = e.width), (s = 270))
    ...
    onClick() {
      this.node.selected && !this.node.rename;
    },
    onMouseDown(e) {
      if (
        (e.stopPropagation(),
    ...
    onMouseUp(e) {
      if ((l.setContext("cloud-function"), e.ctrlKey || e.metaKey)) {
        let e = l.curSelection("cloud-function"),
          t = e.indexOf(this.node.id);
        return (
          -1 !== t ? e.splice(t, 1) : e.push(this.node.id),
          l.select("cloud-function", e, !0, !0),
          void 0
        );
      }
      if (e.shiftKey) {
        ...
        if (!e || e.length <= 0)
          return (
            (e = this.node.id), l.select("cloud-function", e, !0, !0), void 0
          );
        ...
        return l.select("cloud-function", e, !0, !0), void 0;
      }
      let t = this.node.id;
      l.select("cloud-function", t, !0, !0);
    },
    onMouseLeave() {
    ...
    onDBClick(t) {
      if (
        ...
        1 !== t.which || this.node.rename)
      )
        return;
      if (t.shiftKey || t.metaKey || t.ctrlKey) return;
    ...
    onIClick(e) {
      ...
      e.altKey && r.recFoldNodes(this.node.id, t), r.fold(this.node.id, t);
    },
    onIDBClick(e) {
    ...
    onInputBlur(e) {
      if ((e.stopPropagation(), this.lockRename))
        return (this.lockRename = !1), void 0;
    ...
    _renameSubmit(e) {
      (this.node.name = e), r.rename(), clearTimeout(this._renameTimer);
    },
    _renameCancel(e) {
      r.rename(),
        clearTimeout(this._renameTimer),
        e && i.emit("nodes_focus", !0);
    },
  }),
  (exports.directives = {
    init() {
