...
const e = require("fire-url"),
  ...
  o = require("./event"),
  r = require("./utils");
(exports.loadAssets = function (e = !0) {
  e && o.emit("start-loading"),
    requestAnimationFrame((r, n) => {
      try {
        t.genAssetsTree().children.forEach((e) => this.fold(e.id, !1));
      } catch (e) {
        Editor.warn(e.message);
      }
      e && o.emit("finish-loading");
    });
}),
  (exports.show = function (e, o) {
    let r = t.queryNode(e);
    return !!r && ((r.show = o), this.updateShowNodes(), !0);
  }),
  ...
  (exports.fold = function (e, o) {
    ...
    if (!r) return console.log("can't find node ", e), !1;
    (r.fold = o),
      r.children &&
          ...
          (function e(t) {
            (t.show = !o),
              o
                ...
                : o === t.fold && t.children.forEach((t) => e(t));
          })(e)
        ),
      n(e, o),
...
let n = function (e, t) {
  ...
  var n = r.readJson(o);
  n.nodeFoldStates || (n.nodeFoldStates = []);
  var d = n.nodeFoldStates.indexOf(e);
  t
    ? -1 === d && n.nodeFoldStates.push(e)
    : d >= 0 && n.nodeFoldStates.splice(d, 1),
    r.saveJson(o, n);
};
(exports.recFoldNodes = function (e, o) {
  ...
  r.children &&
    r.children.forEach((e) => {
      this.fold(e.id, o), this.recFoldNodes(e.id, o);
    });
}),
  (exports.recParentNodes = function (e, o) {
    ...
    let n = (e) => {
      ...
      r && (r !== t.queryRoot() && this.fold(r.id, o), r.parent && n(r));
    };
    n(r);
  }),
  ...
  (exports.getRealUrl = function (o, r) {
    ...
    let i = (r || d.name) + d.extname,
      s = n[d.parent];
    for (; s; ) (i = e.join(s.name + s.extname, i)), (s = n[s.parent]);
    return i;
  }),
  (exports.getPath = function (o) {
    ...
    let d = "",
      i = r[n.parent];
    for (; i; ) (d = e.join(i.name + i.extname, d)), (i = r[i.parent]);
    return (d = "db://" + d);
  }),
  ...
  (exports.remove = function (e) {
    t.remove(e) && this.updateShowNodes();
  }),
  (exports.add = function (e, o = !1) {
    var r = t.add(e, o);
    return this.updateShowNodes(), r;
  }),
  (exports.autoSort = function () {
    t.sortAssetsTree(), this.updateShowNodes();
  });
let d = [];
(exports.staging = function (e) {
  ...
  (d.length = 0),
    o.forEach((t) => {
      t.selected && d.push(t.id), (t.selected = -1 !== e.indexOf(t.id));
    });
}),
  (exports.restore = function () {
    ...
    return (
      t.queryNodes().forEach((t) => {
        t.selected && e.push(t.id), (t.selected = -1 !== d.indexOf(t.id));
      }),
      (d = []),
      e
    );
