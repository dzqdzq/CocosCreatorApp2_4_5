...
module.exports = {
  ...
  app: {},
  onError(n) {
    this.onTCBError && this.onTCBError(n);
  },
  async init(t) {
    this.app = null;
    try {
    ...
    if ((this.app.getEnvironmentManager().remove(""), a)) {
      for (var i of a.EnvList) this.app.getEnvironmentManager().add(i.EnvId);
      var r = e.getCurrentEnvId();
      "undefinedenv" === r && (r = a.EnvList[0] && a.EnvList[0].EnvId),
  ...
  async createFunction(n, a, i, s) {
    ...
    if (
      ...
      var p = await this.app.functions
        ...
        .catch((n) => this.onError(n));
      return await this.downloadFunction(n.name, a), { res: p, isCreate: !0 };
    }
    return { res: await this.downloadFunction(n.name, a), isCreate: !1 };
  },
    ...
    return new Promise((c, s) => {
      (function (n, e, a) {
        var r = 0,
          ...
          u = t.createWriteStream(e);
        s.pipe(u),
          s.on("response", (n) => {
            if (200 !== n.statusCode)
              return a(new Error(n.statusMessage), null), void 0;
            r = parseInt(n.headers["content-length"], 10);
          }),
          s.on("data", (n) => {
            var t = (((o += n.length) / r) * 100) | 0;
            c !== t &&
              ((c = t), a(null, { status: "downloading", progress: t }));
          }),
          s.on("complete", () => {
        ...
        i ||
          ...
          a.zip
            .uncompress(o, `${e}/${n}/`)
            .then(() => {
              t.existsSync(o) && t.unlinkSync(o), c();
            })
            .catch((n) => {});
      });
    });
    ...
    if ("undefinedenv" !== t)
      return (
        ...
        await this.app
          ...
          .catch((n) => this.onError(n)),
        (await this.describeSafetySource()).Data.filter(
          (t) => t.AppName === n
        )[0]
      );
  },
