  ...
  s = function (e) {
    if (n.existsSync(e)) {
      for (var r of n.readdirSync(e)) {
        var t = e + "/" + r;
        n.statSync(t).isDirectory() ? s(t) : n.unlinkSync(t);
      }
      n.rmdirSync(e);
    }
  },
  o = function (e) {
    n.existsSync(r.dirname(e)) || o(r.dirname(e)), n.mkdirSync(e);
  },
  u = function (e) {
...
module.exports = {
  ...
  copy: async function (r, t) {
    if (!(await i(r))) return new Error(`File does not exist - ${r}`), void 0;
    for (; await i(t); )
      t = t.replace(/( - (\d+))?(\.[^\.]+)?$/, (e, n, r, t) => {
        let i = r ? parseInt(r) : 0,
          s = ++i + "";
        for (; s.length < 3; ) s = "0" + s;
        return ` - ${s}${t || ""}`;
      });
    return await e(n.copy)(r, t), t;
  },
  ...
  emptyFilter: function () {
    t.emit("filter-changed", ""), t.emit("empty-filter");
  },
