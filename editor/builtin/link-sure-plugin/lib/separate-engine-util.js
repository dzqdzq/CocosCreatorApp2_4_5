...
module.exports = {
  gatherInfo(r) {
    (i = r.cpk), (d = r.gameConfig), (l = r.customConfig.separateEngineMode);
    let o = r.buildPath;
    (n = e.join(o, "cocos")),
  ...
  organizeResources() {
    ...
    Editor.info(Editor.T("link-sure-runtime.separate_engine_begin_hint")),
      r.existsSync(n) || r.ensureDirSync(n),
      r.moveSync(s, t);
