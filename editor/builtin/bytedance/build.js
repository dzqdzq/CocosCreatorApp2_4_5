const e = Editor.require("app://editor/share/adapters-build-utils"),
  ...
  n = require("fire-fs"),
  i = require("crypto"),
  o = Editor.require("app://editor/share/build-utils"),
  r = "project://bytedance.json",
...
const u = {
  ...
  "game.json": function (e, n) {
    let i = Editor.Profile.load(r),
      s = JSON.parse(e.contents.toString());
    if (
      ...
      e.version = a[t] || t;
    } else delete s.plugins;
    let u = [];
    for (var d = 0, l = n.bundles.length; d < l; d++) {
      var c = n.bundles[d];
      "subpackage" === c.compressionType &&
  ...
  "signature.json": function (e, o) {
    if (!o.separateEngineMode) return (e.contents = null), void 0;
    ...
    "script-build-finished": async function (t, n) {
      ...
      try {
        (function () {
          ...
          (n.settings.server =
            Editor.Profile.load(r).get("REMOTE_SERVER_ROOT")),
