...
function c(e) {
  ...
  if (!s) return Editor.info(e + " does not exists in library"), {};
  if (s.useRawfile())
    return Editor.info("This asset does not contain in the library"), {};
...
function u(e, t, s) {
  ...
  return a.push({ type: "separator" }), a.concat(r);
}
module.exports = {
  getContextTemplate: function (i) {
    ...
    var f = [
      { label: Editor.T("ASSETS.create"), enabled: !S, submenu: u(!0) },
      { type: "separator" },
      {
        ...
        click() {
          let e = d();
          e && Editor.Ipc.sendToPanel("assets", "assets:copy", e);
        },
      },
      {
        ...
        click() {
          let e = d();
          e && Editor.Ipc.sendToPanel("assets", "assets:paste", e);
        },
      },
      { type: "separator" },
      {
        ...
        click() {
          let e = d();
          e && Editor.Ipc.sendToPanel(n.name, "assets:rename", e);
        },
      },
      {
        ...
        click() {
          let e = Editor.Selection.contexts("asset");
          e.length > 0 && Editor.Ipc.sendToPanel(n.name, "assets:delete", e);
        },
      },
    ];
    ...
    return (
          ...
          click() {
            ...
            1 ===
              ...
              r.waterfall(
                ...
                function (e) {
                  e && Editor.warn(Editor.T("ERROR.assets.rollback"));
                }
              );
          },
        }),
      (f = f.concat([
        { type: "separator" },
        {
          ...
          click() {
            let e = d();
            e && Editor.Ipc.sendToPanel(n.name, "assets:find-usages", e);
          },
        },
        {
        ...
        { type: "separator" },
        {
          ...
          click() {
            ...
            if (e) {
              let { path: t } = c(e);
              t && Editor.Ipc.sendToMain("assets:open-text-file-by-path", t);
            }
          },
        },
        {
        ...
        },
        {
          ...
          click() {
            ...
            if (e) {
              let t = Editor.assetdb.uuidToUrl(e),
                s = Editor.Utils.UuidUtils.compressUuid(e, !0);
              Editor.info(`${e} (${s}), ${t}`);
            }
          },
        },
