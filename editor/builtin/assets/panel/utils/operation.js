...
(exports.loadAssets = function () {
  o.emit("start-loading"),
    Editor.assetdb.deepQuery((e, t) => {
      try {
        if ((console.time("assets-tree._build()"), e))
          return console.error("load assets error ", e), void 0;
        let o = r.genAssetsTree(t);
        this.fold(o.children[0].id, !1),
          console.timeEnd("assets-tree._build()");
      } catch (e) {
        Editor.warn(e.message);
      }
      o.emit("finish-loading"), o.emit("assets-tree-ready");
    });
}),
  (exports.show = function (e, t) {
    let o = r.queryNode(e);
    return !!o && ((o.show = t), this.updateShowNodes(), !0);
  }),
  ...
  (exports.fold = function (e, t) {
    ...
    if (!o) return console.log("can't find node ", e), !1;
    (o.fold = t),
      o.children &&
  ...
  (exports.recFoldNodes = function (e, t) {
    ...
    o.children &&
      o.children.forEach((e) => {
        this.fold(e.id, t), this.recFoldNodes(e.id, t);
      });
  }),
  (exports.recParentNodes = function (e, t) {
    ...
    let n = (e) => {
      ...
      o && (o !== r.queryRoot() && this.fold(o.id, t), o.parent && n(o));
    };
    n(o);
  }),
  ...
  (exports.getRealUrl = function (t, o) {
    ...
    let s = (o || i.name) + i.extname,
      d = n[i.parent];
    for (; d; ) (s = e.join(d.name + d.extname, s)), (d = n[d.parent]);
    return (s = "db://" + s);
  }),
  (exports.getPath = function (t) {
    ...
    let i = "",
      s = o[n.parent];
    for (; s; ) (i = e.join(s.name + s.extname, i)), (s = o[s.parent]);
    return (i = "db://" + i);
  }),
  ...
  (exports.remove = function (e) {
    r.remove(e) && this.updateShowNodes();
  }),
  (exports.add = function (e) {
    r.add(e), this.updateShowNodes();
  }),
  (exports.autoSort = function () {
    r.sortAssetsTree(), this.updateShowNodes();
  });
let n = [];
(exports.staging = function (e) {
  ...
  (n.length = 0),
    t.forEach((t) => {
      t.selected && n.push(t.id), (t.selected = -1 !== e.indexOf(t.id));
    });
}),
  (exports.restore = function () {
    ...
    return (
      r.queryNodes().forEach((t) => {
        t.selected && e.push(t.id), (t.selected = -1 !== n.indexOf(t.id));
      }),
      (n = []),
      e
    );
