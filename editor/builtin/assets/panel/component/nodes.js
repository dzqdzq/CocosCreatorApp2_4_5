...
const e = require("fs"),
  ...
  l = require("../utils/display"),
  a = require("../utils/communication"),
...
(exports.template = e.readFileSync(
  ...
  (exports.methods = {
    ...
    updateShowList() {
      ...
      (this.uh.height = 0), (this.list.length = 0);
    ...
    scrollIfNeeded(e) {
      ...
      let s = i * o.lineHeight,
        r = this.$el.scrollTop + this.$el.clientHeight - o.lineHeight - 2;
      s < this.$el.scrollTop - 2
        ? (this.$el.scrollTop -= this.$el.scrollTop - 2 - s)
        : s >= r && (this.$el.scrollTop += s - r);
    },
    scrollToItem(e) {
      let t = o.queryNode(e);
      if (!t) return;
      r.recParentNodes(e, !1);
      ...
      setTimeout(() => {
        if (this.$el) {
          ...
          s > -1 &&
            ((this.$el.scrollTop =
              o.lineHeight * s - (o.lineHeight * this.length) / 2),
            r.hint(e));
        }
      }, 50);
    },
    ...
    onDropAreaAccept(e) {
      ...
      if (
        ("file" === a
          ...
          : ("asset" !== a && "node" !== a) || (d = d.map((e) => e.id)),
        0 === d.length)
      )
        return;
      if (n.node && -1 !== d.indexOf(n.node.id)) return;
      (this.y = -999),
        1,
        n.node && console.log(`插入目标节点：${n.node.name} - ${n.node.id}`);
      let h = r.getRealUrl(n.node.id),
        u = !0;
      if (
        ("folder" !== n.node.assetType &&
          "mount" !== n.node.assetType &&
          ((h = r.getPath(n.node.id)), (u = !1)),
        "file" === e.detail.dragType)
      ) {
        let e;
        if (u) e = n.node.children.map((e) => e.name + e.extname);
        else {
        ...
        d.length > 0 && Editor.assetdb.import(d, h, !0);
      } else {
        e.detail.dragItems
          ...
          .forEach((l, a) => {
            ...
            switch (e.detail.dragType) {
              ...
              case "asset":
                ...
                if (
                  o.queryNode(d).parent === n.node.parent &&
                  "folder" !== n.node.assetType
                )
                  return;
                let a = r.getRealUrl(d);
                (u = i.join(u, i.basename(a))), Editor.assetdb.move(a, u, !0);
            }
