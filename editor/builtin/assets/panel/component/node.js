...
(exports.template = e.readFileSync(
    ...
    "node.rename": {
      handler: function (e, t) {
        e && !t && (this.oriName = this.node.name),
          !e && t && this.oriName !== this.node.name && this.nodeRename();
      },
    },
    "node.level": {
      handler: function (e, t) {
  ...
  (exports.methods = {
    ...
    _getDrawFrameIcon(e) {
      let t,
        i,
        n = `thumbnail://${e.rawTextureUuid}?32`,
        o = e.trimX,
        s = e.trimY,
        r = 0;
      e.rotated
        ? ((t = e.height), (i = e.width), (r = 270))
    ...
    onMouseUp(e) {
      if (
        (2 !== e.button && Editor.Selection.setContext("asset"),
        e.ctrlKey || e.metaKey)
      ) {
    ...
    async nodeRename() {
      if (a.STATE.RECORD && "animation-clip" === this.node.assetType) {
        if (
          await i(Editor.Ipc.sendToPanel)(
            "timeline",
      ...
      let e = "";
      if (
        "javascript" === this.node.assetType ||
