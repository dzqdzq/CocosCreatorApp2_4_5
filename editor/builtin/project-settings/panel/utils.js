...
const e = require("fire-fs"),
  { dirname: t, join: o } = require("path"),
  i = Editor.require("app://share/engine-utils");
let r = null;
...
(exports.queryGroupList = function () {
  ...
  (exports.querySimulator = function () {
    if (!r) return null;
    let e,
      t = exports.profiles.project,
      o = t.get("use-project-simulator-setting"),
      i = t.get("simulator-orientation") || r.isLandscape,
      s = t.get("simulator-resolution") || {},
      n = t.get("use-customize-simulator"),
      l = t.get("clear-simulator-cache"),
      p = r.simulator_screen_size.map((e, t) => ({
        index: t,
        width: e.width,
        height: e.height,
        title: e.title,
  ...
  (exports.queryEngine = function () {
    ...
    return {
      useGlobalSetting: t("use-global-engine-setting", !0),
      useDefaultJsEngine: t("use-default-js-engine", !0),
      jsEnginePath: e.get("js-engine-path") || "",
      useDefaultCppEngine: t("use-default-cpp-engine", !0),
  ...
  (exports.queryFacebook = function () {
    ...
    return (
      t || (t = e.set("facebook", {})),
      { enable: t.enable, appID: t.appID, live: t.live, audience: t.audience }
    );
  });
(exports.setGroupList = function (e) {
  let t = exports.profiles.project,
    o = t.get("group-list");
  for (o || ((o = []), t.set("group-list", o)); o.length > e.length; ) o.pop();
  e.forEach((e, t) => {
    o[t] = e;
  }),
    t.set("group-list", o);
  ...
  (exports.setSimulator = function (e) {
    ...
    if ("global" === e.type) {
      let t = exports.profiles.global,
        i = t.get("simulator-resolution"),
        r = e.resolutionList[i];
      (o.width = r.width),
        (o.height = r.height),
  ...
  (exports.setFacebook = function (e) {
    ...
    (o.enable = e.enable),
      (o.appID = e.appID || ""),
      (o.live = e.live || { enable: !1 }),
      (o.audience = e.audience || { enable: !1 }),
      t.set("facebook", o);
  }),
  (exports.save = function () {
    let o = exports.profiles.local;
    o.get("use-global-engine-setting") && (o = exports.profiles.global);
