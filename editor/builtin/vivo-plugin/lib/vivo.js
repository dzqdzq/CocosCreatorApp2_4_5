var r,
  ...
  o,
  i = require("path"),
  t = require("child_process").execSync,
...
let u = {
  npmRunServer: function (u, c) {
        ...
        e
          ? (Editor.log(Editor.T("vivo-runtime.custom_npm_path_config"), e),
            "win32" === process.platform
              ? ((r.Path = o.npmPath), (r.Path += ";C:\\Windows\\System32"))
              : ((r.PATH = o.npmPath),
    ...
    var v = r.dest,
      a = i.join(v, "node_modules"),
      f = i.join(v, "dist");
    if (!s.existsSync(a) || !s.existsSync(f))
      return Editor.error(Editor.T("vivo-runtime.buidBeforePreview")), void 0;
    var m,
      _ = "win32" === process.platform ? "npm.cmd" : "npm";
    (free = n(`${_}`, ["run", "server"], { env: p, cwd: v })),
      free.stdout.on("data", function (r) {
        if (((e = free.pid), r && -1 !== r.indexOf("地址 http:"))) {
          var o = r.toString().replace(/[\n\r]/g, "");
          return (m = o.match(/http:\/\/[^\s]*:\d*/)[0]), u(m), void 0;
        }
      }),
