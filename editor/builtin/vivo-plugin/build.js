const e = "project://vivo-runtime.json",
  i = "minigame.config.js",
  n = "game.js",
  t = "boot.js",
  o = "manifest.json",
  r = "qgame-adapter.js",
  a = "cocos-library",
  s = "7d8bb580016b6a2fb89d902deda0d3a4",
  c = "src",
  l = "sign",
  d = "engine";
let u,
  m,
  p,
  v = require("child_process").spawn,
  f = require("path"),
  g = require("fs-extra"),
  j = require(Editor.url("packages://vivo-runtime/lib/cli")),
  y = "";
var E;
let S, _, b, h, P, k, T;
function x(e) {
...
function D(e, i, n) {
  g.readdirSync(e).forEach(function (t) {
    let o = f.join(e, t),
      r = g.statSync(o);
    if (r && r.isDirectory()) D(o, i);
    else {
      if (".js" !== f.extname(o)) return;
  ...
  !0 === u.separateEngineMode &&
    ...
    (e.subpackages = (function () {
      ...
      for (var n = 0, t = P.bundles.length; n < t; n++) {
        var o = P.bundles[n];
        if ("subpackage" !== o.compressionType) continue;
        let t = o.name;
        i.includes(t) ||
          (i.push(t), e.push({ name: "usr_" + t, root: t + "/" }));
      }
      0 === e.length && (e = void 0);
      return e;
    })()),
  ...
  g.emptyDirSync(i),
    ...
    (function () {
      for (let i = 0, n = P.bundles.length; i < n; i++) {
        var e = P.bundles[i];
        if ("subpackage" !== e.compressionType) continue;
        let n = f.join(m, "src", e.name);
        g.emptyDirSync(n), g.copySync(e.scriptDest, n);
        let t = "index.js",
          o = f.join(n, t),
          r = f.join(n, "game.js");
        g.existsSync(o) && g.renameSync(o, r);
      }
    })();
}
function $(e, i) {
...
function M(e, n) {
  if (
    ...
    !0 === u.separateEngineMode && !j.isSupportSeparateEngine())
  )
    return (
  ...
  let o = f.join(m, c),
    s = f.join(m, d);
  g.emptyDirSync(s), g.existsSync(o) && g.moveSync(o, f.join(s, c));
  var p = j.getQGameAdapterPath();
  g.existsSync(p) || (p = f.join(x("res"), r)),
    ...
    (function () {
      if (!u.separateEngineMode) return;
      let e = f.join(m, a),
        i = f.join(m, d, c, "cocos2d-runtime.js"),
        n = f.join(e, "cocos2d-runtime.js"),
        o = f.join(m, d, c, t),
        r = f.join(e, "plugin.json");
    ...
    (async function (e) {
      let i = require("./build-jsb-adapter"),
        n = f.join(x(), "engine", "index.js"),
        t = f.join(m, d, "adapter", "index.js");
      await i.build({ rootPath: n, dstPath: t, isDebug: P.debug }), e && e();
    })(function () {
      (function () {
        ...
        if ("" !== u.tinyPackageServer) return;
        let i = f.join(m, "remote");
        g.existsSync(i) && g.copySync(i, f.join(m, "src", "remote"));
      })(),
        g.copySync(
        ...
        (function () {
          (y = ""),
            D(f.join(m, "assets"), m),
            !0 === u.separateEngineMode
              ? (D(f.join(m, d), m, ["cocos2d-runtime.js"]), D(f.join(m, a), m))
              : D(f.join(m, d), m);
          (function () {
            let e = f.join(x("res"), i),
              n = g.readFileSync(e, "utf8");
...
function O() {
  ...
  n.stdout.on("data", (e) => {}),
    ...
    n.on("close", (e) => {
      ...
      if (!g.existsSync(i))
        return (
          k.reply(new Error(Editor.T("vivo-runtime.rpk_install_fail"))), void 0
        );
...
module.exports = {
  ...
  messages: {
    ...
    "build-start": function (i, n) {
      ...
      if (
        ...
        !1 === j.isInstallNodeJs(i, t.npmPath))
      )
        return;
      if (!1 === j.isInstallVivoMinigameTool())
        return (
          i.reply(
            new Error(
      ...
      if (!1 === j.isInitVivoProject() || !1 === o)
        return (
          !1 === o && g.emptyDirSync(n.dest),
          j.initVivoProject(function (e) {
            if (e) return Editor.log("init  game project failed"), void 0;
            g.emptyDirSync(f.join(n.dest, "src")), i.reply();
          }),
          void 0
        );
      i.reply();
    ...
    "build-finished": function (i, n) {
      ...
      if (
        ([
          ...
          e.value || ((l = !1), d.push(e.name));
        }),
        l || (m += d.join("、") + Editor.T("vivo-runtime.not_empty")),
        r &&
          (g.existsSync(p) ||
            ((l = !1), (m += r + Editor.T("vivo-runtime.icon_not_exist")))),
        _ ||
          ("" === E
            ? ((l = !1),
        ...
        return k.reply(new Error(m)), void 0;
      g.existsSync(f.join(n.dest, "remote")) &&
        "" === u.tinyPackageServer &&
  ...
  buildStart: function (i) {
    ...
    (i.startSceneAssetBundle = n.get("packFirstScreenRes") || !1),
      (i.separateEngineMode = n.get("separateEngineMode") || !1);
  },
