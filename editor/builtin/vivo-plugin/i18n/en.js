module.exports = {
  ...
  support_min_platform_hint:
    "Enter the minimum supported platform version number, such as: 1030",
  ...
  download_qgame_adater: "downloading latest qgame-adapter.js",
  download_qgame_adater_success: "download latest qgame-adapter.js success",
  download_qgame_adater_fail:
    "downloading the latest qgame-adapter.js fails, the default qgame-adapter.js will be used",
  separate_engine: "Separate Engine",
  separate_engine_dont_support:
    "The current @vivo-minigame version does not support the separation engine function, please update: npm install -g @vivo-minigame/cli@latest",
