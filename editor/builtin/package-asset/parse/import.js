...
let l = r.T("IMPORT_ASSET.parse_zip_err_title"),
  _ = r.T("IMPORT_ASSET.parse_zip_err_content");
...
module.exports = {
  ...
  _addAsset(e, s) {
    ...
    if (!r.dir && s)
      if (r.ext) {
        ...
        let t = new h(e, s);
        -1 === s.children.indexOf(t) &&
          (s.children.push(t), (this._folderArr[r.name] = t));
      }
    else {
      ...
      i.loadAsync(n).then(
        (e) => {
          try {
            ...
            r.showErrorMessageBox(l, _), t && t(_);
          }
        },
        (e) => {
          r.showErrorMessageBox(l, _), t && t(_);
  ...
  _addNeedImport(e, t, r) {
    e.selected && ((t[e.name] = e), (t[e.name + ".meta"] = e)),
      s.each(
        e.children,
        (s, r) => {
          if (
            (s.selected && ((t[s.name] = s), (t[s.name + ".meta"] = e)),
            "folder" !== s.type)
          )
            return r();
    ...
    if (".meta" === n.ext) {
      ...
      s.async("string").then((s) => {
        e.writeFileSync(a, s),
          t.forEach((t) => {
            if (
              (e.existsSync(a) && (s = e.readFileSync(a, "utf8")),
              -1 !== s.indexOf(t))
            ) {
              let i = new RegExp(t, "g");
              (s = s.replace(i, r[t])), e.writeFileSync(a, s);
            }
          }),
          i();
      });
      ...
      (e, s) => {
        ...
        ".meta" === i.ext && o
          ? e.async("string").then((e) => {
              let r = JSON.parse(e),
                o = Editor.remote.assetdb.uuidToFspath(r.uuid);
              if (o) {
  ...
  _importAssets(a, o) {
    if (!e.existsSync(this._basePath)) {
      let e = r.T("IMPORT_ASSET.err_title"),
        t = r.T("IMPORT_ASSET.err_info_not_exist", { outPath: this._basePath });
      return r.showErrorMessageBox(e, t), void 0;
    }
      ...
      n ||
        i.loadAsync(h).then((i) => {
          try {
            ...
            (this._progressInfo.total = h.length),
              this._checkMeta(n, a, (i, h) => {
                let l = r.T("IMPORT_ASSET.confirmation_box_title"),
                  _ = r.T("IMPORT_ASSET.confirmation_box_content", {
            ...
            r.showErrorMessageBox(l, _), o && o(_);
          }
        });
    });
  },
  importZip(t, s, i) {
    if (((this._outPath = t), this._initPorgress(i), !e.existsSync(t))) {
      let e = r.T("IMPORT_ASSET.err_title"),
        s = r.T("IMPORT_ASSET.err_info_not_exist", { outPath: t });
      return r.showErrorMessageBox(e, s), void 0;
    }
