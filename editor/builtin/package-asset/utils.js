...
(exports.ASSET_TYPE = "&asset&type&.json"),
  ...
  (exports.save = function (e, t) {
    this.localProfiles.set(e, t), this.localProfiles.save();
  }),
  ...
  (exports.showImportZipDialog = function (e) {
    ...
    if (!e || !t) return;
    let o = t[0];
    e(null, o), this.save("import-folder-path", o);
  }),
  ...
  (exports.copy = function (r, s, i, n) {
    ...
    if (0 === a.length) return n(), void 0;
    o.each(
      a,
      (o, n) => {
        if (!i[o]) return n(), void 0;
        let a = t.join(r, o),
          c = t.join(s, o);
        e.statSync(a).isDirectory()
          ? (this.createFolder(c), this.copy(a, c, i, n))
          : (this.copyFile(a, c), n());
      },
      n
    );
  ...
  (exports.getIcon = function (e) {
    let t = Editor.assetdb.remote.loadMetaByUuid(e),
      o = t.assetType();
    if ("texture" === o) return `thumbnail://${e}?32`;
    if ("sprite-frame" === o) return `thumbnail://${t.rawTextureUuid}?32`;
    if ("dragonbones" === o || "dragonbones-bin" === o) o = "spine";
    else {
      if ("effect" === o) return "unpack://static/icon/assets/shader.png";
      if ("fbx" === o || "gltf" === o)
    ...
    (e.selected = t),
      e.children &&
        e.children.forEach((e) => {
          (e.selected = t), this.changedAssetTreeSelectState(e, t);
        });
  }),
