const e = Editor.require("app://editor/share/adapters-build-utils"),
  ...
  i = require("fire-fs"),
  n = require("globby"),
  r = "project://wechatgame-opendata.json",
  o = Editor.require("app://editor/share/3d-physics-build-utils");
const a = {
  "game.js": function (e, i) {
    Editor.Profile.load(r);
    ...
    n = n.replace("require('cocos2d-js-path')", a);
    let s = i.debug ? "require('adapter.js')" : "require('adapter-min.js')";
    (n = n.replace("require('adapter-js-path')", s)),
      (n = o.updateMinigameRequire(i, n)),
      (e.contents = new Buffer(n));
  },
};
module.exports = {
  name: Editor.T("wechatgame-opendata.platform_name"),
  ...
  messages: {
    "script-build-finished": async function (t, i) {
      ...
      try {
        (function () {
          if (!Editor.Profile.load(r)) throw new Error("config file not found");
        })(),
    ...
    "build-finished": function (e, o) {
      ...
      try {
        (function (e) {
          let r = n.sync(t.join(e.dest, "assets/**"), { nodir: !0 });
          for (let e = 0; e < r.length; ++e) {
            let n = r[e];
            if (".json" !== t.extname(n)) continue;
  ...
  settings: Editor.url("packages://wechatgame-opendata/build-ui.js"),
};
