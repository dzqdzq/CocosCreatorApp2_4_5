const e = Editor.require("app://editor/share/adapters-build-utils"),
  t = require("fire-path"),
  n = require("fire-fs"),
  i = require(Editor.url("packages://wechatgame/utils/wechat-game")),
  o = require("crypto"),
  r = Editor.require("app://editor/share/build-utils"),
  s = "project://wechatgame.json",
  a = Editor.require("app://editor/share/3d-physics-build-utils"),
  u = {
    "2.2.1": "2.2.2",
    "2.2.2": "2.2.3",
    "2.4.2": "2.4.1",
...
const l = {
  "game.js": function (e, t) {
    ...
    t.separateEngineMode && (i = "requirePlugin('cocos')"),
  ...
  "game.json": function (e, n) {
    ...
    if (
      ...
      n.separateEngineMode)
    ) {
      let e = o.plugins.cocos,
        t = Editor.versions.CocosCreator;
      e.version = u[t] || t;
    } else delete o.plugins;
    let a = [];
  ...
  "signature.json": function (e, i) {
    if (!i.separateEngineMode) return (e.contents = null), void 0;
  ...
  "plugin.json": function (e, t) {
    t.separateEngineMode || (e.contents = null);
  },
};
module.exports = {
  ...
  delPattern: function (e) {
    ...
    return n && o.push(`!${t.join(i, n)}`, `!${t.join(i, n, "**/*")}`), o;
  },
    ...
    "script-build-finished": async function (t, n) {
      ...
      try {
        (function () {
          ...
          if (!e) throw new Error("config file not found");
          e.get("appid") ||
            Editor.warn("appid is empty, use 'wx6ac3f5090a6b99c5' by default");
        })(),
          (n.settings.server =
            Editor.Profile.load(s).get("REMOTE_SERVER_ROOT")),
      ...
      try {
        (function (e) {
          for (var i = 0, o = e.bundles.length; i < o; i++) {
            ...
            n.existsSync(o) && n.renameSync(o, t.join(r.scriptDest, "game.js"));
          }
        })(i),
          (function (e) {
