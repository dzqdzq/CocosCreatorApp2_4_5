(() => {
  ...
  const e = require("fire-path"),
    t = Editor.require("packages://inspector/utils/utils"),
    i = require(Editor.url("app://editor/share/build-utils")),
    r = Editor.Profile.load("global://features.json"),
    o = [];
  !r.get("huawei-agc") && o.push("huawei-agc"),
    !r.get("link-sure") && o.push("link-sure"),
    r.get("bytedance-minigame") ||
      (o.push("bytedance"), o.push("bytedance-subcontext")),
    Editor.Panel.extend({
      dependencies: [
      ...
      data: {
        ...
        curOptimizeHotUpdate: !1,
        curInlineSpriteFrames: !1,
        curIsRemoteBundle: !1,
        platforms: [
          "web-mobile",
          "web-desktop",
      ...
      methods: {
        ...
        _updateCurRemoteBundle() {
          this._supportRemoteBundle()
            ? this._isRemoteBundleReadonly() &&
              ((this._isNative() && this.isResources) ||
              "subpackage" === this.curCompressionType
                ? (this.curIsRemoteBundle = !1)
                : "zip" === this.curCompressionType &&
                  (this.curIsRemoteBundle = !0))
            : (this.curIsRemoteBundle = !1);
        },
        _isBundle() {
        ...
        _platformChanged() {
          (this.curCompressionType =
            this.target.compressionType[this.curPlatform] ||
            (this._isInternal() ? "merge_all_json" : "default")),
            (this.curInlineSpriteFrames =
              this.target.inlineSpriteFrames[this.curPlatform] || !1),
            (this.curOptimizeHotUpdate =
              this.target.optimizeHotUpdate[this.curPlatform] || !1),
            (this.curIsRemoteBundle =
              this.target.isRemoteBundle[this.curPlatform] || !1);
        },
        _settingsChanged() {
          this._updateCurRemoteBundle(),
            this.curOptimizeHotUpdate && (this.curInlineSpriteFrames = !1),
            this.target.metas.forEach((e) => {
              (e.compressionType[this.curPlatform] = this.curCompressionType),
                (e.optimizeHotUpdate[this.curPlatform] =
                  this.curOptimizeHotUpdate),
                (e.inlineSpriteFrames[this.curPlatform] =
                  this.curInlineSpriteFrames),
        ...
        async _onApply() {
          if (this.isResources) return !0;
          let e = await t.checkDuplicateNameForBuiltinBundle(this.target);
          return e || Editor.Ipc.sendToWins("inspector:bundle-updated"), !e;
        },
        _bundleName: (t) =>
        ...
        _targetChanged() {
          this.target
            ? ((this.url = this.target.__url__),
              (this.isResources =
                "db://assets/resources" === this.url ||
                "db://internal/resources" === this.url),
              this._platformChanged(),
              (this.curPriority = this.target.priority),
              "db://assets/resources" === this.url && (this.curPriority = 8))
            : ((this.url = ""), (this.isResources = !1));
        },
        explore() {
