...
Vue.component("material-property", {
  ...
  methods: {
    _onDataChanged(e) {
      e && this.$el === e.target && (this.target.value = e.target.value),
  ...
  Vue.component("material-properties", {
    ...
    computed: {
      ...
      children() {
        ...
        return delete e.props, delete e.value, delete e.level, e;
      },
    },
  }),
  (module.exports = {
    ...
    compiled() {
      this.$el.addEventListener("material-item-changed", (e) => {
        e.stopPropagation(), this._onDataChanged(e.detail);
      });
    },
    data: {
      cssHost: {
    ...
    watch: {
      ...
      effectName() {
        this.effectName &&
          ...
          (this.recreateTechniqueData(), this.refreshTechnique());
      },
      techniqueIndex() {
        -1 === this.techniqueIndex ||
          this.isEffectMissing() ||
          (this.recreateTechniqueData(), this.refreshTechnique());
      },
    },
    methods: {
      ...
      createDisplayList(e, t) {
        ...
        for (let t of e) {
          ...
          t.defines.forEach((t) => {
            i.test(t) ||
              (e[t] || (e[t] = { level: e.level + 1, value: a[t] }),
              (e = e[t]),
              (s[t] = !0));
          }),
            e.props || (e.props = []),
      ...
      _onEffectChanged(e) {
        (this.effectName = e.target.value), (this.dirty = !0);
      },
      ...
      async _onApply() {
        ...
        if (Editor.remote.assetdb.isSubAssetByUuid(this.target.uuid)) {
          ...
          Editor.assetdb.saveMeta(this.target.uuid, e, (e) => {
            ...
            (this.dirty = !1), Editor.Ipc.sendToWins("scene:soft-reload", !0);
          });
        } else {
