...
const e = require("highlight.js"),
  { lineNumbersBlock: n } = Editor.require(
...
Vue.component("cc-code-preview", {
  ...
  methods: {
    _updateText() {
      (this.path || this.code) &&
        "unknown" !== this.type &&
        (this.code && !this.path ? this._showCode() : this._highlightCode());
    },
    _highlightCode() {
      const e = require("fire-fs"),
        n = require("event-stream");
