...
Vue.component("texture-format", {
  ...
  computed: {
    platformSupportedFormats() {
      let t = {};
      for (let n in this.supportFormats)
        this.supportFormat(n) && (t[n] = this.supportFormats[n]);
      return t;
    },
  },
  methods: {
    ...
    onSelectFormat(t) {
      if ("none" === this.selectValue) return;
      ...
      if (a) return Editor.warn("Already adds a same format."), void 0;
      (a = {
    ...
    _openExternal(t, n) {
      t.stopPropagation(), require("electron").shell.openExternal(n);
    },
    T: (t) => Editor.T(t),
