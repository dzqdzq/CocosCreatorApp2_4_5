...
Vue.component("cc-comp-section", {
  ...
  props: {
    name: { twoWay: !0, type: String },
    editor: { twoWay: !0, type: Object },
  ...
  methods: {
        ...
        (this._requestID = Editor.Ipc.sendToPanel(
          ...
          (t, e) => {
            let n = this.$els.dropdown.getBoundingClientRect(),
              i = this.target.node.values.map((t) => t.uuid) || [],
              o = this.target.uuid.values;
    ...
    openHelpClick(t) {
      ...
      e.startsWith("i18n:") && (e = Editor.T(e.replace("i18n:", ""))),
  ...
  compiled() {
    this.customDraw() &&
      Editor.import(this.editor.inspector).then((t) => {
        ...
        t.options && t.options.dependencies && t.options.dependencies.length
