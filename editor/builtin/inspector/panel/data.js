  ...
  (exports.get = function () {
    ...
    e.forEach((e) => {
      ...
      e.value.__comps__.forEach((e) => {
        var a = e.type;
        r[a] || (r[a] = 0), (e.__orderedType = a + r[a]), (r[a] += 1);
      });
    });
    var a = {
      types: {},
            ...
            _ = e.map((e) => {
              ...
              return (
                e.value.__comps__.some((e) => {
                  e.__orderedType === r.__orderedType && (a = e);
                }),
                a || (t = !0),
                a
              );
  ...
  if (e && e[0]) {
    ...
    e.forEach((e) => {
      var t = (function (e, r) {
        ...
        v = t.value.uuid.value || t.value.uuid;
      let s = { id: v, path: u, type: n, value: l, isSubProp: !1 };
      r[`${v}.${u}`] = s;
    }),
      exports.onSendBegin && exports.onSendBegin(),
      clearTimeout(t),
      (t = setTimeout(() => {
        for (let e in r)
...
function u(e) {
  var r = e[0],
    a = { type: r.type, value: r.value, values: e.map((e) => e.value) };
  return (
