...
const e = require("lodash"),
  ...
  { changeCurveState: o, changeCurveData: n } = Editor.require(
...
Editor.Panel.extend({
  ...
  listeners: {
    ...
    "drop-area-enter"(e) {
      if ((e.stopPropagation(), !this._vm || "node" !== this._selectType))
        return;
      let t = e.detail.dragItems;
      (this.highlightBorderFlag = !0),
        Editor.assetdb.queryInfoByUuid(t[0].id, (t, i) => {
          let s = i.type;
          ("javascript" !== s && "typescript" !== s) ||
            ((this.dropAccepted = !0),
            this.highlightBorderFlag && (this.$highlightBorder.hidden = !1),
    ...
    "drop-area-leave"(e) {
      e.stopPropagation(),
        this._vm &&
          "node" === this._selectType &&
          ((this.dropAccepted = !1),
          (this.highlightBorderFlag = !1),
          (this.$highlightBorder.hidden = !0));
    },
    "drop-area-accept"(e) {
      if ((e.stopPropagation(), !this._vm || "node" !== this._selectType))
        return;
    ...
    async "meta-apply"(e) {
      if ((e.stopPropagation(), !(await this._vm._onApply()))) return;
    ...
    var t = (e) => (t) => {
      ...
      if (i.expression) {
        ...
        if (a) {
          ...
          if (o) {
            var n = {};
            "UI-PROP" === i.tagName && (o.value = t.detail.value),
  ...
  _clear() {
    clearTimeout(this._queryNodeTimeoutID),
      this._vm && (this._vm.$destroy(), (this._vm = null)),
  ...
  _inspect(e, t) {
    ...
    (this._curSessionID = d),
      "asset" === e && this._selectID.length > 0
        ? this._queryMeta(this._selectID)
        : "node" === e && this._queryNode(this._selectID);
  },
  _doInspect(t, i, s, r, a, o) {
    ...
    this._clear(),
      ...
      this._loadInspector(i, (n, l, d) => {
        if (n)
          return (
            Editor.error(`Failed to load inspector ${i}: ${n.stack}`), void 0
          );
  ...
  _loadMeta(e, t) {
    ...
    Editor.assetdb.queryMetaInfoByUuid(e, (s, r) => {
      if (!r)
        return t && t(new Error(`Failed to query meta info by ${e}`)), void 0;
  ...
  messages: {
    "selection:activated"(e, t, i) {
      ("node" !== t && "asset" !== t) ||
        (this._checkIfApply(), this._inspect(t, i), (this._hasActivated = !0));
    },
    "selection:changed"(e, t) {
      if ("asset" !== t || this._hasActivated)
        return (this._hasActivated = !1), void 0;
      this.refresh();
    },
    "selection:deactivated"(e, t, i) {
      "node" === t &&
        "node" === this._selectType &&
        (this._checkIfApply(), (this._selectID = null));
    },
    ...
    "asset-db:asset-changed"(e, t) {
      ...
      if (this._selectID && this._selectID.includes(t.uuid))
        return (this._forceUpdate = !0), this.refresh(), void 0;
    ...
    "asset-db:asset-uuid-changed"(e, t) {
      this._curInspector &&
        ...
        ((this._selectID = t.uuid), (this._forceUpdate = !0), this.refresh());
    },
    "curve:state"(e, t) {
      o("true" === t);
    },
    ...
    t.map(
      ...
      (e, t) => {
        this._loadMeta(e, (i, s, r) => {
          if (i)
            return (
              Editor.error(`Failed to load meta ${e}: ${i.message}`), void 0
            );
          t(i, r);
        });
      },
      ...
      if (
        ...
        let s = {
          ...
          setProp: (e) => {
            ...
            let o = e.detail.type;
            "cc.Node" === o && (o = e.detail.attrs.typeid),
  ...
  _patchAt(e, t) {
    if (Array.isArray(t)) {
      ...
      for (let e in t) {
        ...
        (a = t[e]),
          "_" === e[0]
            ? (0 !== a[2] && 3 !== a[2]) || i.push(parseInt(e.slice(1), 10))
            : 1 === a.length
      ...
      for (let e = (i = i.sort(c.numerically)).length - 1; e >= 0; e--) {
        let r = i[e],
          a = t["_" + r],
          n = o.splice(r, 1)[0];
        3 === a[2] && s.push({ index: a[1], value: n });
      }
    ...
    } else for (let i in t) this._patchAt(`${e}.${i}`, t[i]);
  },
});
