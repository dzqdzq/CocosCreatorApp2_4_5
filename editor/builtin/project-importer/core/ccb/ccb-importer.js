...
const e = require("async"),
  ...
  a = require("plist"),
  n = require("fire-url"),
  i = "db://internal/image/default_sprite_splash.png/default_sprite_splash",
  o = "db://internal/image/default_btn_normal.png/default_btn_normal",
  c = "db://internal/image/default_btn_pressed.png/default_btn_pressed",
  ...
  d = "db://internal/image/default_scrollbar.png/default_scrollbar",
  u = "_action",
  f = 30,
  p = ["cubic", "elastic", "bounce", "back"],
  v = ["In", "Out", "InOut"],
  m = {
    ...
    CCScrollView: function (t, r, a) {
      ...
      e.waterfall(
        [
          function (e) {
            R(s, function (t) {
              (d = t).setName("container"), e();
            });
          },
          function (e) {
            if ((n.addChild(d), (o.content = d), o.vertical)) {
              var t = L(
  ...
  h = {
        ...
        [
          ...
          function (e) {
            ...
            var n = t.getContentSize(),
              i = _(r, "preferedSize", [n.width, n.height, 0]);
            if ((t.setContentSize(i[0], i[1]), a.spriteFrame)) {
    ...
    CCMenuItemImage: function (e, t, r) {
      ...
      (n.sizeMode = cc.Sprite.SizeMode.CUSTOM),
        (n.trim = !1),
        (a.interactable = _(t, "isEnabled", !0)),
    ...
    CCControlButton: function (e, r, a) {
      ...
      if (p) {
        ...
        var h = v.addComponent(cc.Label),
          S = _(r, "titleTTFSize|1", [-1, 0]),
          g = _(r, "titleColor|1", [255, 255, 255]),
          C = new cc.Color(g[0], g[1], g[2]);
        (v.color = C),
          (h.string = p),
          (h.lineHeight = 0),
          S[0] >= 0 && (h._fontSize = S[0]);
        var b = _(r, "titleTTF|1", "");
        b && ".ttf" === t.extname(b) && O(h, b);
      }
      a();
    },
    CCParticleSystemQuad: function (e, t, r) {
      ...
      (a.life = i[0]), (a.lifeVar = i[1]);
      var o = _(t, "startSize", [0, 0]);
      (a.startSize = o[0]), (a.startSizeVar = o[1]);
      var c = _(t, "endSize", [0, 0]);
      (a.endSize = c[0]), (a.endSizeVar = c[1]);
      var l = _(t, "startSpin", [0, 0]);
      (a.startSpin = l[0]), (a.startSpinVar = l[1]);
      var s = _(t, "endSpin", [0, 0]);
      (a.endSpin = s[0]), (a.endSpinVar = s[1]);
      var d = _(t, "angle", [0, 0]);
      (a.angle = d[0]), (a.angleVar = d[1]);
      ...
      (a.srcBlendFactor = p[0]), (a.dstBlendFactor = p[1]);
      ...
      if (
        ...
        var h = _(t, "speed", [0, 0]);
        (a.speed = h[0]), (a.speedVar = h[1]);
        var S = _(t, "tangentialAccel", [0, 0]);
        (a.tangentialAccel = S[0]), (a.tangentialAccelVar = S[1]);
        var C = _(t, "radialAccel", [0, 0]);
        (a.radialAccel = C[0]), (a.radialAccelVar = C[1]);
      } else {
        var b = _(t, "startRadius", [0, 0]);
        (a.startRadius = b[0]), (a.startRadiusVar = b[1]);
        var y = _(t, "endRadius", [0, 0]);
        (a.endRadius = y[0]), (a.endRadiusVar = y[1]);
        var w = _(t, "rotatePerSecond", [0, 0]);
        (a.rotatePerS = w[0]), (a.rotatePerSVar = w[1]);
      }
      var z = _(t, "texture", null),
        F = !1;
      if (!z) return r();
      var E = n.join(g, z),
        A = Editor.assetdb.remote.urlToUuid(E);
      if (!Editor.assetdb.remote.existsByUuid(A)) return r();
      Editor.assetdb.queryMetaInfoByUuid(A, function (e, t) {
        if (e) return Editor.warn(e), r();
        ...
        cc.assetManager.loadAny(c, function (e, t) {
          if (e) return Editor.warn(e), r();
          (a.spriteFrame = t), (F = !0), (a.enabled = F), r();
        });
      });
    },
  },
  S = {
    position: function (e, t, r) {
      ...
      for (var a = 0, n = e.keyframes.length; a < n; a++) {
        ...
        o.value = [c.x, c.y];
        var l = T(i);
        l && (o.curve = l), r.props.position.push(o);
      }
    },
    rotation: function (e, t, r) {
      ...
      for (var a = 0, n = e.keyframes.length; a < n; a++) {
        var i = e.keyframes[a],
          o = { frame: i.time, value: i.value },
          c = T(i);
        c && (o.curve = c), r.props.rotation.push(o);
      }
    },
    scale: function (e, t, r) {
      (r.props.scaleX = []), (r.props.scaleY = []);
      for (var a = 0, n = e.keyframes.length; a < n; a++) {
        var i = e.keyframes[a],
          o = { frame: i.time, value: i.value[0] },
          c = { frame: i.time, value: i.value[1] },
          l = T(i);
        l && ((o.curve = l), (c.curve = l)),
    ...
    visible: function (e, t, r) {
      ...
      for (var a = 0, n = e.keyframes.length; a < n; a++) {
        var i = e.keyframes[a];
        0 === a && i.time > 0 && r.props.active.push({ frame: 0, value: !1 });
    ...
    color: function (e, t, r) {
      ...
      for (var a = 0, n = e.keyframes.length; a < n; a++) {
        var i = e.keyframes[a],
          ...
          c = T(i);
        c && (o.curve = c), r.props.color.push(o);
      }
    },
...
var g = "",
  ...
  z = [];
function F(i, o) {
  if (y.indexOf(i) >= 0) return o();
  if ((Editor.log("Importing ccb file : ", i), !r.existsSync(i)))
    return Editor.warn("%s is not existed!", i), o();
  var c = t.basename(i, t.extname(i)),
    l = t.relative(b, t.dirname(i)),
    s = t.join(C, l, c + ".prefab");
  e.waterfall(
    [
      function (o) {
        (function (i, o, c) {
          var l = new cc.Node(),
            s = a.parse(r.readFileSync(i, "utf8"));
          e.waterfall(
            [
              function (t) {
                (w = {}), (z = s.sequences);
                var r = s.currentResolution,
                  a = s.resolutions,
                  n = new cc.Size(0, 0);
                a && a[r] && ((n.width = a[r].width), (n.height = a[r].height)),
              ...
              function (a) {
                (function (a, i, o) {
                  if (!w.selfData && !w.childrenData) return o();
                  var c,
                    l,
                    s = [],
                    d = -1;
                  ...
                  w.selfData && E(w.selfData, "", s);
                  if (w.childrenData)
                    for (var v in w.childrenData)
                      w.childrenData.hasOwnProperty(v) &&
                        E(w.childrenData[v], v, s);
                  var m = (function (e) {
                    var r = t.dirname(e),
                      a = t.relative(C, r),
                      i = t.basename(e, t.extname(e)) + u;
                    n.join(g, a, i);
                    return t.join(C, a, i);
                  })(i);
                  r.existsSync(m) || r.mkdirsSync(m);
                  var h = t.dirname(m),
                    S = t.relative(C, h),
                    b = n.join(g, S),
                    y = [];
                  for (c = 0, l = s.length; c < l; c++) {
                    ...
                    r.writeFileSync(T, _), y.push(n.join(b, t.basename(m), A));
                  }
                  e.waterfall(
                    [
                      function (e) {
                        Editor.assetdb.import([m], b, !1, function () {
                          e();
                        });
                      },
                      function (e) {
                        ...
                        if (t) {
                          for (c = 0, l = y.length; c < l; c++) {
                            var r = y[c],
                              i = Editor.assetdb.remote.urlToUuid(r);
                            if (i) {
                              ...
                              (o._uuid = i),
                                ...
                                t.addClip(o),
                                d === c &&
                                  ((t.defaultClip = o), (t.playOnLoad = !0));
                            }
                          }
                          e();
                        } else
                          Editor.warn("Add Animation component failed."), e();
                      },
                    ],
                    o
                  );
              ...
              function (e) {
                ...
                var n = a.createPrefabFrom(l),
                  i = Editor.serialize(n),
                  c = t.dirname(o);
                r.existsSync(c) || r.mkdirsSync(c), r.writeFileSync(o, i), e();
              },
            ],
            c
          );
      ...
      function (e) {
        if (!r.existsSync(s)) return e();
        var t = n.join(g, l);
        Editor.assetdb.import([s], t, !1, function () {
          y.push(i), e();
        });
      },
    ],
...
function E(e, t, r) {
  for (var a = e.theNode, n = 0, i = r.length; n < i; n++) {
    var o = e["" + n];
    o &&
      (r[n].curveData || (r[n].curveData = {}),
      t
        ? (r[n].curveData.paths || (r[n].curveData.paths = {}),
          r[n].curveData.paths[t] || (r[n].curveData.paths[t] = {}),
...
function T(e) {
  if (!e.easing) return null;
  var t = e.easing.type;
  if (t < 0 || t > 13) return null;
  var r = null;
  if (0 === t) r = "constant";
  else if (1 === t) r = "linear";
  else {
    var a = t - 2,
      n = Math.floor((a - 1) / 3),
      i = (a - 1) % 3;
...
function P(e, t, r) {
  e.active = _(t, "visible", !0);
  var a = _(t, "anchorPoint", [0, 0]);
  _(t, "ignoreAnchorPointForPosition", !1)
    ...
    (function (e, t, r) {
      ...
      switch (i) {
        case 1:
          (o = (r.width * o) / 100), (c = (r.height * c) / 100);
          break;
        case 2:
          (o = r.width - o), (c = r.height - c);
          break;
        case 3:
          o = (r.width * o) / 100;
          break;
      ...
      switch (l) {
        case 1:
          ...
          break;
        case 2:
          (s = r.width - s), (d = r.height - d);
          break;
        case 3:
          s = r.width - s;
          break;
        case 4:
          (s = (r.width * s) / 100), (d = (r.height * d) / 100);
      }
      e.setPosition(s, d);
    })(e, t, r),
...
function N(e, t) {
  var r = "";
  if (!e || e.length < 2 || (!e[0] && !e[1])) r = t;
  else if (e[0]) {
    var a = n.join(g, e[0]);
    r = n.join(a, e[1]);
  } else (r = n.join(g, e[1])), (r = n.join(r, n.basenameNoExt(r)));
  if (!r) return null;
...
function x(e, t, r, a, n) {
  ...
  (i.srcBlendFactor = 1 === o[0] ? 770 : o[0]), (i.dstBlendFactor = o[1]);
  var c = _(t, r, null);
  (i.sizeMode = a), (i.trim = !1);
  let l = N(c, "");
...
function B(r, a, n) {
  ...
  e.waterfall(
    [
      function (e) {
        l ? O(i, l, e) : c && ".ttf" === t.extname(c) ? O(i, c, e) : e();
      },
      function (e) {
...
function O(e, t, r) {
  ...
  if (a) {
    ...
    Editor.assetdb.remote.existsByUuid(o) && (i = !0);
  }
  i
    ...
    e.waterfall(
      [
        ...
        function (e) {
          ...
          var r = t.dirname(o),
            a = t.relative(b, r),
            i = t.basename(o, t.extname(o)),
            s = n.join(g, a, i + ".prefab"),
            d = Editor.assetdb.remote.urlToUuid(s);
          cc.assetManager.loadAny(d, function (t, r) {
            t ? e() : ((c = cc.instantiate(r)), e());
          });
        },
      ],
      function () {
...
function L(e, t, r) {
  ...
  return (
    ...
    e === cc.Scrollbar.Direction.HORIZONTAL
