const e = Editor.require("app://editor/share/adapters-build-utils"),
  ...
  i = require("fire-fs"),
  r = require("globby"),
  n = (require("del"), "project://baidugame-opendata.json"),
...
const o = {
  "game.js": function (e, i) {
    ...
    let r = e.contents.toString(),
      n = i.debug ? "require('cocos2d-js.js')" : "require('cocos2d-js-min.js')";
...
module.exports = {
  ...
  messages: {
    "script-build-finished": async function (t, i) {
      ...
      try {
        (function () {
          if (!Editor.Profile.load(n)) throw new Error("config file not found");
        })(),
    ...
    "build-finished": function (e, a) {
      ...
      try {
        (function (e) {
          let n = r.sync(t.join(e.dest, "assets/**"), { nodir: !0 });
          for (let e = 0; e < n.length; ++e) {
            let r = n[e];
            if (".json" !== t.extname(r)) continue;
