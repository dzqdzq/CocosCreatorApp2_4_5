const t = 5,
  i = 2,
  { Point: e } = require("./utils");
module.exports = class {
  set cxt2D(t) {
    (this.canvas = t.canvas), (this._cxt2D = t);
  }
  get cxt2D() {
    return this._cxt2D;
  }
  set multiplier(t) {
    0 !== t && ((this._multiplier = t), this.rePaint());
  }
  get multiplier() {
    return this._multiplier;
  }
  set negative(t) {
    t !== this._negative && ((this._negative = t), this.rePaint());
  }
  get negative() {
  ...
  get step() {
    const t = this.location.w / this.axis.piece,
      e = this.location.h / this.axis.piece,
      { rangeX: s, rangeY: a } = this.axis,
      h = Number((s / this.axis.piece).toFixed(i));
    ...
    return (
      this.negative && ((n *= 2), (c *= 2)),
      { spaceX: t, spaceY: e, stepX: h, stepY: n, orgStepX: r, orgStepY: c }
    );
  }
  get location() {
    return {
  ...
  canvasToAxis(t) {
    const { x: i, y: s, h: a } = this.location,
      h = t.x - i;
    let n = a - t.y + s;
    return this.negative && (n = a / 2 - t.y + s), new e({ x: h, y: n });
  }
  axisToCanvas(t) {
    const { x: i, y: s, h: a } = this.location;
  ...
  drawAxis() {
    ...
    const { x: i, y: e, w: s, h: a } = this.location,
      { stepX: h, stepY: n, spaceX: r, spaceY: c } = this.step;
    ...
    let l = e + a,
      g = this.negative ? -1 * this.multiplier : 0;
    for (; l > i; )
  ...
  drawGrid(t, i, e, s) {
    s && (this.cxt2D.lineWidth = s), e && (this.cxt2D.strokeStyle = e);
