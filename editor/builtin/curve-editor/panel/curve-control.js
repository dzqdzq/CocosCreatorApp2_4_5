...
module.exports = class extends t {
  ...
  constructor(t) {
    super(),
      ...
      (this.isBindHandle = !1),
      (this.negative = !1),
      (this.flags = { flag: !1, tanDrag: !1, curveDrag: !1, keyDrag: !1 }),
      (this.grid = t.grid),
  ...
  rePaint() {
    this.clear(), this.grid.rePaint(), this.hermite.rePaint();
  }
  update(t, i) {
    (this.negative = i),
  ...
  initContrl() {
    ...
    (this.cxt2D.fillStyle = i), (this.cxt2D.strokeStyle = e);
  ...
  resetCtrl(t) {
    (this.isShowCtrl || this.isShowAuxi) &&
      ((this.isShowAuxi = !1),
      (this.isShowCtrl = !1),
  ...
  onMouseDown(t) {
    ...
    const { radius: i } = this.ctrlConfig,
      { offsetX: r, offsetY: n } = t,
      a = this.cxt2D.getImageData(r - e / 2, n - e / 2, e, e);
    ...
    a.data.toString() !== s &&
      ...
      2 === t.button
        ...
        : (this.lightCurve(),
          ...
          !this.flags.tanDrag &&
            !this.flags.keyDrag &&
            (this.flags.curveDrag = !0))),
      this.flags.flag || this.resetCtrl("hideCtrl");
  }
  onMouseMove(t) {
    ...
    (e || i || s) &&
      process.nextTick(() => {
        ...
        if (s) return this.moveKey(r, h), this.emitChange(), void 0;
        if (i && 0 !== n) {
          if (!this.hermite.moveY(-n)) return;
  ...
  onMouseUp(t) {
    (this.flags.tanDrag = !1),
      (this.flags.curveDrag = !1),
      (this.flags.keyDrag = !1),
      (this.isShowPoint = !1),
      (this.canvas.style.cursor = "default"),
      this.changeType &&
        (this.emitChange(), this.emitConfirm(), (this.changeType = ""));
  }
  moveKey(t, i) {
    ...
    this.hermite.moveKey(t, i, e), this.refreshRender();
  }
  delKeyFrame(t) {
  ...
  addKeyFrame(t) {
    ...
    if (null === i) return console.warn("添加点无效", t), void 0;
    this.emitChange(), this.emitConfirm();
    const e = this.ctrlKey[i];
    this.initContrl(), this.drawCtrl(e);
  }
  updateTan(t, i) {
    const { index: e, type: s } = this.ctrlPoints,
      { point: r, isBroken: h } = this.ctrlKey[e],
      n = -(i - r.canvas.y) / (t - r.canvas.x);
    h
  ...
  showCtrl(t) {
    (this.ctrlPoints && this.ctrlPoints.index === t.index) ||
  ...
  drawCtrl(t, i = this.cxt2D) {
    (this.isShowCtrl = !0), (this.ctrlPoints = t);
    const { point: e, inPoint: s, outPoint: r } = t,
      { radius: h, fillColor: n } = this.ctrlConfig;
    i.save(),
      (i.fillColor = n),
      (i.strokeStyle = "white"),
      s &&
