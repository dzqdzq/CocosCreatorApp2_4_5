module.exports = {
  platform_name: "Baidu Mini Game",
  remote_server_address: "Resource Server Address",
  remote_server_address_tips:
    "The address of the server used to download the remote resources. Because the Baidu game limits the native package size to 4MB, if it is greater than that, please upload 'remote' folder to the server for download.",
