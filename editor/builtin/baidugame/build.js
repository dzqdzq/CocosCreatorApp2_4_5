const e = Editor.require("app://editor/share/adapters-build-utils"),
  t = require("fire-path"),
  i = Editor.require("app://editor/share/build-utils"),
  n = "project://baidugame.json",
  o = Editor.require("app://editor/share/3d-physics-build-utils");
const r = {
  "game.js": function (e, t) {
    let i = e.contents.toString(),
      n = t.debug ? "require('cocos2d-js.js')" : "require('cocos2d-js-min.js')";
...
module.exports = {
  ...
  buildStart: function (e) {
    let t = e.excludedModules,
      i = t.indexOf("SubContext");
    -1 !== i && t.splice(i, 1);
    let o = Editor.Profile.load(n);
    e.startSceneAssetBundle = o.get("startSceneAssetBundle") || !1;
  },
  ...
  delPattern: function (e) {
    ...
    return i && r.push(`!${t.join(o, i)}`, `!${t.join(o, i, "**/*")}`), r;
  },
  md5: {
    ...
    "script-build-finished": async function (t, i) {
      ...
      try {
        (function () {
          ...
          (i.settings.server =
            Editor.Profile.load(n).get("REMOTE_SERVER_ROOT")),
