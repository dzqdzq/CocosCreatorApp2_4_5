...
async function e(e, i) {
  ...
  await r.execInstallNativePlatformScript(e, (e) => e && i()), i();
}
async function i(e = !1) {
  let i = Editor.require("packages://cocos-services/panel/utils/ccServices.js");
  await i.init(e), !e && Editor.info("Cocos Service load base data!");
}
function r() {
  i(!0), Editor.info("Cocos Service reload base data!");
}
function s() {
  i(!0);
}
...
module.exports = {
  ...
  async downloadImPlugin() {
    try {
      let r = require("./panel/utils/utils"),
        s = require("./panel/utils/ccServices"),
        a = require("fs");
      if (
        a.existsSync(`${r.getCreatorHomePath()}/packages/im-plugin`) ||
        a.existsSync(`${r.getProjectPath()}/packages/im-plugin`)
      )
        return;
      await s.init();
      var e = await s.getIMSettings(),
        i = r.getCreatorHomePath() + "/download/im-plugin.zip";
          ...
          e ||
            ...
            r.unzip(i, o, (e) => {
              a.existsSync(i) && a.unlinkSync(i),
                e || this.loadImPlugin("im-plugin", o);
            });
        }
      );
    } catch (e) {
  ...
  messages: {
    ...
    "plugin-messages"(e, i, r) {
      this.panelStatus["cocos-services"] &&
      ...
      for (var a of s.readServiceList())
        if ("service-tcb" === a.service_component_name) {
          var o = s.readBindGame().appid,
            t = await r.getTCBTempKey(a.service_id, o);
          return e.reply && e.reply(null, t), void 0;
        }
    },
    "change-float-window-size"(e, i, r) {
      require("electron")
        .BrowserWindow.fromWebContents(e.sender)
        .setContentSize(i, r, !0);
    },
    async "open-service"(e, i, r) {
      i.match(/^service-[a-z]+/) || (i = `service-${i}`);
      let s = Editor.require(
        ...
        t = Editor.require("packages://cocos-services/panel/utils/utils.js"),
        c = o.readServiceList().find((e) => e.service_component_name === i);
      if (void 0 === c)
        return e.reply && e.reply(null, a(-1, t.t("service_name_error")));
      let n = o.readBindGame();
      if ("UNKNOW" === n.appid) {
        let i = await s.createGame(t.getProjectName());
        if (0 !== i.status) return e.reply && e.reply(null, a(i.status, i.msg));
      ...
      "0" !== c.service_type && l.data.service.indexOf(c.service_id) < 0
        ? r &&
          s.openService(n.appid, c.service_id, (e, i) => {
            ...
            o.wirteEnableService(c.service_id, !0),
              t.printToCreatorConsole(
                "log",
        ...
        e.reply && e.reply(null, a(0, "success"));
    },
  },
};
