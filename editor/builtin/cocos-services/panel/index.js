(window.CocosServices = {}), (window.ccServices = {});
let e = Editor.require("packages://cocos-services/panel/utils/ccServices.js"),
  i = Editor.require("packages://cocos-services/panel/utils/utils.js"),
  s = Editor.require("packages://cocos-services/panel/utils/serviceConfig.js");
...
let t = Editor.require("packages://cocos-services/panel/bindGame/bindGame.js"),
  ...
  c = Editor.require("packages://cocos-services/panel/toast/toast.js"),
  n = require("fs");
(window.fs = n), (window.ccServices = e);
    ...
    (this._vm = (function (t) {
      return new window.Vue({
        ...
        data: {
          ...
          isCompanyUser: !1,
          isCompanyGame: !1,
          isItemClickToBindGame: !1,
          isUpdate: !1,
          isDownloadServicePackage: !1,
          ...
          async game(i, t) {
            ...
            for (var a of this.services)
              Vue.set(a, "enable", -1 !== r.indexOf(a.service_id)),
                "UNKNOW" === i.appid
                  ? a.service_type
                  : ("0" === i.cid, a.service_type),
                Vue.set(a, "hovered", !0);
            e.getUserIsLogin() && (await e.getGameDetail(this.game.appid));
          },
        },
        created() {
          (t.$loader_wrapper.hidden = !0), (t.$loader_service.hidden = !1);
          var r = s.readBindGame();
          r && "UNKNOW" != r.appid && this.checkGameOwner(r)
            ? ((this.game = r),
              (this.isBindGame = !0),
              (this.isCompanyGame = "0" !== r.cid))
            : ((this.game = { name: i.t("unknow_game"), appid: "UNKNOW" }),
              (this.isBindGame = !1),
              (this.isCompanyGame = !1),
          ...
          !n.existsSync(a) && i.mkdirs(a),
            ...
            e.on("service:refresh-panel", (e, i) => {
              (this.game = s.readBindGame()),
                "UNKNOW" != this.game.appid && (this.isBindGame = !0),
                (this.refresh = !1),
                this.$nextTick(() => (this.refresh = !0)),
                i && i(null, "");
            }),
            e.removeAll("service:goto-service"),
            e.on("service:goto-service", (e, i) => {
              if (!e.service_name) return;
              let s = e.service_name;
              s.match(/^service-[a-z]+/) || (s = `service-${s}`);
        ...
        methods: {
          showTips: function (e, i, s = 1500) {
            (this.visible = !0),
              (this.status = e),
              (this.message = i),
              -1 !== s && setTimeout(() => (this.visible = !1), s);
          },
          ...
          serviceItemClick: function (e) {
            ...
            (this.isShowHome = !1),
              ...
              "0" === e.service_type || this.isBindGame
                ? ((this.isShowService = !0),
                  (this.isShowBindGame = !1),
                  window.ccServicesAnalytics &&
                    window.ccServicesAnalytics.enterService())
                : ((this.isShowService = !1),
                  (this.isShowBindGame = !0),
                  (this.isItemClickToBindGame = !0),
                  window.ccServicesAnalytics &&
          ...
          checkGameOwner: function (s) {
            ...
            if (!t) return !1;
            for (var r of t.data) if (r.app_id === s.appid) return !0;
            return (
              i.printToCreatorConsole("warn", this.utils_t("not_owner")), !1
            );
          },
          bindGameLogic: async function (t) {
            ...
            s.writeBindGame(this.game),
              "UNKNOW" != t.appid && (this.isBindGame = !0),
              window.ccServicesAnalytics &&
                window.ccServicesAnalytics.init(
                  this.user.cocos_uid,
                  this.game,
              ...
              this.isItemClickToBindGame
                ? ((this.isShowHome = !1),
                  (this.isShowService = !0),
                  "0" === this.game.cid && "2" === this.service.service_type
                    ? (i.printToCreatorConsole(
                        "warn",
                        this.utils_t("select_company_service")
                      ),
                  ...
                  this.isShowService &&
                    window.ccServicesAnalytics &&
                    window.ccServicesAnalytics.enterService())
                : ((this.isShowHome = !0), (this.isShowService = !1)),
              (this.isShowBindGame = !1),
          ...
          bindGame: function () {
            (this.isShowHome = !1),
              (this.isShowBindGame = !0),
              (this.isItemClickToBindGame = !1),
              window.ccServicesAnalytics &&
                window.ccServicesAnalytics.enterBindCocosAppID();
          },
          enableService: function (e, i) {
            for (var t of this.services)
              t.service_id === e &&
                ((t.enable = i), s.wirteEnableService(e, t.enable));
          },
                ...
                if (a.indexOf("/") <= -1)
                  for (var c of t)
                    if (c.service_component_name.indexOf(a) >= 0)
                      return s && s(!0, c.service_id, c.service_name), void 0;
              });
            });
          },
        },
      ...
      this.argv && e.emit("service:goto-service", this.argv, (e, i) => {});
  },
  run(i) {
    (this.argv = i),
      this.argv && e.emit("service:goto-service", this.argv, (e, i) => {});
  ...
  messages: {
    "before-change-files"(i, s) {
      e.execInstallNativePlatformScript(s, (e) => {
        1, i.reply && i.reply(null, "Cocos Service install successfully");
      });
    },
