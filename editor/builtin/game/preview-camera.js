class e extends cc.Component {
  ...
  set canvas(e) {
    (this._canvas = e), this._updateCanvas();
  }
  get cameras() {
  ...
  getBase64Data() {
    return this._dataDirty
      ? ((this._dataDirty = !1), this._canvas.toDataURL())
      : "";
  }
  getBinaryData() {
    return this._dataDirty ? ((this._dataDirty = !1), this._data) : null;
  }
  _updateCanvas() {
  ...
  update(e) {
    if (this._runningScene !== cc.director.getScene())
      return (this._runningScene = cc.director.getScene()), void 0;
    if (0 === this._cameras.length) return;
    ...
    this._imageData.data.set(n), this._ctx.putImageData(this._imageData, 0, 0);
    for (let e = 0; e < r.length; e++) {
      let t = r[e];
      (t.targetTexture = a[e]),
        (t.node.z = s[e]),
...
(e._executeInEditMode = !0), (module.exports = e);
