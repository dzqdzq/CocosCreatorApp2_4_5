...
const e = require("fire-fs"),
  t = require("fire-path"),
  s = require("electron").dialog;
function r(e, t) {
  t || (t = Editor.assetdb.uuidToUrl(Editor.currentSceneUuid)),
    t || (t = "Untitled");
  let s = e ? "*" : "";
...
module.exports = {
  ...
  messages: {
    ...
    "save-scene"(r, a, d) {
      ...
      if (
        ...
        !(o = (function e() {
          let r = Editor.assetdb._fspath("db://assets/"),
            i = s.showSaveDialogSync(Editor.Window.main.nativeWin, {
              title: "Save Scene",
              defaultPath: r,
      ...
      e.existsSync(n)
        ? Editor.assetdb.saveExists(o, a, (e, t) => {
            ...
            i(t.meta.uuid), Editor.Ipc.sendToAll("scene:saved"), r.reply();
          })
        : Editor.assetdb.create(o, a, (e, t) => {
            ...
            i(t[0].uuid), Editor.Ipc.sendToAll("scene:saved"), r.reply();
          });
    },
    "create-prefab"(e, t, s) {
    ...
    "query-asset-info-by-uuid"(e, t) {
      ...
      r &&
        !r.useRawfile() &&
        ((s = Editor.assetdb._uuidToImportPathNoExt(t)), (s += ".json"));
      let i = s.replace(/\\/g, "/");
