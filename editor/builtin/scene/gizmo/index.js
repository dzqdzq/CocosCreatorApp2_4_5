...
module.exports = class extends window.HTMLElement {
  ...
  set transformTool(e) {
    (s.toolName = e),
      this.svg.transform && this.edit(this.svg.transform.target);
  }
  get coordinate() {
    return s.coordinate;
  }
  ...
  getGizmoToolByName(e) {
    ...
    if (null == t) {
      ...
      null != s
        ...
        : (Editor.error("Unknown transform tool %s", e), this.repaintHost());
    }
    return t;
  }
  clearAllGizmos() {
  ...
  createGizmo(e, t, s) {
    ...
    let o = null;
    if (null == i)
      (i = []), (o = new t(this, s)), i.push(o), (this._gizmosPool[e] = i);
    else {
  ...
  showNodeGizmo(e) {
    ...
    e._components.forEach((i) => {
      if (
        (i.gizmo && (i.gizmo.remove(), i.gizmo.hide(), (i.gizmo = null)),
        e.active && i.enabled)
      ) {
        (t = null), (s = null);
        ...
        t || (t = _Scene.gizmos.components[o]),
          null != t &&
  ...
  onComponentEnable(e) {
    ...
    -1 !== this.svg.selection.indexOf(t.node.uuid) &&
      this.showNodeGizmo(t.node);
  }
  onComponentDisable(e) {
    let t = cc.engine.getInstanceById(e);
    t && t.gizmo && (t.gizmo.remove(), t.gizmo.hide(), (t.gizmo = null)),
      this.repaintHost();
  }
  connectedCallback() {
    (this.svg.selection = []),
  ...
  resize(t, s) {
    if (
      (t <= 0 &&
        (console.warn("The SVG width should not be less than 0."), (t = 0)),
      s <= 0 &&
        (console.warn("The SVG height should not be less than 0."), (s = 0)),
      !t || !s)
    ) {
      let e = this.getBoundingClientRect();
      (t = Math.round(t || e.width)), (s = Math.round(s || e.height));
    }
    e && console.log(`resize: ${t} ${s}`),
  ...
  updateSelectRect(e, t, s, i) {
    this.svg.select || (this.svg.select = this.foreground.rect().front()),
      this.svg.select
  ...
  reset() {
    (this.svg.selection = []),
      this.svg.transform &&
        (this.svg.transform.remove(), (this.svg.transform = null)),
      this.svg.select && (this.svg.select.remove(), (this.svg.select = null)),
  ...
  select(e) {
    ...
    this.svg.selection.forEach((e) => {
      ...
      s &&
        (this.updateGizmosState(s, { selecting: !0, editing: !1 }), t.push(s));
    }),
      this.edit(t);
  }
  unselect(e) {
    e.forEach((e) => {
      ...
      -1 !== t && this.svg.selection.splice(t, 1);
      let s = cc.engine.getInstanceById(e);
      this.updateGizmosState(s, { selecting: !1, editing: !1 }),
  ...
  edit(e) {
    if (0 === e.length)
      return (
        this.svg.transform && (this.svg.transform.target = []),
        this.repaintHost(),
        void 0
      );
    1 === e.length &&
    ...
    null != t &&
      (t !== this.svg.transform &&
        (null != this.svg.transform && this.svg.transform.hide(),
  ...
  hoverin(e) {
    let t = cc.engine.getInstanceById(e);
    this.updateGizmosState(t, { hovering: !0 });
  }
  hoverout(e) {
    let t = cc.engine.getInstanceById(e);
    this.updateGizmosState(t, { hovering: !1 });
  }
  checkNodeGizmoState(e) {
    -1 !== this.svg.selection.indexOf(e.uuid) &&
      e.gizmo &&
      (e.gizmo.editing = !0);
  }
};
