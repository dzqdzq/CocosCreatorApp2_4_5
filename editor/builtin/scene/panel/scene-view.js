const e = require("fs"),
  ...
  t = Editor.require("packages://scene/panel/tools"),
  n = Editor.require("app://editor/page/gizmos/utils/transform-tool-data"),
  o = Editor.require("scene://utils/scene"),
  s = Editor.require("scene://dump/hierarchy"),
  c = require("mousetrap"),
  d = Editor.require("packages://scene/panel/tools/camera");
...
let l = {
  ...
  ready() {
    (this._vm = (function (e) {
      return new window.Vue({
        el: e,
        data: { mode: "scene", isInEditMode: !1, editModeIcon: "" },
    ...
    (this.designSize = [0, 0]),
      (this._initTimer = setInterval(() => {
        ...
        (0 === e.width && 0 === e.height) ||
          ...
          cc.engine.isInitialized
            ? (this.dispatchEvent(new Event("engine-ready", { bubbles: !0 })),
              this.dispatchEvent(
                new Event("scene-view-ready", { bubbles: !0 })
              ),
              this._resize())
            : this._initEngine(() => {
                (this.$gizmosView.sceneToPixel = this.sceneToPixel.bind(this)),
                  (this.$gizmosView.worldToPixel =
                    this.worldToPixel.bind(this)),
                  (this.$gizmosView.pixelToScene =
                    this.pixelToScene.bind(this)),
                  (this.$gizmosView.pixelToWorld =
                    this.pixelToWorld.bind(this)),
                  this._resize();
              }));
      }, 100));
  ...
  onSceneLaunched() {
    ...
    e.setScale(1), e.setPosition(0, 0, 0);
    for (let e = 0; e < t.length; e++)
      t[e].onSceneLaunched && t[e].onSceneLaunched();
  },
  _resize() {
    if (cc.engine.isInitialized && cc.director.getScene()) {
      ...
      for (let e = 0; e < t.length; e++) t[e].onResize && t[e].onResize();
    }
  },
  _hackSceneClass() {
    [
      ...
      cc.Class.Attr.setClassAttr(cc.Scene, e, "serializable", !1);
    });
  },
  _initEngine(e) {
    ...
    (_Scene._inited = !1),
      cc.engine.init(s, () => {
        ...
        for (let e = 0; e < t.length; e++) t[e].init && t[e].init();
        _Scene.initScene((i) => {
          if (((_Scene._inited = !0), i)) {
            let e = new Event("scene-view-init-error");
            return (e.error = i), this.dispatchEvent(e), void 0;
          }
          this.dispatchEvent(new Event("scene-view-ready", { bubbles: !0 })),
            cc.engine.emit("scene-view-ready", { bubbles: !0 }),
            e && e();
        });
      });
  },
  ...
  _registerShortcuts() {
    ...
    e.bind(["ctrl+a", "command+a"], this.selectAll.bind(this)),
      ...
      document.addEventListener("keydown", (e) => {
        ...
        "KeyF" === e.code && i && "scene" === i.id && this.focusNode();
      });
  },
  focusNode() {
  ...
  selectAll(e) {
    ...
    s.node().forEach((e) => {
      ...
      Editor.Selection.select("node", i, !0, !1);
  },
...
[
  ...
  l[e] = function (i) {
    if ((i.stopPropagation(), cc.engine.isInitialized))
