...
const e = Editor.require("scene://utils/scene"),
  n = Editor.require("scene://utils/animation");
function t(e, n, t) {
  try {
...
module.exports = {
  ...
  "add-component"(t, r, c) {
    ...
    r || (r = Editor.Selection.curActivate("node")),
      Editor.Ipc.sendToMain("metrics:track-event", {
        category: "Scene",
  ...
  "reset-node"(e, n) {
    o(n, (e) => {
      ...
      return (
        !!n &&
        (_Scene.Undo.recordNode(n.uuid, "Reset Node"),
        _Scene.resetNode(n),
        _Scene.Undo.commit(),
        !0)
      );
  ...
  "reset-all"(e, n) {
    o(n, (e) => {
      let n = cc.engine.getInstanceById(e);
      if (!n) return !1;
      _Scene.Undo.recordNode(n.uuid, "Reset All"), _Scene.resetNode(n);
      for (var t = 0; t < n._components.length; ++t)
        _Scene.resetComponent(n._components[t]);
      return _Scene.Undo.commit(), !0;
    });
  },
  "move-up-component"(e, o, r) {
    ...
    t(o, r, (e, n) => {
      ...
      if (r <= 0) return !1;
      let c = r - 1;
      return t._components.splice(r, 1), t._components.splice(c, 0, o), !0;
    });
  },
  "move-down-component"(e, o, r) {
    ...
    t(o, r, (e, n) => {
      ...
      if (!t || !o) return !1;
      let r = t._components.indexOf(o);
      if (r >= t._components.length) return !1;
      let c = r + 1;
      return t._components.splice(r, 1), t._components.splice(c, 0, o), !0;
    });
  },
  "reset-component"(e, n, o) {
    t(n, o, (e, n) => {
      ...
      return (
        !!t &&
        (_Scene.Undo.recordNode(e, "Reset Component"),
  ...
  "regenerate-polygon-points"(e, n) {
    ...
    t && t.resetPointsByContour && t.resetPointsByContour();
  },
  "search-skeleton-animation-clips"(e, n) {
    var t = cc.engine.getInstanceById(n);
    t && t.searchClips && t.searchClips();
  },
  "change-node-lock"(e, n, t) {
    let o = cc.engine.getInstanceById(n);
    o instanceof cc.Node &&
      (void 0 === t && (t = !(o._objFlags & cc.Object.Flags.LockedInEditor)),
  ...
  generate_attached_node(e, n) {
    var t = cc.engine.getInstanceById(n);
    t && t.attachUtil && t.attachUtil.generateAllAttachedNodes();
  },
};
