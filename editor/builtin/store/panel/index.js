...
const e = require("electron"),
  t = require("fire-fs"),
  r = require("vue/dist/vue"),
  o = Editor.require("app://share/@base/electron-base-ipc"),
  s = Editor.require("packages://store/main/utils/network.js");
...
e.ipcRenderer.on("store:update", () => n && n.updateStoreList()),
  ...
  (exports.ready = async function () {
    ...
    const e =
        this.$.webview instanceof HTMLElement
          ? this.$.webview
          : document.querySelector("webview"),
      t =
        this.$.uiLoader instanceof HTMLElement
          ? this.$.uiLoader
          : document.querySelector("ui-loader"),
      d = await o.send("creator-libs-user:call", "getUserData").promise();
    var l = `${
      (
        await (async () =>
          await s.post(
    ...
    requestAnimationFrame(() => e.setAttribute("src", a(d.session_id, l))),
      ...
      e.addEventListener("did-navigate-in-page", (e) => {
        if (
          ...
          /(app\/|app)/.test(e.url) && t.remove(),
          /order\_pay/.test(e.url))
        )
          return (
