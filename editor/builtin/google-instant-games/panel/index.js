...
const t = require("fs"),
  a = Editor.require("packages://google-instant-games/panel/component/home"),
  s = Editor.require("packages://google-instant-games/panel/lib/record"),
  o = Editor.require("packages://google-instant-games/panel/lib/advice");
Editor.Panel.extend({
  listeners: {
    "panel-resize"() {
  ...
  messages: {
    "google-instant-games:update-list"(e, t) {
      o.emit("manual-add-resource", t), e.reply();
    },
  ...
  run(e) {
    (this.recordPath = null),
      e && e.recordPath && (this.recordPath = e.recordPath);
  },
  ready() {
  ...
  save(e) {
    e && (e.stopPropagation(), e.preventDefault()), o.emit("record-save");
  },
});
