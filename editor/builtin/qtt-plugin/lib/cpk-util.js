let e = require("./jszip.min.js"),
  t = require("path"),
  i = require("fs-extra"),
  n = require("./adapter-util.js"),
  o = require("./tinypack-util.js"),
  r = {};
  ...
  (module.exports = {
    ...
    checkData(e, n, o) {
      var r = e.customConfig.package,
        a = e.customConfig.name,
        s = e.customConfig.versionName,
        c = e.customConfig.versionCode,
        m = e.customConfig.icon,
        u = !0,
        d = [],
        p = "";
      [
        ...
        e.value || ((u = !1), d.push(e.name));
      }),
        u || (p += d.join("、") + Editor.T("qtt-runtime.not_empty")),
        m &&
          (i.existsSync(m) ||
            ((u = !1), (p += m + Editor.T("qtt-runtime.icon_not_exist"))));
      r.match(/^[a-zA-Z]+[0-9a-zA-Z]*(\.[a-zA-Z]+[0-9a-zA-Z]*)*$/) ||
        ((u = !1), (p += Editor.T("qtt-runtime.package_name_error")));
      a.match(/^[0-9a-zA-Z]*(\.[a-zA-Z]+[0-9a-zA-Z]*)*$/) ||
        ((u = !1), (p += Editor.T("qtt-runtime.game_name_error")));
      s.match(/^[0-9]*(\.[0-9]*)*$/) ||
      ...
      return (
        ...
        u
          ? (i.existsSync(t.join(o.dest, "remote")) &&
            ...
            !0)
          : (n.reply(new Error(p)), !1)
      );
    },
    async organizeResources(e) {
      let o = r.buildPath;
      return (
        !1 !== (await n.organizeResources(e)) &&
        (i.writeJSONSync(t.join(o, "game.config.json"), r.gameConfig),
        i.writeJSONSync(t.join(o, "manifest.json"), r.mainfest),
        !0)
      );
    },
    async pack(e) {
