module.exports = {
  ...
  package_name_error:
    "Please enter the correct package name: start with a letter and cannot contain characters _",
  game_name_error: "Please enter the correct game name: letter or number",
  game_version_name_error:
    "Please enter the correct version number of the game: numbers, with dots. example: 1.0.0",
  game_version_number_error: "Please enter the game version number",
  ...
  build_same_game_version_error:
    "warn:the game version name and game version number have been constructed",
