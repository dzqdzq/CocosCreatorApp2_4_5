...
module.exports = {
  ...
  messages: {
    "script-build-finished": function (e, r) {
      ...
      (r.settings.server = i.get("tinyPackageServer") || ""), e.reply();
    },
    "build-finished": async function (r, i) {
      try {
        var n = await e.gatherInfo(i, r);
        if (!1 === n) return;
        if (!1 === (n = await e.organizeResources(r))) return;
        await e.pack(r),
          (function (e) {
  ...
  beforeFinish: function (t) {
    let e = require("fs-extra"),
      r = require("path"),
      i = Editor.url("packages://runtime-adapters/platforms/qtt/res/main.js");
    var n = r.join(t.dest, "main.js");
    e.copySync(i, n);
  },
  buildStart: function (e) {
    let r = Editor.Profile.load(t);
    e.startSceneAssetBundle = r.get("packFirstScreenRes") || !1;
  },
