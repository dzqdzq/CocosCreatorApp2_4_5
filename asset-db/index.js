...
(() => {
  ...
  function u(s) {
    (s = s || {}),
      ...
      void 0 === this.silent && (this.silent = !1),
      (this.dev = s.dev),
      void 0 === this.dev && (this.dev = !1),
    ...
    (this.cache = s.cachePath),
      ...
      (this._tasks = r.queue((s, i) => {
        ...
        for (let t = 0; t < s.params.length; ++t)
          (e += n(s.params[t], 20)), t !== s.params.length - 1 && (e += ", ");
        let a = function (s) {
          this._curTask.silent || s || this.success("done!"),
            (this._curTask = null);
          try {
        ...
        try {
          t &&
            ...
            s.silent || this.log("[db-task][%s] running...", e),
            (this._curTask = s),
  ...
  i.inherits(u, s),
    ...
    t && t.isMainProcess && h.assign(u.prototype, require("./core/watch")),
    (module.exports = u);
})();
