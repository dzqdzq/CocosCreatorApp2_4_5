...
async function h(e, r, o) {
  ...
  try {
    (s = s.replace(/\\/g, "/")), await n([s, s + ".*"], { force: !0 });
  } catch (e) {
    return o(e);
  }
  i.series(
...
function f(t, i) {
  ...
  return (
    !e.existsSync(a) &&
    (t.info(`remove unused meta: ${t._url(i)}`), e.unlinkSync(i), !0)
  );
}
function m(i, a, r) {
...
function c(t, a) {
  ...
  i.each(
    ...
    (i, a) => {
      ...
      e.existsSync(r) ||
        (delete t._uuid2mtime[i], t.log(`remove unused mtime info: ${i}`)),
        a();
    },
    (e) => {
      a && a(e);
...
function y(i, r, n, o) {
  "function" == typeof n && ((o = n), (n = null)),
    "boolean" != typeof (n = n || {})["remove-unused-meta"] &&
  ...
  globby(s, (e, a) => {
    ...
    (a = a.map((e) => t.normalize(e))).includes(r) || a.unshift(r),
      a.forEach((e) => {
        if (i._isMountPath(e)) return;
        if (".meta" !== t.extname(e) || !n["filter-meta"])
          return u.push(e), void 0;
        if (n["remove-unused-meta"]) f(i, e);
        else {
          let t = m(i, e);
          t && l.push(t);
        }
...
function v(t, i, a) {
  ...
  for (let t = 0; t < u.length; ++t)
    if (!e.existsSync(u[t])) return a && a(null, !0), void 0;
...
function g(i, r, n, o, u) {
  ...
  globby(d, (a, r) => {
    ...
    r.forEach((a) => {
      let r;
      if (((a = t.normalize(a)), ".meta" === t.extname(a)))
        return o && f(i, a), void 0;
      let u,
        d = a + ".meta";
      if (((d = a + ".meta"), e.existsSync(d))) {
        ...
        if ((i._dbAdd(a, r.uuid), r)) {
          ...
          if (e)
            for (let n in e) {
              ...
              i._dbAdd(u, o.uuid), h.push({ assetpath: u, meta: o });
            }
          return;
        }
      }
...
function $(e, a, r) {
  let n = !1,
    o = a + ".meta",
    s = l.load(e, o);
  if (!s && ((s = l.create(e, o)), (n = !0), !s))
    return r && r(new Error(`Can not create or load meta from ${a}`)), void 0;
  if (e.isSubAssetByPath(a)) return r && r(null, s), void 0;
...
function b(e, a, r) {
  ...
  let n = !1,
    o = a.path,
    s = o + ".meta",
    u = a.meta || l.get(e, e.fspathToUuid(o)),
    d = a.isSubAsset || e.isSubAssetByPath(o);
  if (!u || d) return r && r(null, u), void 0;
  i.series(
    [
      (t) => {
        if (u.postImport)
...
function S(e, t, a, r) {
  ...
  for (var o = 0, s = t.length; o < s; o++)
    e.isSubAssetByPath(t[o]) || n.push(t[o]);
  i.waterfall(
    [
      (t) => {
        let a = [];
        i.eachSeries(
          ...
          (t, i) => {
            e.log(`scan ${t}...`),
              y(e, t, { "remove-unused-meta": !1 }, (e, t) => {
...
function w(e, i, a) {
  ...
  for (let e = 0; e < l.length; ++e) {
    let i = l[e],
      s = a[i];
    r[i] || o.push({ uuid: s.uuid, path: t.join(n, i), type: s.assetType() });
  }
  l = Object.keys(r);
...
(module.exports = d),
  (d.mount = function (i, a, r, n, s) {
    if ("string" != typeof a)
      return s && s(new Error("expect 1st param to be a string")), void 0;
    if (!e.isDirSync(a))
      return (
        s &&
          s(
    ...
    if ("string" != typeof r)
      return s && s(new Error("Expect 2nd param to be a string")), void 0;
    (function (e, i, a) {
      /[\\/.]/.test(a) &&
        e.throw(
          "normal",
    ...
    let u = { path: a, mountPath: r, attached: !1 };
    o.assign(u, n),
      (i._mounts[r] = u),
              ...
              (i) => {
                ...
                e.log(`refresh at db://${t}`),
                  S(e, a, !1, (a, n) => {
                    if (a)
                      return (
                        e.failed(`Failed to refresh db://${t}`), i(), void 0
                      );
  ...
  (d.unattachMountPath = function (e, a, r) {
    ...
    if (!o.attached)
      return e.log(`db://${a} has not been attached!`), r(null, n), void 0;
    var s = e._allPaths(),
      u = t.resolve(o.path);
    i.waterfall(
      [
  ...
  (d.refresh = function (a, r, n) {
    ...
    Array.isArray(r) || (r = [r]),
      (r = (r = r.map((e, i) => {
        if (a._isAssetPath(e)) return e;
        a.isSubAssetByPath(e) && (e = t.dirname(e));
        let r = e,
          n = t.dirname(e);
        for (; n && !a._path2uuid[n]; )
          (r = n) === (n = t.dirname(n)) &&
            ((r = n = void 0), a.failed(`Failed to refresh path: ${e}`));
        return r;
      })).filter(Boolean)),
      i.waterfall(
        [
          ...
          (e) => {
            ...
            i.eachSeries(
              r,
              (e, i) => {
                if (t.includes(e)) return i(), void 0;
                g(a, e, s, !1, (e, r) => {
                  r.forEach((e) => {
                    t.push(e.assetpath);
                    let i = a._path2uuid[e.assetpath],
                      r = a._uuid2path[e.meta.uuid];
                    !i || i !== e.meta.uuid || !r || r !== e.assetpath;
                  }),
                    i();
                });
              },
        ...
        (e, t) => {
          ...
          t.forEach((e) => {
            ...
            if (t)
              t !== i
                ? ((e.command = "uuid-change"), (e.oldUuid = t))
                : (e.command = "change");
            else {
              e.command = "create";
  ...
  (d.deepQuery = function (e, i) {
    ...
    for (let i = 0; i < r.length; ++i) {
      let n,
        ...
        u = r[i],
        d = e._path2uuid[u],
        h = e._path2uuid[t.dirname(u)],
        f = e.isSubAssetByPath(u);
      o = t.extname(u);
      let m = e.mountInfoByPath(u);
      if (e.isMountByPath(u)) (n = t.basenameNoExt(m.mountPath)), (s = "mount");
      else {
        "folder" === (s = l.get(e, e.fspathToUuid(u)).assetType())
          ? ((n = t.basename(u)), (o = ""))
          : (n = t.basenameNoExt(u));
      }
      let p = {
  ...
  (d.queryAssets = function (e, t, i, a) {
    let n = [],
      ...
      s = o;
    t && (s = r.match(o, t)), "string" == typeof (i = i || []) && (i = [i]);
      ...
      [
        (i) => {
          (function (i, a, r, n) {
            ...
            n && n(null, { importFiles: s, mergeFiles: u });
          })(a, r, n, (e, t) => {
            (s = t), i(e);
          });
        },
          ...
          i.each(
            ...
            (i, r) => {
              ...
              e.copy(i, u, (e) => {
                if (e)
                  return (
                    a.failed(`Failed to copy file ${i}. ${e}`), r(), void 0
                  );
                l
                  ? o.mergeFiles.indexOf(u) < 0 && o.mergeFiles.push(u)
                  : o.importFiles.indexOf(u) < 0 && o.importFiles.push(u),
                  r();
              });
            },
            (e) => {
        ...
        (e, t) => {
          ...
          d.refresh(a, e.mergeFiles, (i, r) => {
            ...
            (u = u.concat(r)), t(null, e.importFiles);
          });
        },
        (e, t) => {
          let r = [];
          a.log("init metas..."),
            i.each(
              ...
              (e, t) => {
                g(a, e, null, !0, (e, i) => {
                  i.forEach((e) => {
                    a.isSubAssetByPath(e.assetpath) || r.push(e.assetpath);
                  }),
                    t();
                });
              },
    ...
    i.each(
      ...
      (t, i) => {
        (async function (t, i, a) {
          if (!e.existsSync(i))
            return a && a(new Error(`Asset ${i} is not exists`)), void 0;
          if (t.mountInfoByPath(i).readonly) {
            ...
            try {
              u.moveItemToTrash(i, !0), u.moveItemToTrash(i + ".meta", !0);
            } catch (e) {
              return a && a(e), void 0;
            }
            d.clearImports(t, i, null, (e, t) => {
              if (e) return a && a(e), void 0;
              a && a(null, t);
            });
          }
        })(a, t, (e, r) => {
  ...
  (d.create = function (a, r, n, o) {
    ...
    let l = t.dirname(r);
    if (!e.existsSync(l))
      return o && o(new Error(`Parent path ${l} is not exists`)), void 0;
  ...
  (d.saveExists = function (a, r, n, o) {
    if (!a.existsByPath(r))
      return o && o(new Error(r + " is not exists")), void 0;
    if (a.mountInfoByPath(r).readonly) {
      if (o) {
  ...
  (d.saveMeta = function (e, a, r, n) {
    ...
    try {
      ...
      return (
        n && n(new Error(`Failed to pase json string, message : ${e.message}`)),
        void 0
      );
    }
    if (a !== o.uuid)
      return n && n(new Error("Uuid is not equal to json uuid")), void 0;
    let u = s + ".meta",
      d = e.loadMetaByPath(s);
    if (!d) return n && n(new Error(`Can't load meta for : ${a}`)), void 0;
    let f = d.copySubMetas();
    if ((d.deserialize(o), e.isSubAssetByPath(s))) {
      let i = t.basename(s);
      u = (s = t.dirname(s)) + ".meta";
      let r = e.loadMetaByPath(s);
      (a = r.uuid), (f = r.copySubMetas()), (r.getSubMetas()[i] = d), (d = r);
    }
    l.save(e, u, d),
      i.waterfall(
        [
          ...
          (t, i) => {
            ...
            for (let t = 0; t < r.added.length; ++t) {
              let i = r.added[t];
              e.existsByUuid(i.uuid) ||
                (e._dbAdd(i.path, i.uuid), e.updateMtime(i.uuid));
            }
            for (let t = 0; t < r.deleted.length; ++t) {
              let i = r.deleted[t];
              e.existsByUuid(i.uuid) && e._dbDelete(i.path);
            }
            e.updateMtime(a), i(null, { meta: t, subMetas: r });
          },
        ],
        (e, t) => {
          if (e) return n && n(e), void 0;
  ...
  (d.clearImports = function (a, r, n, o) {
    if (!a.fspathToUuid(r))
      return o && o(new Error(`path-2-uuid does not contian: ${r}`)), void 0;
    a.log(`clear imports ${r}`);
    let s = [];
    for (let e in a._path2uuid)
      t.contains(r, e) && (a._isMountPath(e) || s.push(e));
    let u = [];
    i.eachSeries(
      s,
      (t, r) => {
        ...
        u.push(o),
          i.series(
            [
              ...
              (e) => {
                a._dbDelete(t), a.updateMtime(s), e();
              },
            ],
            r
          );
        ...
        (i) => {
          ...
          oldglobby(r, (e, a) => {
            Promise.all(
              a.map(
                (e) => (
                  (e = t.resolve(e)), n(e.replace(/\\/g, "/"), { force: !0 })
                )
              )
            ).then((e) => {
              i();
  ...
  (d.move = function (e, t, a, r) {
    if (e.mountInfoByPath(t).readonly) {
      ...
      return (
        r && r(new Error(`${i} is readonly, CAN NOT move it in Editor.`)),
        void 0
      );
    }
