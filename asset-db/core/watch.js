...
function n(s, n, c) {
  ...
  for (let t = 0; t < n.length; ++t) {
    ...
    if (".meta" !== e.extname(c))
      "delete" !== h.command
        ? "new" !== h.command && "change" !== h.command
      ...
      let t = h.path,
        ...
        c = a.existsSync(n);
      ("delete" === h.command && c) || "change" === h.command
        ? i(l, n)
        : "new" !== h.command ||
          c ||
          (a.unlinkSync(t), s.warn(`Delete unused meta file: ${s._url(t)}`));
    }
  }
  t.series(
    [
...
function r(t, e) {
  if (t._snapshot)
    return (
      e && e(new Error("Failed to watch asset-db, already watched.")), void 0
    );
  let a = t._mountPaths();
...
function o(t, e) {
  if (!t._snapshot)
    return (
      e && e(new Error("Failed to stop watching asset-db, Already stopped.")),
      void 0
    );
  let a = t._mountPaths();
  a = a.map((t) => `${t}/**/*`);
  ...
  i.length > 0 && t.syncChanges(i), e && e();
}
module.exports = {
  watchON() {
    (this._expectWatchON = !0),
      "watch-starting" !== this._watchState &&
        ...
        this._tasks.push(
          { name: "watch-on", run: r, params: [], silent: !0 },
          (t) => {
            (this._watchState = "watch-on"),
              ...
              !1 === this._expectWatchON && this.watchOFF();
          }
        ));
  },
  watchOFF() {
    (this._expectWatchON = !1),
      "watch-starting" !== this._watchState &&
        "watch-stopping" !== this._watchState &&
        ...
        this._dispatchEvent("asset-db:watch-state-changed", this._watchState),
        this._tasks.push(
          { name: "watch-off", run: o, params: [], silent: !0 },
          (t) => {
            (this._watchState = "watch-off"),
              ...
              this._expectWatchON && this.watchON();
          }
        ));
  },
  submitChanges(t) {
    if (!this._snapshot)
      return (
        t && t(new Error("Failed to stop watching asset-db, Already stopped.")),
        void 0
      );
